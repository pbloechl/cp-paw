...
!
!     ..................................................................
      SUBROUTINE WARMUP__SETL4(ID,VAL)
!     ******************************************************************
!     ******************************************************************
      USE WARMUP_MODULE
      IMPLICIT NONE
...
!     ******************************************************************
      ...
      ELSE
        ...
        CALL ERROR__STOP('WARMUP__SETL4')
      END IF
      RETURN
      END
!
!     ..................................................................
      SUBROUTINE WARMUP__SETI4(ID,VAL)
!     ******************************************************************
!     ******************************************************************
      USE WARMUP_MODULE
      IMPLICIT NONE
...
!     ******************************************************************
      ...
      ELSE
        CALL ERROR__MSG('KEYWORD NOT RECOGNIZED')
        CALL ERROR__STOP('WARMUP__SETI4')
      END IF
      RETURN
      END
!
!     ..................................................................
      SUBROUTINE WARMUP__SETR8(ID,VAL)
!     ******************************************************************
!     ******************************************************************
      USE WARMUP_MODULE
      IMPLICIT NONE
...
!     ******************************************************************
      ...
      ELSE
        CALL ERROR__MSG('KEYWORD NOT RECOGNIZED')
        CALL ERROR__STOP('WARMUP__SETR8')
      END IF
      RETURN
      END
!
...
!     == RETURN DATA                                                  ==
!     ==================================================================
      CALL ATOMLIST__SETR8A('R(+)',0,3*NAT,RP)
...
!     -------------------------------------------
      IF (DABS(SXVAR).GT.1D-7) THEN
       CALL ERROR__MSG('FAILED TO ORTHOGONALIZE FORCES AND M|DV>')
       CALL ERROR__STOP('ATOMIC:MM_WARMUPAPPLY')
      ENDIF
!     -------------------------------------------------------------
...
!
      IF (DABS(TEMPER-TEMPER1-RKAPPA).GT.1.D-5) THEN
       CALL ERROR__MSG('WARMUP: DESIRED DELTA T NOT EFFECTED')
      CALL ERROR__STOP('IN WARMUP_APPLY')
      ENDIF
!
      RETURN
...
!      -----------------------------
       ...
       IF (DABS(SVAR).GT.1.D-10) THEN
        CALL ERROR__MSG('FAILED TO FIND ORTHOGONAL VELOCITIES!')
        CALL ERROR__STOP('IN WARMUP')
       ENDIF
       DEALLOCATE(VPRO)
       DEALLOCATE(DWORK)
       DEALLOCATE(RCHECK)
