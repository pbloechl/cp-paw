...
!NAME=(/'ZR1','SI3'/)
!CALL STRCIO__CLEAR
!CALL STRCIO__SETR8A('R',3*NAT,R)
!CALL STRCIO__SETCHA('NAME',NAT,NAME)
!CALL STRCIO__WRITE(6)
!DEALLOCATE(NAME)
!DEALLOCATE(R)
!PRINT*,'=========================================='
!!
!CALL STRCIO__CLEAR
!CALL STRCIO__READ(5)
!CALL STRCIO__GETI4('NAT',NAT)
!PRINT*,'NAT ',NAT
!ALLOCATE(NAME(NAT))
!ALLOCATE(R(3,NAT))
!CALL STRCIO__GETCHA('NAME',NAT,NAME)
!CALL STRCIO__GETR8A('R',3*NAT,R)
!CALL STRCIO__GETR8A('RBAS',9,RBAS)
!!
!CALL STRCIO__CLEAR
!CALL STRCIO__SETR8A('RBAS',9,RBAS)
!CALL STRCIO__SETR8A('R',3*NAT,R)
!CALL STRCIO__SETCHA('NAME',NAT,NAME)
!CALL STRCIO__WRITE(6)
!STOP
...
!
!     ..................................................................
      SUBROUTINE STRCIO__SETI4(ID,VAL)
      USE STRCIO_MODULE
      IMPLICIT NONE
...
!     ******************************************************************
      ...
      ELSE
        ...
        CALL ERROR__STOP('STRCIO__SETI4')
      END IF
      RETURN
      END
!
!     ..................................................................
      SUBROUTINE STRCIO__SETI4A(ID,LEN,VAL)
      USE STRCIO_MODULE
      IMPLICIT NONE
      CHARACTER(*),INTENT(IN) :: ID
...
!     ******************************************************************
      IF(ID.EQ.'IZ') THEN
        ...
        IF(NAT.NE.LEN) THEN
          ...
          CALL ERROR__STOP('STRCIO__SETI4A')
        END IF
        IF(ALLOCATED(IZ))DEALLOCATE(IZ)
        ALLOCATE(IZ(NAT))
        IZ(:)=VAL(:)
      ELSE IF(ID.EQ.'NEIGHBORS') THEN
        IF(NAT.EQ.0) THEN
          CALL ERROR__MSG('#(ATOMS) NOT KNOWN')
          CALL ERROR__CHVAL('ID',ID)
          CALL ERROR__STOP('STRCIO__SETI4A')
        END IF
        NNEIGH=LEN/NAT
      ...
      ELSE IF(ID.EQ.'IT(NEIGHBORS)') THEN
        ...
        END IF
        IF(NNEIGH.EQ.0) THEN
          CALL ERROR__MSG('X#(NEIGHBORS) NOT KNOWN')
          CALL ERROR__CHVAL('ID',ID)
          CALL ERROR__STOP('STRCIO__SETI4A')
        END IF
...
!
!     ..................................................................
      SUBROUTINE STRCIO__GETI4A(ID,LEN,VAL)
      USE STRCIO_MODULE
      IMPLICIT NONE
      CHARACTER(*),INTENT(IN) :: ID
      INTEGER(4)  ,INTENT(IN) :: LEN
...
!     ******************************************************************
      IF(ID.EQ.'IZ') THEN
        IF(NAT.NE.LEN) THEN
          ...
          CALL ERROR__I4VAL('LEN',LEN)
          CALL ERROR__I4VAL('NAT',NAT)
          CALL ERROR__STOP('STRCIO__GETI4A')
        END IF
        VAL(:)=IZ(:)
      ELSE IF(ID.EQ.'NEIGHBORS') THEN
        NNEIGH1=LEN/NAT
...
!
!     ..................................................................
      SUBROUTINE STRCIO__SETR8A(ID,LEN,VAL)
      USE STRCIO_MODULE
      IMPLICIT NONE
      CHARACTER(*),INTENT(IN) :: ID
      INTEGER(4)  ,INTENT(IN) :: LEN
...
!     ******************************************************************
      IF(ID.EQ.'RBAS') THEN
        IF(9.NE.LEN) THEN
          ...
          CALL ERROR__CHVAL('ID',ID)
          CALL ERROR__I4VAL('LEN',LEN)
          CALL ERROR__STOP('STRCIO__SETR8A')
        END IF
...
!
!     ..................................................................
      SUBROUTINE STRCIO__GETR8A(ID,LEN,VAL)
      USE STRCIO_MODULE
      IMPLICIT NONE
      CHARACTER(*),INTENT(IN) :: ID
      INTEGER(4)  ,INTENT(IN) :: LEN
...
!     ******************************************************************
      IF(ID.EQ.'RBAS') THEN
        IF(9.NE.LEN) THEN
          ...
          CALL ERROR__CHVAL('ID',ID)
          CALL ERROR__I4VAL('LEN',LEN)
          CALL ERROR__STOP('STRCIO__GETR8A')
        END IF
        VAL=RESHAPE(RBAS,(/9/))
      ELSE IF(ID.EQ.'R') THEN
        IF(3*NAT.NE.LEN) THEN
...
!
!     ..................................................................
      SUBROUTINE STRCIO__SETCHA(ID,LEN,VAL)
      USE STRCIO_MODULE
      IMPLICIT NONE
      CHARACTER(*),INTENT(IN) :: ID
      INTEGER(4)  ,INTENT(IN) :: LEN
...
!     ******************************************************************
      ...
      ELSE
        CALL ERROR__MSG('ID NOT RECOGNIZED')
        CALL ERROR__CHVAL('ID',ID)
        CALL ERROR__STOP('STRCIO__SETCHA')
      END IF
      RETURN
      END
!
!     ..................................................................
      SUBROUTINE STRCIO__GETCHA(ID,LEN,VAL)
      USE STRCIO_MODULE
      IMPLICIT NONE
      CHARACTER(*),INTENT(IN) :: ID
      INTEGER(4)  ,INTENT(IN) :: LEN
...
!     ******************************************************************
      IF(ID.EQ.'NAME') THEN
        ...
        IF(.NOT.ALLOCATED(Q)) THEN
          CALL ERROR__MSG('NOT ALLOCATED')
          CALL ERROR__CHVAL('ID',ID)
          CALL ERROR__STOP('STRCIO__GETCHA')
        END IF
        VAL(:)=NAME(:)
      ELSE
        CALL ERROR__MSG('ID NOT RECOGNIZED')
...
!
!     ..................................................................
      SUBROUTINE STRCIO__GETI4(ID,VAL)
      USE STRCIO_MODULE
      IMPLICIT NONE
      CHARACTER(*),INTENT(IN) :: ID
...
!     ******************************************************************
      ...
      ELSE
        CALL ERROR__MSG('ID NOT RECOGNIZED')
        CALL ERROR__CHVAL('ID',ID)
        CALL ERROR__STOP('STRCIO__GETI4')
      END IF
      RETURN
      END
!
!     ..................................................................
      SUBROUTINE STRCIO__SETCH(ID,VAL)
      USE STRCIO_MODULE
      IMPLICIT NONE
      CHARACTER(*),INTENT(IN) :: ID
...
!     ******************************************************************
      ...
      ELSE
        CALL ERROR__MSG('ID NOT RECOGNIZED')
        CALL ERROR__CHVAL('ID',ID)
        CALL ERROR__STOP('STRCIO__SETCH')
      END IF
      RETURN
      END
!
!     ..................................................................
      SUBROUTINE STRCIO__GETCH(ID,VAL)
      USE STRCIO_MODULE
      IMPLICIT NONE
      CHARACTER(*),INTENT(IN) :: ID
...
!     ******************************************************************
      ...
      IF(FORMAT.EQ.'XYZ') THEN
        CALL ERROR__MSG('XYZ FORMAT NOT YET IMPLEMENTED')
        CALL ERROR__MSG('STRCIO__WRITE')
      ELSE
...
!     ==================================================================
      IF(NAT.EQ.0) THEN
        CALL ERROR__MSG('#(ATOMS) UNKNOWN')
        CALL ERROR__STOP('STRCIO_COMPLETE')
      END IF
!
      IF(.NOT.ALLOCATED(R)) THEN
        CALL ERROR__MSG('ATOMIC POSITIONS UNKNOWN')
        CALL ERROR__STOP('STRCIO_COMPLETE')
      END IF
!
      IF((.NOT.ALLOCATED(IZ)).AND.(.NOT.ALLOCATED(NAME))) THEN
        CALL ERROR__MSG('INFORMATION ON ELEMENTS MUST BE GIVEN EITHER')
        CALL ERROR__MSG('BY ATOMIC NUMBER OR NAME')
        CALL ERROR__STOP('STRCIO_COMPLETE')
      END IF
!
!     ==================================================================
...
!     ==================================================================
      IF(.NOT.ALLOCATED(NAME)) THEN
        ...
        DO IAT=1,NAT
          ...
          CALL PERIODICTABLE__GET(IZ(IAT),'SYMBOL',NAME(IAT))
...
!     ==================================================================
      IF(.NOT.ALLOCATED(IZ)) THEN
        ALLOCATE(IZ(NAT))
        DO IAT=1,NAT
          CALL PERIODICTABLE__GET(NAME(IAT)(1:2),'Z',IZ(IAT))
        ENDDO
      END IF
!
!     ==================================================================
...
!     == RESET IF NEIGBORLIST IS PRESENT BUT EMPTY =====================
      ...
      IF(.NOT.ALLOCATED(NEIGH)) THEN
        ...
        ALLOCATE(RAD(NAT))
        DO IAT=1,NAT
          CALL PERIODICTABLE__GET(IZ(IAT),'R(COV)',RAD(IAT))
              ...
              DO IAT1=1,NAT
                ...
                DO IAT2=IAT,NAT
                  ...
                  IF(INN(IAT1).GT.NNEIGH) THEN
                    CALL ERROR__MSG('TOO MANY NEIGHBORS')
                    CALL ERROR__I4VAL('#(NEIGHBORS) ALLOWED',NNEIGH)
                    CALL ERROR__I4VAL('IAT',IAT1)
                    CALL ERROR__STOP('STRCIO_COMPLETE')
                  END IF
                  INN(IAT2)=INN(IAT2)+1
...
!     ******************************************************************
      PI=4.D0*DATAN(1.D0)
      CALL CONSTANTS__GET('ANGSTROM',ANGSTROM)
!
!     ==================================================================
