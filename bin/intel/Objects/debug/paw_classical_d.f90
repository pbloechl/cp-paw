...
!**                                                                  **
!**  PREPARE DATA                                                    **
!**   1. SET THE FOLLOWING DATA USING CLASSICAL__SET                  **
!**      NAT      NUMBER OF ATOMS                                    **
!**      R(0)                                                        **
!**      R(-)                                                        **
...
!     ..................................................................
      SUBROUTINE CLASSICAL__SELECT(ID_)
!     ******************************************************************
!     ******************************************************************
!     ******************************************************************
...
!
!     .................................................................
      SUBROUTINE CLASSICAL__SETR8A(ID_,LENG_,VAL_)
!     *****************************************************************
!     **  CLASSICAL__SET                                              **
!     *****************************************************************
      USE CLASSICAL_MODULE
...
!     *****************************************************************
      IF(.NOT.SELECTED) THEN
        CALL ERROR__MSG('NO CLASSICAL OBJECT SELECTED')
        CALL ERROR__STOP('CLASSICAL__SETR8A')
      END IF
!
!     =================================================================
...
!     =================================================================
      IF(ID_.EQ.'R(0)') THEN
        ...
        IF(LENG_.NE.3*MD%NAT) THEN
          ...
          CALL ERROR__CHVAL('ID',ID_)
          CALL ERROR__CHVAL('SELECTION',MD%MDNAME)
          CALL ERROR__STOP('CLASSICAL__SETR8A')
        END IF
...
!     =================================================================
      ELSE
        CALL ERROR__MSG('INVALID IDENTIFIER')
        CALL ERROR__CHVAL('ID',ID_)
        CALL ERROR__CHVAL('SELECTION',MD%MDNAME)
        CALL ERROR__STOP('CLASSICAL__SETR8A')
      END IF
...
!
!     .................................................................
      SUBROUTINE CLASSICAL__SETI4A(ID_,LENG_,VAL_)
!     *****************************************************************
!     **  CLASSICAL__SET                                              **
!     *****************************************************************
      USE CLASSICAL_MODULE
...
!     *****************************************************************
      IF(.NOT.SELECTED) THEN
        CALL ERROR__MSG('NO CLASSICAL OBJECT SELECTED')
        CALL ERROR__STOP('CLASSICAL__SETI4')
      END IF
!
!     =================================================================
...
!     =================================================================
      IF(ID_.EQ.'INDEX2') THEN
        ...
        IF(LENG_.NE.2*MD%NBOND) THEN
          CALL ERROR__MSG('INCONSISTENT SIZE')
          CALL ERROR__I4VAL('LENG',LENG_)
          CALL ERROR__I4VAL('NBOND',MD%NBOND)
          CALL ERROR__CHVAL('ID',ID_)
          CALL ERROR__CHVAL('SELECTION',MD%MDNAME)
          CALL ERROR__STOP('CLASSICAL__SETI4A')
        END IF
...
!
!     .................................................................
      SUBROUTINE CLASSICAL__SETI4(ID_,VAL_)
!     *****************************************************************
!     **  CLASSICAL__SET                                              **
!     *****************************************************************
      USE CLASSICAL_MODULE
...
!
!     .................................................................
      SUBROUTINE CLASSICAL__SETL4A(ID_,LENG_,VAL_)
!     *****************************************************************
!     **  CLASSICAL__SET                                              **
!     *****************************************************************
      USE CLASSICAL_MODULE
...
!     *****************************************************************
      IF(.NOT.SELECTED) THEN
        CALL ERROR__MSG('NO CLASSICAL OBJECT SELECTED')
        CALL ERROR__STOP('CLASSICAL__SETL4A')
      END IF
!
!     =================================================================
!     == INDEX2 = ARRAY DEFINING COVALENT BONDS                      ==
...
!
!     .................................................................
      SUBROUTINE CLASSICAL__SETL4(ID_,VAL_)
!     *****************************************************************
!     **  CLASSICAL__SET                                              **
!     *****************************************************************
      USE CLASSICAL_MODULE
...
!     *****************************************************************
      IF(.NOT.SELECTED) THEN
        CALL ERROR__MSG('NO CLASSICAL OBJECT SELECTED')
        CALL ERROR__STOP('CLASSICAL__SETL4')
      END IF
!
!     =================================================================
!     == INDEX2 = ARRAY DEFINING COVALENT BONDS                      ==
...
!
!     .................................................................
      SUBROUTINE CLASSICAL__SETCHA(ID_,LENG_,VAL_)
!     *****************************************************************
!     **  CLASSICAL__SET                                              **
!     *****************************************************************
      USE CLASSICAL_MODULE
...
!     *****************************************************************
      IF(.NOT.SELECTED) THEN
        CALL ERROR__MSG('NO CLASSICAL OBJECT SELECTED')
        CALL ERROR__STOP('CLASSICAL__SETCHA')
      END IF
!
!     =================================================================
!     == TYPE = ATOM TYPE                                            ==
...
!
!     .................................................................
      SUBROUTINE CLASSICAL__GETR8A(ID_,LENG_,VAL_)
!     *****************************************************************
!     **  CLASSICAL__SET                                              **
!     *****************************************************************
      USE CLASSICAL_MODULE
...
!     *****************************************************************
      IF(.NOT.SELECTED) THEN
        CALL ERROR__MSG('NO CLASSICAL OBJECT SELECTED')
        CALL ERROR__STOP('CLASSICAL__GETR8A')
      END IF
!
!     =================================================================
!     == R(0) = ACTUAL ATOMIC POSITIONS                              ==
!     =================================================================
      IF(ID_.EQ.'R(0)') THEN
        ...
        IF(LENG_.NE.3*MD%NAT) THEN
          ...
          CALL ERROR__I4VAL('MD%NAT',MD%NAT)
          CALL ERROR__CHVAL('ID',ID_)
          CALL ERROR__CHVAL('SELECTION',MD%MDNAME)
          CALL ERROR__STOP('CLASSICAL__GETR8A')
        END IF
        IF(.NOT.ASSOCIATED(MD%R0)) THEN
          CALL ERROR__MSG('NOT ALLOCATED')
          CALL ERROR__CHVAL('ID',ID_)
          CALL ERROR__CHVAL('SELECTION',MD%MDNAME)
          CALL ERROR__STOP('CLASSICAL__GETR8A')
        END IF
...
!
!     .................................................................
      SUBROUTINE CLASSICAL__GETI4A(ID_,LENG_,VAL_)
!     *****************************************************************
!     **  CLASSICAL__SET                                              **
!     *****************************************************************
      USE CLASSICAL_MODULE
...
!     *****************************************************************
      IF(.NOT.SELECTED) THEN
        CALL ERROR__MSG('NO CLASSICAL OBJECT SELECTED')
        CALL ERROR__STOP('CLASSICAL__GETI4A')
      END IF
!
!     =================================================================
!     == INDEX2 = ARRAY DEFINING COVALENT BONDS                      ==
...
!
!     .................................................................
      SUBROUTINE CLASSICAL__GETI4(ID_,VAL_)
!     *****************************************************************
!     **  CLASSICAL__SET                                              **
!     *****************************************************************
      USE CLASSICAL_MODULE
...
!
!     .................................................................
      SUBROUTINE CLASSICAL__GETCHA(ID_,LENG_,VAL_)
!     *****************************************************************
!     **  CLASSICAL__SET                                              **
!     *****************************************************************
      USE CLASSICAL_MODULE
...
!     *****************************************************************
      IF(.NOT.SELECTED) THEN
        CALL ERROR__MSG('NO CLASSICAL OBJECT SELECTED')
        CALL ERROR__STOP('CLASSICAL_INITIALIZE')
      END IF
      IF(MD%TINI) THEN
        RETURN
      END IF
      MD%TINI=.TRUE.
                               CALL TRACE__PUSH('CLASSICAL_INITIALIZE')
!
!     ==================================================================
...
!     ==================================================================
      ...
      IF(.NOT.TCHK) THEN
        CALL ERROR__MSG('NOT ALL MANDATORY DATA ARE SET')
        CALL ERROR__I4VAL('NAT',MD%NAT)
        CALL ERROR__I4VAL('NBOND',MD%NBOND)
        CALL ERROR__L4VAL('R(0)',ASSOCIATED(MD%R0))
        CALL ERROR__L4VAL('MASS',ASSOCIATED(MD%RMASS))
        CALL ERROR__L4VAL('FFTYPE',ASSOCIATED(MD%TYPE))
        CALL ERROR__L4VAL('QEL',ASSOCIATED(MD%QEL))
        CALL ERROR__L4VAL('INDEX2',ASSOCIATED(MD%INDEX2))
        CALL ERROR__L4VAL('BOND ORDER',ASSOCIATED(MD%BO))
        CALL ERROR__STOP('CLASSICAL_INITIALIZE')
      END IF
!
!     ==================================================================
...
!
!     .................................................................
      SUBROUTINE CLASSICAL__NEIGHBORS
!     *****************************************************************
!     **                                                             **
!     *****************************************************************
      USE CLASSICAL_MODULE
      ...
      INTEGER(4) :: I
!     *****************************************************************
                               CALL TRACE__PUSH('CLASSICAL__NEIGHBORS')
      IF(.NOT.SELECTED) THEN
        CALL ERROR__MSG('CLASSICAL OBJECT NOT SELECTED')
        CALL ERROR__STOP('CLASSICAL__NEIGHBORS')
      END IF
...
!
!     .................................................................
      SUBROUTINE CLASSICAL__ETOT(EPOT)
!     *****************************************************************
!     **                                                             **
...
!     *****************************************************************
      ...
      REAL(8)                :: SIGMA
!     *****************************************************************
                               CALL TRACE__PUSH('CLASSICAL__ETOT')
      IF(.NOT.SELECTED) THEN
        CALL ERROR__MSG('CLASSICAL OBJECT NOT SELECTED')
        CALL ERROR__STOP('CLASSICAL__ETOT')
      END IF
      CALL CLASSICAL_INITIALIZE
!
!     ==================================================================
...
!
!     .................................................................
      SUBROUTINE CLASSICAL__PROPAGATE(DELT,ANNE)
!     *****************************************************************
!     **                                                             **
!     *****************************************************************
      USE CLASSICAL_MODULE
...
!     *****************************************************************
                               CALL TRACE__PUSH('CLASSICAL__PROPAGATE')
      IF(.NOT.SELECTED) THEN
        CALL ERROR__MSG('CLASSICAL OBJECT NOT SELECTED')
        CALL ERROR__STOP('CLASSICAL__ETOT')
      END IF
...
!
!     .................................................................
      SUBROUTINE CLASSICAL__EKIN(DELT_,EKIN_)
!     *****************************************************************
!     **                                                             **
!     *****************************************************************
      USE CLASSICAL_MODULE
      ...
      REAL(8)               :: SVAR
!     *****************************************************************
                               CALL TRACE__PUSH('CLASSICAL__EKIN')
      IF(.NOT.SELECTED) THEN
        CALL ERROR__MSG('CLASSICAL OBJECT NOT SELECTED')
        CALL ERROR__STOP('CLASSICAL__EKIN')
      END IF
      CALL CLASSICAL_INITIALIZE
!
!     ==================================================================
...
!
!     .................................................................
      SUBROUTINE CLASSICAL__MAXFORCE(FMAX_)
!     *****************************************************************
!     **                                                             **
!     *****************************************************************
      USE CLASSICAL_MODULE
...
!
!     .................................................................
      SUBROUTINE CLASSICAL__REPORT(NFIL)
!     *****************************************************************
!     **                                                             **
!     *****************************************************************
      USE CLASSICAL_MODULE
...
!     *****************************************************************
                               CALL TRACE__PUSH('CLASSICAL__REPORT')
      IF(.NOT.SELECTED) THEN
        CALL ERROR__MSG('CLASSICAL OBJECT NOT SELECTED')
        CALL ERROR__STOP('CLASSICAL__ETOT')
      END IF
...
!     *****************************************************************
                            CALL TRACE__PUSH('CLASSICAL_ETOTAL')
      CALL MPE__QUERY(NTASKS,THISTASK)
!
!     =================================================================
!     ==  ZERO OUT ARRAYS                                            ==
...
real(8) :: g1,dgdx1
!     ******************************************************************
                               CALL TRACE__PUSH('CLASSICAL_ECOULOMB')
      CALL MPE__QUERY(NTASKS,THISTASK)
      PI=4.D0*DATAN(1.D0)
...
!     INTEGER(4)   ,ALLOCATABLE  :: IWORK(:)
      ...
      REAL(8)                    :: X,K,D
!     ******************************************************************
                                  CALL TRACE__PUSH('CLASSICAL_UFFINITIALIZE')
      NPOT=0
!     ==================================================================
...
!       =================================================================
        ...
        IF(IAT1.GT.NAT.OR.IAT2.GT.NAT) THEN
          CALL ERROR__MSG('ATOM INDEX IN BOND OUT OF RANGE')
          CALL ERROR__I4VAL('IAT1',IAT1)
          CALL ERROR__I4VAL('IAT2',IAT2)
          CALL ERROR__I4VAL('NAT',NAT)
          CALL ERROR__STOP('UFFINITIALIZE')
        END IF
        TYPE1=TYPE(IAT1)
        TYPE2=TYPE(IAT2)
        CALL UFFTABLE__BONDPARMS(TYPE1,TYPE2,BO(IB),ID,X,K,D,TCHK)
!
!       =================================================================
...
!       == CREATE NEW POTENTIAL IF NECCESARY ==========================
        ...
        IF(NPOT.GT.NPOTX) THEN
          CALL ERROR__MSG('NPOT TOO LARGE')
          CALL ERROR__STOP('CLASSICAL_UFFINITIALIZE')
        END IF
      ...
      DO IAT2=1,NAT
        ...
        DO II1=1,NN2
          DO II3=II1+1,NN2
            ...
            TYPE2=TYPE(IAT2)
            TYPE3=TYPE(IAT3)
            CALL UFFTABLE__ANGLEPARMS(TYPE1,TYPE2,TYPE3,BO1,BO3,ID,X,K,TCHK)
            IF(.NOT.TCHK) CYCLE
!
!           == ADD NEW ANGLE ===========================================
            NANGLE=NANGLE+1
            IF(NANGLE.GT.NANGLEX) THEN
              CALL ERROR__MSG('NUMBER OF ANGLES LARGER THAN MAXIMUM')
              CALL ERROR__OVERFLOW('NANGLE',NANGLE,NANGLEX)
              CALL ERROR__STOP('CLASSICAL_UFFINITIALIZE')
            END IF
...
!           == CREATE NEW POTENTIAL IF IT DOES NOTE YET EXIST  =========
            NPOT=NPOT+1
            IF(NPOT.GT.NPOTX) THEN
              CALL ERROR__MSG('NUMBER OF POTENTIALS TOO LARGE')
              CALL ERROR__STOP('CLASSICAL_UFFINITIALIZE')
            END IF
...
!           == WRITE IDENTIFIER FOR THE POTENTIAL ======================
            ...
            BO12=0.D0
            BO34=0.D0
            CALL UFFTABLE__TORSIONPARMS(TYPE1,TYPE2,TYPE3,TYPE4 &
...
!           == ADD NEW TORSION =========================================
            ...
            IF(NTORSION.GT.NTORSIONX) THEN
              CALL ERROR__MSG('NUMBER OF TORSIONS LARGER THAN MAXIMUM')
              CALL ERROR__STOP('CLASSICAL_UFFINITIALIZE')
            END IF
...
!            BO14=BONEIGH(1+MOD(II+1,3),IAT)
            CALL UFFTABLE__INVERSIONPARMS(TYPE1,TYPE2,TYPE3,TYPE4 &
     &              ,ID,X,K,TCHK)
            IF(.NOT.TCHK) CYCLE
!
      ...
      DO IAT1=1,NAT
        DO IAT2=IAT1,NAT
          ...
          IF(NONBOND(I1,I2).EQ.0) THEN
            TYPE1=TYPE(IAT1)
            TYPE2=TYPE(IAT2)
            CALL UFFTABLE__NONBONDPARMS(TYPE1,TYPE2,ID,X,D,TCHK)
            NPOT=NPOT+1
...
!     ==================================================================
      ...
      IF(B.GT.0.D0) THEN
        CALL ERROR__MSG('ATTEMPT TO REMOVE MINIMUM AT ZERO BOND-ANGLE FAILED')
        CALL ERROR__I4VAL('N',N)
        CALL ERROR__STOP('CLASSICAL%ANGLEPOTA')
      END IF
      DO I=N,POT%NX
        X=POT%X1+POT%DX*DBLE(I-1)
...
!     ==  WE USES A LENNARD-JONES 6-12 POTENTIAL =======================
      ...
      DO I=1,POT%NX
        ...
        IF(I.NE.1) THEN
          ...
          ELSE
            call error__msg('INVALID NONBOND POTENTIAL')
            call error__stop('CLASSICAL_NONBONDPOTA')
          END IF
        ELSE
          POT%VAL(I)=0.D0
          POT%DER(I)=0.D0
...
!     .................................................................
      SUBROUTINE UFFTABLE__GET(TYPE_,ID,VAL_)
      USE UFFTABLE_MODULE
...
!     ==================================================================
      ...
      DO WHILE(TYPE_.NE.PAR(ITYPE)%NAME)
        ...
        IF(ITYPE.GT.NTYPE) THEN
          CALL ERROR__MSG('ATOM TYPE NOT RECOGNIZED')
          CALL ERROR__CHVAL('TYPE ',TYPE_)
          CALL ERROR__STOP('UFFTABLE__GETR8')
        END IF
      ENDDO
!
!     ==================================================================
...
!     ==================================================================
      ...
      ELSE IF(ID.EQ.'ENC') THEN    !PAULING ELECTRONEGATIVITY
        CALL PERIODICTABLE__GET(TYPE_(1:2),'EN',VAL_)
      ELSE
...
!     == COLLECT UFF DATA                                            ==
!     ==================================================================
      CALL UFFTABLE__GET(TYPE1,'R',RI)
      CALL UFFTABLE__GET(TYPE2,'R',RJ)
      CALL UFFTABLE__GET(TYPE1,'ENC',ENCI)
      CALL UFFTABLE__GET(TYPE2,'ENC',ENCJ)
      CALL UFFTABLE__GET(TYPE1,'Z',ZI)
      CALL UFFTABLE__GET(TYPE2,'Z',ZJ)
!
!     ==================================================================
...
!
!     .................................................................
      SUBROUTINE UFFTABLE__BONDPARMS(TYPE1,TYPE2,BO,ID,R,K,D,TCHK)
!     ******************************************************************
!     **                                                              **
...
!
!     .................................................................
      SUBROUTINE UFFTABLE__ANGLEPARMS(ATOM1,ATOM2,ATOM3,BO1,BO2,ID,THETA,K,TCHK)
!     ******************************************************************
!     **                                                              **
...
!     ==================================================================
      IF(.NOT.TCHK1) THEN
        CALL UFFTABLE__GET(ATOM1,'Z',ZI)
        CALL UFFTABLE__GET(ATOM3,'Z',ZK)
        CALL UFFTABLE__GET(ATOM2,'THETA',THETA); THETA=THETA/180.D0*PI
...
!
!     ..................................................................
      SUBROUTINE UFFTABLE__TORSIONPARMS(TYPE1,TYPE2,TYPE3,TYPE4 &
     &            ,BO12,BO23,BO34 &
...
!     ==================================================================
      ...
      ELSE IF(TYPE2(3:3).EQ.'6') THEN
        IHYB2=6
      ELSE
        CALL ERROR__MSG('HYBRIDIZATION NOT RECOGNIZED')
        CALL ERROR__CHVAL('TYPE2',TYPE2)
        CALL ERROR__STOP('CLASSICAL_TORSIONPOT')
      END IF
!
...
!
!     ..................................................................
      SUBROUTINE UFFTABLE__INVERSIONPARMS(TYPE1,TYPE2,TYPE3,TYPE4 &
     &              ,ID,GAMMA0,K,TCHK)
!     ******************************************************************
!     ******************************************************************
      USE CLASSICAL_MODULE,ONLY : POT_TYPE
...
!
!     ..................................................................
      SUBROUTINE UFFTABLE__NONBONDPARMS(ATOM1,ATOM2,ID,RIJ,DIJ,TCHK)
!     ******************************************************************
!     **                                                              **
...
!     ******************************************************************
      CALL UFFTABLE__GET(ATOM1,'X',XI)
      CALL UFFTABLE__GET(ATOM2,'X',XJ)
      CALL UFFTABLE__GET(ATOM1,'D',DI)
      CALL UFFTABLE__GET(ATOM2,'D',DJ)
!
      RIJ=DSQRT(XI*XJ)
      DIJ=DSQRT(DI*DJ)
...
!     ==================================================================
      ...
      IF(EXCLUSION.NE.-1) THEN
        CALL ERROR__MSG('NOT ALL EXCLUSIONS HAVE BEEN TOUCHED')
        CALL ERROR__STOP('CLASSICAL_NEIGHBORS')
      END IF
!
!     ==================================================================
...
!     ******************************************************************
      ...
      IF(LARGEST.GT.HUGE(IEXCLUSION)) THEN
        CALL ERROR__MSG('NUMBERS LARGER THAN NUMBER MODEL')
        CALL ERROR__STOP('CLASSICAL_EXCLUSIONS')
      END IF
      NEXCLUSION=0
...
!if i understand correctly this must be completed for periodic systems
          ...
          IF(ABS(IT1).GT.MAXDIV.OR.ABS(IT2).GT.MAXDIV.OR.ABS(IT3).GT.MAXDIV) THEN
            CALL ERROR__MSG('BOND TRANSLATIONS TOO LARGE')
            CALL ERROR__MSG('CANNOT HANDLE AT PRESENT')
            CALL ERROR__STOP('CLASSICAL_EXCLUSIONS')
          END IF
...
!     ==================================================================
      IF(NEXCLUSION.GT.1) THEN
        call lib__sorti4(NEXCLUSION,IEXCLUSION)
!
...
!
!     ..................................................................
      SUBROUTINE CLASSICAL__BUILDSOLVENT(DENSITY,RSPHERE &
...
!     ==================================================================
      CALL CLASSICAL__SELECT(IDENTMOL)
      CALL CLASSICAL__GETI4('NAT',NAT)
      CALL CLASSICAL__GETI4('NBOND',NBOND)
!
      ALLOCATE(R0(3,NAT))
      ALLOCATE(TYPE(NAT))
      ALLOCATE(QEL(NAT))
      ...
      CALL CLASSICAL__GETCHA('TYPE',NAT,TYPE)
      CALL CLASSICAL__GETR8A('QEL',NAT,QEL)
      CALL CLASSICAL__GETR8A('MASS',NAT,RMASS)
      CALL CLASSICAL__GETI4A('INDEX2',3*NBOND,IBOND)
      CALL CLASSICAL__GETR8A('BONDORDER',NBOND,BO)
!
!     ==================================================================
!     ==  DEFINE GRID                                                 ==
!     ==================================================================
...
!     ==================================================================
      CALL CLASSICAL__SELECT(IDENTEXCL)
      CALL CLASSICAL__GETI4('NAT',NATEXCL)
      ALLOCATE(REXCL(3,NATEXCL))
      CALL CLASSICAL__GETR8A('R(0)',3*NATEXCL,REXCL)
     ...
     &   .OR.(I1.GT.MAX1).OR.(I2.GT.MAX2).OR.(I3.GT.MAX3)
        IF(TCHK) THEN
          CALL ERROR__MSG('MOLECULE NOT FULLY SOLVATED')
          CALL ERROR__STOP('SOLVENT')
        ELSE
...
!     ==================================================================
      CALL CLASSICAL__GETI4('NBOND',NBONDEXCL)
...
!
      ...
      ALLOCATE(BOS(NBONDS))
!
      CALL CLASSICAL__GETR8A('R(0)',8*3*NATEXCL,R0S)
      CALL CLASSICAL__GETCHA('TYPE',NATEXCL,TYPES)
      CALL CLASSICAL__GETR8A('MASS',NATEXCL,RMASSS)
      CALL CLASSICAL__GETR8A('QEL',NATEXCL,QELS)
      CALL CLASSICAL__GETI4A('INDEX2',3*NBONDEXCL,IBONDS)
      CALL CLASSICAL__GETR8A('BONDORDER',NBONDEXCL,BOS)
!
!     ==================================================================
...
!     ==================================================================
      CALL CLASSICAL__SELECT(IDENTSOLV)
      CALL CLASSICAL__SETI4('NAT',NATS)
      CALL CLASSICAL__SETR8A('R(0)',3*NATS,R0S)
      CALL CLASSICAL__SETR8A('R(-)',3*NATS,R0S)
      CALL CLASSICAL__SETR8A('QEL',NATS,QELS)
      CALL CLASSICAL__SETCHA('TYPE',NATS,TYPES)
      CALL CLASSICAL__SETR8A('MASS',NATS,RMASSS)
      CALL CLASSICAL__SETI4('NBOND',NBONDS)
      CALL CLASSICAL__SETI4A('INDEX2',3*NBONDS,IBONDS)
      CALL CLASSICAL__SETR8A('BONDORDER',NBONDS,BOS)
      DEALLOCATE(IBONDS)
      DEALLOCATE(BOS)
      DEALLOCATE(R0S)
      DEALLOCATE(QELS)
...
!
!     ..................................................................
      SUBROUTINE CLASSICAL__MINIMIZE(TOL_,MAXSTEP,TCONV)
!     ******************************************************************
!     **                                                              **
!     **                                                              **
!     **                                                              **
...
!       RMASS1(IAT)=2.D0*1899.D0
      ENDDO
!     CALL CLASSICAL__SETR8A('MASS',NAT,RMASS1)
!
      ETOTP=1.D+8
      DO ITER=1,NITER
!       ================================================================
...
!       ================================================================
        ...
        EPOTP=EPOT
        CALL CLASSICAL__PROPAGATE(DELT,ANNE)
!
!       ================================================================
!       ==  CHECK CONVERGENCE                                         ==
!       ================================================================
        CALL CLASSICAL__MAXFORCE(FMAX)
!
!       ================================================================
!       ==  PRINT                                                     ==
!       ================================================================
        IF(TPR) THEN
          ...
          CALL CLASSICAL__EKIN(DELT,EKIN)
          ECON=EPOT+EKIN
...
!       ================================================================
      ...
      ENDDO
 1000 CONTINUE
      PRINT*,'CLASSICAL__MINIMIZE CONVERGED AFTER ',ITER,' ITERATIONS'
      CALL CLASSICAL__SETR8A('MASS',NAT,RMASS)
      DEALLOCATE(RMASS)
      DEALLOCATE(RMASS1)
      RETURN
      END
!
!     ..................................................................
      SUBROUTINE CLASSICAL__D2EDX2(NAT_,DYNMAT)
!     ******************************************************************
!     **                                                              **
!     ******************************************************************
      IMPLICIT NONE
...
!     ******************************************************************
      CALL CLASSICAL__GETI4('NAT',NAT)
      IF(NAT.NE.NAT_) THEN
        CALL ERROR__MSG('NAT OF CLASSICAL NOT CONSISTENT WITH INPUT')
        CALL ERROR__STOP('CLASSICAL__DYNAMICALMATRIX')
      END IF
...
!     ==================================================================
      ...
      CALL CLASSICAL__GETR8A('R(0)',3*NAT,RSAVE)
      DO IAT=1,NAT
        DO I=1,3
          R0(:,:)=RSAVE(:,:)
          R0(I,IAT)=R0(I,IAT)-DELTA
          CALL CLASSICAL__SETR8A('R(0)',3*NAT,R0)
          CALL CLASSICAL__ETOT(EPOT)
          CALL CLASSICAL__GETR8A('FORCE',3*NAT,FORCE1)
          R0(:,:)=RSAVE(:,:)
          R0(I,IAT)=R0(I,IAT)+DELTA
          CALL CLASSICAL__SETR8A('R(0)',3*NAT,R0)
          CALL CLASSICAL__ETOT(EPOT)
          CALL CLASSICAL__GETR8A('FORCE',3*NAT,FORCE2)
          FAC=-1.D0/(2.D0*DELTA)
...
!     ==================================================================
      CALL CLASSICAL__SETR8A('R(0)',3*NAT,RSAVE)
      CALL CLASSICAL__ETOT(EPOT)
      DEALLOCATE(FORCE2)
      DEALLOCATE(FORCE1)
      DEALLOCATE(R0)
...
!     ******************************************************************
     ...
     &          //',"TEST=",E12.5)')I,X(I),E(I),DEDX(I),SVAR
      ENDDO
      CALL ERROR__MSG('NORMAL STOP IN TESTVALUE')
      CALL ERROR__STOP('TESTVALUE')
      END
!
!     ..................................................................
...
!
      CALL CLASSICAL__GETR8A('R(0)',3*NAT,R0SAVE)
      CALL CLASSICAL__ETOT(EPOTSAVE)
      CALL CLASSICAL__GETR8A('FORCE',3*NAT,FSAVE)
      DO IAT=1,NAT
        DO I=1,3
!
          R0=R0SAVE
          ...
          CALL CLASSICAL__SETR8A('R(0)',3*NAT,R0)
          CALL CLASSICAL__ETOT(EPOTM2)
!
          R0=R0SAVE
          R0(I,IAT)=R0(I,IAT)-DEL
          CALL CLASSICAL__SETR8A('R(0)',3*NAT,R0)
          CALL CLASSICAL__ETOT(EPOTM1)
!
          R0=R0SAVE
          R0(I,IAT)=R0(I,IAT)+DEL
          CALL CLASSICAL__SETR8A('R(0)',3*NAT,R0)
          CALL CLASSICAL__ETOT(EPOTP1)
!
          R0=R0SAVE
          R0(I,IAT)=R0(I,IAT)+2*DEL
          CALL CLASSICAL__SETR8A('R(0)',3*NAT,R0)
          CALL CLASSICAL__ETOT(EPOTP2)
!
...
!     == RESTORE ORIGINAL STATE                                       ==
!     ==================================================================
      CALL CLASSICAL__SETR8A('R(0)',3*NAT,R0SAVE)
      CALL CLASSICAL__ETOT(EPOTSAVE)
      DEALLOCATE(R0SAVE)
      DEALLOCATE(R0)
      DEALLOCATE(FSAVE)
