...
!
!     ....................................................................
      SUBROUTINE POLYNOM__COEFF(NX,X0,COEFF,X,Y)
!     **                                                                **
...
!     ==================================================================
      ...
      END IF
      RETURN
      END SUBROUTINE POLYNOM__COEFF
!
!     ....................................................................
      SUBROUTINE POLYNOM__SHIFTORIGIN(NX,X0,COEFF,X0NEU)
!     **                                                                **
...
!
!     ....................................................................
      SUBROUTINE POLYNOM__PRODUCT(N1,X1,C1,N2,X2,C2,N3,X3,C3)
!     **                                                                **
...
!     ********************************************************************
      X1S=X1
      C1S(:)=C1(:)
      CALL POLYNOM__SHIFTORIGIN(N1,X1S,C1S,X3)
      X2S=X2
      C2S(:)=C2(:)
      CALL POLYNOM__SHIFTORIGIN(N2,X2S,C2S,X3)
      DO I=1,N3
        J1=MAX(1,I+1-N2)
        J2=MIN(N1,I)
        SUM=0.D0
...
!
!     ....................................................................
      SUBROUTINE POLYNOM__VALUE(NX,X0,COEFF,X,Y)
!     **                                                                **
...
!
!     ....................................................................
      SUBROUTINE POLYNOM__DERIVATIVE(NX,X0,COEFF,X,Y)
!     **                                                                **
...
!
!     ....................................................................
      SUBROUTINE POLYNOM__INTEGRAL(NX,X0,COEFF,X,Y)
!     **                                                                **
