...
ELSE
  ...
  CALL ERROR__STOP('CONTINUUM_TESSELATION_GETI4')
END IF
RETURN
END
!
...
ELSE
  CALL ERROR__MSG('ID NOT RECOGNIZED')
  CALL ERROR__CHVAL('ID',ID)
  CALL ERROR__STOP('CONTINUUM_TESSELATION_SELECT')
END IF
RETURN
END
...
!
      ...
      DO IAT=1,NAT
       CALL ATOMLIST__GET('NAME',32,IAT,NAME)
...
!     IF(THISTASK.EQ.1) THEN
        READ(NFIL)FACE_IDENT,FACE_ATOM_IDENT,FACE_MIDPOINT,&
         & FACE_TRI1,FACE_TRI2,FACE_TRI3,FACE_AREA,FACE_Q,FACE_QM,FACE_FMEM
!     END IF
      CALL MPE__BROADCAST(1,FACE_IDENT)
      CALL MPE__BROADCAST(1,FACE_ATOM_IDENT)
      CALL MPE__BROADCAST(1,FACE_MIDPOINT)
      CALL MPE__BROADCAST(1,FACE_TRI1)
      CALL MPE__BROADCAST(1,FACE_TRI2)
      CALL MPE__BROADCAST(1,FACE_TRI3)
      CALL MPE__BROADCAST(1,FACE_AREA)
      CALL MPE__BROADCAST(1,FACE_Q)
      CALL MPE__BROADCAST(1,FACE_QM)
      CALL MPE__BROADCAST(1,FACE_FMEM)
!
      DO COUNTER=1,NFACE
...
!
      ...
      CALL FILEHANDLER__UNIT(TESSELATION_NAME(IAT),NFIL)
      REWIND(NFIL)
      READ(NFIL,*)NPOINT
...
!
      ...
      ENDDO
      DEALLOCATE(POINTS)
      CALL FILEHANDLER__CLOSE(TESSELATION_NAME(IAT))
...
!
      ...
      REAL(8) :: ERFX
!
                 CALL TIMING__CLOCKON('CONT:FORCE/ENERGY INIT')
!
...
!
      ...
      ENDDO
!
                 CALL TIMING__CLOCKOFF('CONT:FORCE/ENERGY INIT')
!
!     ----------------------------------------------
!     ----------- NOW DO FORCES ON CHARGES ---------
!     ----------------------------------------------
!
                 CALL TIMING__CLOCKON('CONT:CHARGE FORCE 1')
!
...
! CAUTION CAUTION CAUTION
        DO IG=1,NG
          CALL LIB__ERFR8(AFD(AI,FI)/RC(IG,AI),ERFX)
...
!
      ENDDO CF1LOOP
!
                 CALL TIMING__CLOCKOFF('CONT:CHARGE FORCE 1')
!
...
!
                 CALL TIMING__CLOCKON('CONT:CHARGE FORCE 2')
!
...
!       ENDIF
      ...
      ENDDO
!
                 CALL TIMING__CLOCKOFF('CONT:CHARGE FORCE 2')
!
!     ----------------------------------------------
...
!
                 CALL TIMING__CLOCKON('CONT:NUC FORCE/FACES')
!
      DO AI=1,NAT
...
!
        LOOP1: DO CAI=1,NAT
         IF (FBA(CAI,FI)) THEN
          IF (.NOT. FBA(AI,FI)) THEN
           DO IG=1,NG
            CALL LIB__ERFR8(AFD(AI,FI)/RC(IG,AI),ERRFUNC)
      ...
      &                        *DBIGFDRI(VI,CAI,FI)
       ...
       ENDDO NFACELOOP
      ENDDO
                 CALL TIMING__CLOCKOFF('CONT:NUC FORCE/FACES')
!
...
!
       CALL ENERGYLIST__SET('INTER-TRIANGLE-POTENTIAL',&
         &INTER_TRIANGLE_ENERGY)
       CALL ENERGYLIST__SET('INTRA-TRIANGLE-POTENTIAL',&
         &INTRA_TRIANGLE_ENERGY)
       CALL ENERGYLIST__SET('ION-TRIANGLE-POTENTIAL',&
         &ATOM_TRIANGLE_ENERGY)
       CALL ENERGYLIST__SET('CAVITY-HARDNESS-POTENTIAL',&
         &HARDNESS_ENERGY)
       CALL ENERGYLIST__SET('SURFACETENSION-POTENTIAL',&
         &SURFACETENSION_ENERGY)
       CALL ENERGYLIST__SET('TOTAL-SURFACE-POTENTIAL',ECONT)
!       CALL ENERGYLIST__ADD('TOTAL ENERGY',ECONT)
!
...
!
!
!     SUBROUTINE CONTINUUM__SETC(MOVE_ATOMS,TCONTIN,TSTARTC,TMOVEC,TFZO,&
...
!        &TSTOPC,TAUTOC,MQ,EPSILON,ANNER1,ANNER2,SANNR1,SANNR2)
!
!      END SUBROUTINE CONTINUUM__SETC
!
!     =======================================================================
!
!      SUBROUTINE CONTINUUM__WRITE(NAT,R0)
!      USE CONTINUUM_CONTROL_MODULE
!      USE NET_MODULE
!      IMPLICIT NONE
!      LOGICAL :: ON_FLAG
...
!      CALL FILEHANDLER__UNIT('CONTINUUM_RESTART',NFIL)
!      REWIND(NFIL)
!
!      CALL WRITE_NET(NFIL)
!
!      CALL FILEHANDLER__CLOSE('CONTINUUM_RESTART')
!      CALL NET_REPORT(NAT,R0)
!
!      END SUBROUTINE CONTINUUM__WRITE
!
!     =======================================================================
!
      SUBROUTINE CONTINUUM__INITIALIZE
      USE CONTINUUM_CONTROL_MODULE
      USE NET_MODULE
      IMPLICIT NONE
...
!
      END SUBROUTINE CONTINUUM__INITIALIZE
!
!     =======================================================================
!
      SUBROUTINE CONTINUUM__PROPAGATE(NAT,R0,NG,RC,QMAD,ECONT,PCONT,CFORCE)
      USE CONTINUUM_CONTROL_MODULE
      USE NET_MODULE
      IMPLICIT NONE
      TYPE (FACETYPE),POINTER :: FACE
...
!
      CALL GET_SET_ON('GET',ON_FLAG)
      IF (.NOT. ON_FLAG) RETURN
                               CALL TRACE__PUSH('CONTINUUM__PROPAGATE')
!
...
!
        CALL CONTINUUM__NOSE_THERMOSTAT(KINETIC_ENERGY,CHARGE_FRICTION)
       ENDIF
!
...
!
       CALL PROPAGATE
!
       CALL ENERGYLIST__SET('SURFACE Q EKIN',KINETIC_ENERGY)
       CALL ENERGYLIST__ADD('CONSTANT ENERGY',KINETIC_ENERGY)
!
!     ===== SWITCH CHARGES
!
       FACE=>FIRSTFACE
...
!     --------------------------------------------
!
      END SUBROUTINE CONTINUUM__PROPAGATE
!
!     =======================================================================
!
      SUBROUTINE CONTINUUM__RETURNPROTOCOL(ON,ESOLV,EKINQ,QFRIC,QTOT)
      USE CONTINUUM_CONTROL_MODULE
      IMPLICIT NONE
...
!
      ...
      IF (.NOT. ON) THEN
       ...
       RETURN
      ENDIF
!      CALL FILEHANDLER__UNIT('CONTINUUM_PROTOCOL',NFILO)
      CALL GET_SET_CHARGEFRICTION('GET',QFRIC)
      CALL ENERGYLIST__RETURN('TOTAL-SURFACE-POTENTIAL',ESOLV)
      CALL ENERGYLIST__RETURN('SURFACE Q EKIN',EKINQ)
...
!
      END SUBROUTINE CONTINUUM__RETURNPROTOCOL
!
!     =======================================================================
!
      SUBROUTINE CONTINUUM__SWITCH(NAT,R0,RM)
      USE CONTINUUM_CONTROL_MODULE
      USE NET_MODULE
      IMPLICIT NONE
      TYPE (FACETYPE),POINTER :: FACE
...
!
      ...
      ENDDO
!
      END SUBROUTINE CONTINUUM__SWITCH
!
!     ================================================================
!
      SUBROUTINE CONTINUUM__SET_THERMOSTAT(TNOSEQ,TSTPNQ,AVEKINQ,FNOSEQ)
      USE CONTINUUM_CONTROL_MODULE
      IMPLICIT NONE
...
!
      END SUBROUTINE CONTINUUM__SET_THERMOSTAT
!
!     ================================================================
...
!
!
      SUBROUTINE CONTINUUM__NOSE_THERMOSTAT(EKINQ,FRICTION)
      USE CONTINUUM_CONTROL_MODULE
      IMPLICIT NONE
!
...
!
      ...
      NOSE_ENERGY=0.5D0*NOSE_MASS*((NOSE_P-NOSE_M)/(2.D0*TIMESTEP))&
        &**2+GKBT*NOSE_0
      CALL ENERGYLIST__SET('CHARGE THERMOSTAT',NOSE_ENERGY)
      CALL ENERGYLIST__ADD('CONSTANT ENERGY',NOSE_ENERGY)
!
...
!     ==============================================================
!
      END SUBROUTINE CONTINUUM__NOSE_THERMOSTAT
!
!
!
      SUBROUTINE CONTINUUM__SETL4(ID_,VALUE_)
      USE CONTINUUM_CONTROL_MODULE
      IMPLICIT NONE
...
!
      ...
      ENDIF
!
      END SUBROUTINE CONTINUUM__SETL4
!
!
!
      SUBROUTINE CONTINUUM__SETR8(ID_,VALUE_)
      USE CONTINUUM_CONTROL_MODULE
      IMPLICIT NONE
      CHARACTER(*) :: ID_
      REAL(8)      :: VALUE_
!
      ...
      ENDIF
!
      END SUBROUTINE CONTINUUM__SETR8
!
!
!
      SUBROUTINE CONTINUUM__SETR8A(ID_,LENGTH_,VALUE_)
      USE CONTINUUM_CONTROL_MODULE
      IMPLICIT NONE
      CHARACTER(*) :: ID_
      INTEGER(4)   :: LENGTH_
...
!
      ...
      ENDIF
!
      END SUBROUTINE CONTINUUM__SETR8A
!
!
!
      SUBROUTINE CONTINUUM__SETCHA(ID_,LENGTH_,VALUE_)
      USE CONTINUUM_CONTROL_MODULE
      IMPLICIT NONE
      CHARACTER(*)  :: ID_
      INTEGER(4)    :: LENGTH_
...
!
      ...
      IF (ID_ == 'TESS') THEN
       ...
       IF (NAT /= LENGTH_) THEN
        ...
        CALL ERROR__STOP('CONTINUUM__SETCHA')
       END IF
       DO I=1,LENGTH_
         WRITE(FILEID(I),FMT='("TESS",I4)')I
         CALL FILEHANDLER__SETFILE(FILEID(I),.FALSE.,VALUE_(I))
         CALL FILEHANDLER__SETSPECIFICATION(FILEID(I),'FORM','FORMATTED')
       ENDDO
      ...
      DEALLOCATE(FILEID)
!
      END SUBROUTINE CONTINUUM__SETCHA
!
!
!
      SUBROUTINE CONTINUUM__SETI4(ID_,VALUE_)
      USE CONTINUUM_CONTROL_MODULE
      IMPLICIT NONE
      CHARACTER(*),INTENT(IN):: ID_
...
!
      ...
      ENDIF
!
      END SUBROUTINE CONTINUUM__SETI4
!
!
!
      SUBROUTINE CONTINUUM__PRLINE(NFILO)
      USE CONTINUUM_CONTROL_MODULE
      IMPLICIT NONE
      INTEGER :: NFILO
...
!
      ...
      PRINT*,NETCHARGE,INSIDE_CHARGE,POSITIVE_INTEGRAL,&
        & NEGATIVE_INTEGRAL,INSIDE_PLUS,INSIDE_MINUS
!
      END SUBROUTINE CONTINUUM__PRLINE
!
!
!
!     ..................................................................
      SUBROUTINE CONTINUUM__READ(NFIL,NFILO,TCHK)
!     ******************************************************************
!     ******************************************************************
...
!
      IF(SEPARATOR%VERSION.NE.MYSEPARATOR%VERSION) THEN
        ...
        CALL ERROR__STOP('CONTINUUM__READ')
      END IF
...
!
!     ..................................................................
      SUBROUTINE CONTINUUM__WRITE(NFIL,NFILO,TCHK)
!     ******************************************************************
      USE RESTART_INTERFACE
