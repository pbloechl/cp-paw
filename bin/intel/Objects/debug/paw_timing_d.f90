...
!**       TIMING__CLOCKON AND TIMING__CLOCKOFF BEFORE AND AFTER         **
!**    3) PRINT OUT A REPORT USING TIMING__PRINT                       **
!**                                                                   **
!**  FUNCTIONS                                                        **
!**    TIMING__START                INITIALIZES TOTAL TIME             **
!**    TIMING__CLOCKON(ID)          STARTS CLOCK FOR IDENTIFIER        **
!**    TIMING__CLOCKOFF(ID)         STOPS CLOCK FOR IDENTIFIER         **
!**    TIMING__PRINT(ID)            PRINT REPORT FOR IDENTIFIER        **
!**    TIMING__PRINT('ALL')         PRINT FULL REPORT                  **
!**                                                                   **
!**  METHODS:                                                         **
!**    TIMING_CLOCK                                                   **
!**    TIMING_CONVERT                                                 **
...
!
!     ..................................................................
      SUBROUTINE TIMING__CLOCKON(ID_)
!     ******************************************************************
!     ******************************************************************
      USE TIMING_MODULE
      IMPLICIT NONE
...
!     ******************************************************************
      IF(.NOT.STARTED) THEN
        CALL ERROR__MSG('WARNING FORM TIMING CLOCK HAS NOT BEEN STARTED')
        CALL ERROR__MSG('CALL TIMING__START BEFORE ANY OTHER FUNCTON')
        CALL ERROR__STOP('TIMING__CLOCKON')
      END IF
!
!     ==================================================================
!     ==  FIND CORRECT CLOCK                                          ==
...
!     ==================================================================
      IF(IENTRY.EQ.0) THEN
        IF(NENTRY.GE.NENTRYX) THEN
          CALL ERROR__MSG('WARNING FROM TIMING TOO MANY ENTRIES:')
          CALL ERROR__MSG('INCREASE PARAMETER NENTRIX IN SUBROUTINE TIMING')
          CALL ERROR__STOP('TIMING__CLOCKON')
          RETURN
        END IF
        NENTRY=NENTRY+1
...
!
!     ..................................................................
      SUBROUTINE TIMING__CLOCKOFF(ID_)
!     ******************************************************************
!     ==  CLOCK OFF                                                   ==
!     ******************************************************************
      USE TIMING_MODULE
...
!     ******************************************************************
      CALL TIMING_CLOCK(TIME)
      IF(.NOT.STARTED) THEN
        CALL ERROR__MSG('CLOCK HAS NOT BEEN STARTED')
        CALL ERROR__MSG('CALL TIMING__START BEFORE ANY OTHER FUNCTON')
        CALL ERROR__STOP('TIMING__CLOCKOFF')
      END IF
!
!     ==================================================================
!     ==  FIND CORRECT CLOCK                                          ==
...
!
!     ..................................................................
      SUBROUTINE TIMING__PRINT(NFIL,ID_)
!     ******************************************************************
...
!     ==================================================================
      ISVAR=NENTRY
      CALL MPE__BROADCAST(1,ISVAR)
      IF(ISVAR.NE.NENTRY) THEN
        CALL ERROR__MSG('INCONSISTENT TIMING TABLES ON PARALLEL TASKS')
        CALL ERROR__STOP('TIMING__REPORT')
      END IF
!
!     ==================================================================
...
!     ==================================================================
      ...
      CALL MPE__GATHER(1,TLOCAL,TIMEVAL)
