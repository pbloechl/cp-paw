...
!**                                                                   **
!**  FUNCTIONS:                                                       **
!**    SELFTEST__START(DENT_,LENG_,VAL_,DIFFAMP_)                      **
!**    SELFTEST__END(IDENT_,LENG_,VAL_,ENERGY_,TBACK)                  **
!**                                                                   **
!**  USAGE:                                                           **
!**    1) CALL SELFTEST__START WITH THE REFERENCE CONFIGURATION        **
!**       AND CONTINUE FORCE AND ENERGY CALCULATION WITH OUTPUT       **
!**       VALUE                                                       **
!**    2) AFTER ENERGIES AND FORCES HAVE BEEN COMPUTED,               **
!**       CALL SELFTEST__END                                           **
!**    3) IF TBACK=TRUE JUMP TO SELFTEST__BACK                         **
...
!**                                                                   **
!**    EXAMPLE:                                                       **
!**      1234   SELFTEST__START('TEST1',5,POS,1.D-3)                   **
!**             .....                                                 **
!**             SELFTEST__END(TEST1,5,FORCE,ENERGY,TBACK)              **
!**             IF(TBACK) GOTO 1234                                   **
!**                                                                   **
!**  DEPENDENCIES:                                                    **
!**    ERROR                                                          **
...
!**       SELFTEST__START AND BEFORE SELFTEST__END                      **
!**                                                                   **
!***********************************************************************
...
!
!     ..................................................................
      SUBROUTINE SELFTEST__START(IDENT_,LENG_,VAL_,DIFFAMP_)
!     ******************************************************************
!     **                                                              **
!     ******************************************************************
      USE SELFTEST_MODULE
...
!
!     ..................................................................
      SUBROUTINE SELFTEST__END(IDENT_,LENG_,FORCE,ENERGY_,TBACK)
!     ******************************************************************
!     **                                                              **
!     ******************************************************************
      USE SELFTEST_MODULE
...
!     ==================================================================
      IF(IDENT_.NE.IDENT.OR.LENG_.NE.LENG) THEN
        CALL ERROR__MSG('IDENTIFIER OR LENGTH INCONSISTENT')
