...
CALL TIMING__CLOCKON('W:SPHERE')
      ...
      DO IAT=THISTASK,NAT,NTASKS   ! DISTRIBUTE WORK ACCROSS TASKS
        ...
        CALL AUGMENTATION__SPHERE(ISP,IAT,LMNX,NDIMD,DENMAT1 &
          ...
          DO ISPIN=1,NSPIN
            ...
            DO IB=1,NBH
              ...
              IF(TSUPER) THEN
                DO IDIM=1,NDIM
                  PSIP(:,IDIM)=PSI1(:,IDIM)
                  CALL PLANEWAVE__INVERTG(NGL,PSIP(1,IDIM),PSIM(1,IDIM))
              ...
              IF(TSUPER) THEN
                DO IDIM=1,NDIM
                  CALL PLANEWAVE__COLLECTC8(1,NGL,PSI2(1,IDIM),NGG,PSIG(1,IDIM))
                ENDDO
                IF(THISTASK.EQ.1) THEN
                  WRITE(NFIL,ERR=9999,IOSTAT=IOS)PSIG !<<<<<<<<<<<<<<<<<<<
                  NREC1=NREC1+1
...
!       ================================================================
        IF(TSTRESS) THEN
          DO I=1,3
            ...
            ENDDO
          ENDDO
          CALL PLANEWAVE__SCALARPRODUCT('=',NGL,NDIM,3,PSI1,3,PSI1,CMAT)
        ...
        ELSE
          DO IDIM=1,NDIM
            ...
            ENDDO
          ENDDO
          CALL PLANEWAVE__SCALARPRODUCT(' ',NGL,NDIM,1,PSI1,1,PSI(1,1,IB) &
     &                                    ,CMAT)
...
!
!     ..................................................................
      SUBROUTINE WAVES__PROPAGATE_OLD()
!     ******************************************************************
!     **                                                              **
!     **  PROPAGATES WAVE FUNCTIONS                                   **
!     **                                                              **
...
!     ==================================================================
      ...
      DO IKPT=1,NKPT
        ...
        DO ISPIN=1,NSPIN
          ...
          NBH=THIS%NBH
          ALLOCATE(ARR(NGL))
          CALL PLANEWAVE__GETR8A('G2',NGL,ARR)
          DO IG=1,NGL
