...
!
!      .................................................................
       SUBROUTINE VEXT__SETUNBIND(IAT1,IAT2,E0)
!      *****************************************************************
!      **                                                             **
!      **                                                             **
!      **                                                             **
...
!      *****************************************************************
       ...
       FORCE(:,:)=FORCE(:,:)+FORCE1(:,:)
       CALL ENERGYLIST__SET('EXTERNAL POTENTIAL',ENERGY)
       CALL ENERGYLIST__ADD('CONSTANT ENERGY',ENERGY)
...
!      =================================================================
       DO IAT=1,NAT
         ...
         CALL ATOMTYPELIST__GETI4('IZ',IZ(IAT))
         CALL PERIODICTABLE__GET(IZ(IAT),'R(VDW)',RVDW(IAT))
         CALL PERIODICTABLE__GET(IZ(IAT),'R(COV)',RCOV(IAT))
