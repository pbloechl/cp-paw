      ...
      call constants__get(string,val)
      return
      end
      subroutine constants__list(nfil)
      IMPLICIT NONE
      integer(4),intent(in) :: nfil
      call constants__report(nfil)
      return
      end
!     ==================================================================
!     ==================================================================
...
!
!     ..................................................................
      SUBROUTINE CONSTANTS__get(id_,VAL)
!     ******************************************************************
!     **                                                              **
...
!     ******************************************************************
      ...
      IF(TRIM(id_).EQ.'HELP') THEN
        CALL CONSTANTS__LIST(6)
        RETURN
      END IF
      CALL ERROR__MSG('STRING NOT FOUND IN ROUTINE CONSTANTS')
      CALL ERROR__CHVAL('STRING=',id_)
      CALL ERROR__STOP('CONSTANTS')
      RETURN
      END
!
!     ..................................................................
      SUBROUTINE CONSTANTS__report(NFIL)
!     ******************************************************************
!     **                                                              **
...
!
!     ..................................................................
      SUBROUTINE CONSTANTS__LISTCONVERSION(NFIL)
!     ******************************************************************
!     **                                                              **
