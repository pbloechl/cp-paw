...
!**    CLOCK__NOW       RETURNS THE CURRENT TIME IN ONE OF THE THREE   **
!**                    FORMATS                                        **
!**    CLOCK__TIMESTAMP(DATE_TIME,STAMP) PRODUCES A PRINTABLE TIMESTAMP**
...
!       ***************************************************************
        IF(NOW%MONTH.LT.1.OR.NOW%MONTH.GT.12) THEN
           CALL ERROR__MSG('MONTH IS NOT IN A VALID RANGE')
           CALL ERROR__STOP('CLOCK: TIMESTAMP')
        END IF
!       ================================================================
