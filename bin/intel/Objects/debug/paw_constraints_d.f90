...
!     ******************************************************************
      IF(TINI) RETURN
      CALL LINKEDLIST__NEW(LL_CNSTR)
      TINI=.TRUE.
      RETURN
      END
!
!     ..................................................................
      SUBROUTINE CONSTRAINTS__OPEN(TYPE_,TITLE_)
!     ******************************************************************
!     **  CONSTRAINTS__OPEN                                            **
!     ******************************************************************
      USE CONSTRAINTS_MODULE
...
!
      IF(TSET) THEN
        CALL ERROR__MSG('ADDING OF FURTHER CONSTRAINTS NOT ALLOWED')
        CALL ERROR__STOP('CONSTRAINTS__OPEN')
      END IF
!
      IF(TOPEN) THEN
        CALL ERROR__MSG('CANNOT ADD CONSTRAINT WHILE ADDING ANOTHER')
        CALL ERROR__STOP('CONSTRAINTS__OPEN')
      END IF
!
      CALL LINKEDLIST__SELECT(LL_CNSTR,'~')
      CALL LINKEDLIST__SELECT(LL_CNSTR,'CONSTRAINT',-1)
      TYPE=TYPE_
      CALL LINKEDLIST__SET(LL_CNSTR,'TYPE',0,TYPE)
      STRING=TITLE_
      CALL LINKEDLIST__SET(LL_CNSTR,'TITLE',0,STRING)
      TOPEN=.TRUE.
      TON=.TRUE.
      RETURN
      END
!#TEMPLATE CONSTRAINTS__DEFINE
...
!!
!!     ..................................................................
!      SUBROUTINE CONSTRAINTS__DEFINE<TYPEID><RANKID>(IDENT_<,NBYTE_>,VAL_)
!!     ******************************************************************
!!     **  CONSTRAINTS__DEFINE                                          **
!!     ******************************************************************
!      USE CONSTRAINTS_MODULE
...
!      IF(TSET) THEN
!        CALL ERROR__MSG('ADDING OF FURTHER CONSTRAINTS NOT ALLOWED')
!        CALL ERROR__STOP('CONSTRAINTS__DEFINE')
!      ELSE IF(.NOT.TOPEN) THEN
!        CALL ERROR__MSG('CANNOT SET DATA UNLESS CONSTRAINT IS OPEN')
!        CALL ERROR__STOP('CONSTRAINTS__DEFINE')
!      END IF
!!
!!     ===================================================================
...
!!     ===================================================================
!      IF(TOPEN) THEN
!        CALL LINKEDLIST__GET(LL_CNSTR,'TYPE',1,TYPE)
...
!          NOPTION=13
!        ELSE
!          CALL ERROR__MSG('CONSTRAINT TYPE NOT RECOGNIZED')
!          CALL ERROR__CHVAL('TYPE',TYPE)
!          CALL LINKEDLIST__GET(LL_CNSTR,'TITLE',1,TITLE)
!          CALL ERROR__CHVAL('TITLE',TITLE)
!          CALL ERROR__STOP('CONSTRAINTS__OPEN')
!        END IF
!!
!        TCHK=.FALSE.
...
!        ENDDO
!        IF(.NOT.TCHK) THEN
!          CALL ERROR__MSG('DATA IDENTIFIER NOT RECOGNIZED')
!          CALL ERROR__CHVAL('IDENT_',IDENT_)
!          CALL ERROR__STOP('CONSTRAINTS__DEFINE')
!        END IF
!      END IF
!!
...
!!     ==   SET OPTION                                                  ==
!!     ===================================================================
!      CALL LINKEDLIST__SET(LL_CNSTR,IDENT_,0,VAL_)
!      RETURN
!      END
!#INSTANCES
!
!     ..................................................................
      SUBROUTINE CONSTRAINTS__DEFINER8(IDENT_,VAL_)
!     ******************************************************************
!     **  CONSTRAINTS__DEFINE                                          **
!     ******************************************************************
      USE CONSTRAINTS_MODULE
...
!
!     ..................................................................
      SUBROUTINE CONSTRAINTS__DEFINEI4(IDENT_,VAL_)
!     ******************************************************************
!     **  CONSTRAINTS__DEFINE                                          **
!     ******************************************************************
      USE CONSTRAINTS_MODULE
...
!
!     ..................................................................
      SUBROUTINE CONSTRAINTS__DEFINEL4(IDENT_,VAL_)
!     ******************************************************************
!     **  CONSTRAINTS__DEFINE                                          **
!     ******************************************************************
      USE CONSTRAINTS_MODULE
...
!
!     ..................................................................
      SUBROUTINE CONSTRAINTS__DEFINECH(IDENT_,VAL_)
!     ******************************************************************
!     **  CONSTRAINTS__DEFINE                                          **
!     ******************************************************************
      USE CONSTRAINTS_MODULE
...
!
!     ..................................................................
      SUBROUTINE CONSTRAINTS__DEFINER8A(IDENT_,NBYTE_,VAL_)
!     ******************************************************************
!     **  CONSTRAINTS__DEFINE                                          **
!     ******************************************************************
      USE CONSTRAINTS_MODULE
...
!
!     ..................................................................
      SUBROUTINE CONSTRAINTS__DEFINEI4A(IDENT_,NBYTE_,VAL_)
!     ******************************************************************
!     **  CONSTRAINTS__DEFINE                                          **
!     ******************************************************************
      USE CONSTRAINTS_MODULE
      ...
      CHARACTER(*),INTENT(IN) :: IDENT_
   INTEGER(4)  ,INTENT(IN) :: NBYTE_
      INTEGER(4)      ,INTENT(IN) :: VAL_(NBYTE_)
      LOGICAL(4)              :: TCHK
      CHARACTER(32)           :: TYPE
      INTEGER(4)              :: NOPTION
      CHARACTER(32)           :: OPTION(32)
...
!
!     ..................................................................
      SUBROUTINE CONSTRAINTS__DEFINEL4A(IDENT_,NBYTE_,VAL_)
!     ******************************************************************
!     **  CONSTRAINTS__DEFINE                                          **
!     ******************************************************************
      USE CONSTRAINTS_MODULE
      ...
      CHARACTER(*),INTENT(IN) :: IDENT_
   INTEGER(4)  ,INTENT(IN) :: NBYTE_
      LOGICAL(4)      ,INTENT(IN) :: VAL_(NBYTE_)
      LOGICAL(4)              :: TCHK
      CHARACTER(32)           :: TYPE
      INTEGER(4)              :: NOPTION
      CHARACTER(32)           :: OPTION(32)
...
!
!     ..................................................................
      SUBROUTINE CONSTRAINTS__DEFINECHA(IDENT_,NBYTE_,VAL_)
!     ******************************************************************
!     **  CONSTRAINTS__DEFINE                                          **
!     ******************************************************************
      USE CONSTRAINTS_MODULE
      ...
      CHARACTER(*),INTENT(IN) :: IDENT_
   INTEGER(4)  ,INTENT(IN) :: NBYTE_
      CHARACTER(*)      ,INTENT(IN) :: VAL_(NBYTE_)
      LOGICAL(4)              :: TCHK
      CHARACTER(32)           :: TYPE
      INTEGER(4)              :: NOPTION
      CHARACTER(32)           :: OPTION(32)
...
!     ===================================================================
      ...
      RETURN
      END
!#END TEMPLATE CONSTRAINTS__DEFINE
!
!     ..................................................................
      SUBROUTINE CONSTRAINTS__CLOSE
!     ******************************************************************
!     **  CONSTRAINTS__CLOSE                                           **
!     ******************************************************************
      USE CONSTRAINTS_MODULE
...
!     ******************************************************************
      CALL CONSTRAINTS_INITIALIZE
      IF(.NOT.TOPEN) THEN
        CALL ERROR__MSG('CANNOT CLOSE CONSTRAINT THAT IS NOT OPEN')
        CALL ERROR__STOP('CONSTRAINTS__CLOSE')
      END IF
!     == CHECK WHETHER PRINTOUT IS REQUESTED =======================
      CALL LINKEDLIST__EXISTD(LL_CNSTR,'SHOW',1,TCHK)
      IF(.NOT.TCHK)CALL LINKEDLIST__SET(LL_CNSTR,'SHOW',0,.FALSE.)
!
      TOPEN=.FALSE.
      RETURN
      END
!
!     ..................................................................
      SUBROUTINE CONSTRAINTS__SETREFERENCE(rbas,NAT_,R0_,RM_,RMASS_,DELT)
!     ******************************************************************
...
!     ******************************************************************
      ...
      CALL LINKEDLIST__SELECT(LL_CNSTR,'~')
      IF(TSET) THEN
        CALL ERROR__MSG('CONSTRAINTS ALREADY INITIALIZED')
        CALL ERROR__STOP('CONSTRAINTS__SETREFERENCE')
      END IF
      TSET=.TRUE.
      CALL LINKEDLIST__SET(LL_CNSTR,'REFERENCE',0,R0_)
      CALL LINKEDLIST__SET(LL_CNSTR,'ICOUNT',0,1)
      ALLOCATE(RREF(3,NAT))
      CALL LINKEDLIST__GET(LL_CNSTR,'REFERENCE',1,RREF)
      TSET=.TRUE.
      TREF=.TRUE.
      NDEG=3*NAT
      IC=0
      CALL LINKEDLIST__SELECT(LL_CNSTR,'~')
      CALL LINKEDLIST__NLISTS(LL_CNSTR,'CONSTRAINT',NUM)
      DO I=1,NUM
        CALL LINKEDLIST__SELECT(LL_CNSTR,'~')
        CALL LINKEDLIST__SELECT(LL_CNSTR,'CONSTRAINT',I)
        CALL LINKEDLIST__GET(LL_CNSTR,'TYPE',1,TYPE)
!
!       ==  BONDLENGTH =================================================
        STRING='BONDLENGTH'
        IF(TYPE.EQ.STRING(1:32)) THEN
          CALL LINKEDLIST__GET(LL_CNSTR,'ATOM1',1,STRING)
          CALL ATOMLIST__INDEXX(STRING,IAT1,it1)
          CALL LINKEDLIST__GET(LL_CNSTR,'ATOM2',1,STRING)
          CALL ATOMLIST__INDEXX(STRING,IAT2,IT2)
          NC1=1
          CALL LINKEDLIST__SET(LL_CNSTR,'NC1',0,NC1)
!
          ALLOCATE(S0(NC1))
          ALLOCATE(SM(NC1))
...
!       ==  GENERAL LINEAR =============================================
        ...
        IF(TYPE.EQ.STRING(1:32)) THEN
          ALLOCATE(VEC(3,NAT))
          CALL LINKEDLIST__GET(LL_CNSTR,'VEC',1,VEC)
          NC1=1
          CALL LINKEDLIST__SET(LL_CNSTR,'NC1',0,NC1)
          ALLOCATE(S0(NC1))
          ALLOCATE(SM(NC1))
...
!         ==  FIXATOM   ================================================
        STRING='FIXATOM'
        IF(TYPE.EQ.STRING(1:32)) THEN
          CALL LINKEDLIST__GET(LL_CNSTR,'ATOM',1,STRING)
          CALL ATOMLIST__INDEX(STRING,IAT)
          NC1=3
          CALL LINKEDLIST__SET(LL_CNSTR,'NC1',0,NC1)
!
          ALLOCATE(S0(NC1))
...
!       ==  FIXGROUP  ==================================================
        STRING='FIXGROUP'
        IF(TYPE.EQ.STRING(1:32)) THEN
          CALL LINKEDLIST__GET(LL_CNSTR,'GROUP',1,STRING)
          ALLOCATE(TMEMBER(NAT))

          CALL GROUPLIST__MEMBERS(STRING,NAT,TMEMBER)
          NC1=0
          DO IAT=1,NAT
...
!         == RIGID =====================================================
        ...
        IF(TYPE.EQ.STRING(1:32)) THEN
          ...
          CALL GROUPLIST__MEMBERS(STRING,NAT_,TMEMBER)
          NMEMBER=0
          DO IAT=1,NAT_
          ...
          IF(NMEMBER.EQ.2) THEN
            NC1=1
            CALL ERROR__MSG('USE BONDLENGTH CONSTRAINT, IF TWO ATOMS')
            CALL ERROR__MSG('SHALL BE KEPT RIGID')
            CALL ERROR__STOP('CONSTRAINTS__SETREFERENCE')
          END IF
          CALL LINKEDLIST__SET(LL_CNSTR,'NC1',0,NC1)
          CALL CONSTRAINTS_RIGID__BASIS(NAT,TMEMBER,R0_,IAT1,IAT2,IAT3)
          CALL LINKEDLIST__SET(LL_CNSTR,'IAT1',0,IAT1)
          CALL LINKEDLIST__SET(LL_CNSTR,'IAT2',0,IAT2)
          CALL LINKEDLIST__SET(LL_CNSTR,'IAT3',0,IAT3)
!
          ALLOCATE(S0(NC1))
          ALLOCATE(SM(NC1))
          CALL CONSTRAINTS_RIGID__VALUE(NAT,TMEMBER,R0_,IAT1,IAT2,IAT3 &
     &                          ,NC1,S0)
          PRINT*,'IAT1,IAT2,IAT3 ',IAT1,IAT2,IAT3
          PRINT*,'NC1 ',NC1
          PRINT*,'S0 ',(S0(III),III=1,NC1)
          CALL CONSTRAINTS_RIGID__VALUE(NAT,TMEMBER,RM_,IAT1,IAT2,IAT3 &
     &                          ,NC1,SM)
          DEALLOCATE(TMEMBER)
        ENDIF
!
!         ==  TRANSLATIONALMOMENTUM  =====================================
        ...
        IF(TYPE.EQ.STRING(1:32)) THEN
          ...
          CALL LINKEDLIST__GET(LL_CNSTR,'GROUP',1,STRING)
          CALL GROUPLIST__MEMBERS(STRING,NAT,TMEMBER)
          CALL LINKEDLIST__GET(LL_CNSTR,'DIR',1,VEC)
!
          ALLOCATE(S0(NC1))
          ALLOCATE(SM(NC1))
...
!       ==  ANGULARMOMENTUM ==========================================
        ...
        IF(TYPE.EQ.STRING(1:32)) THEN
          ...
          CALL GROUPLIST__MEMBERS(STRING,NAT,TMEMBER)
          ALLOCATE(VEC(3,1))
          CALL LINKEDLIST__GET(LL_CNSTR,'PHI',1,VEC)
          ALLOCATE(S0(NC1))
          ALLOCATE(SM(NC1))
          CALL CONSTRAINTS_ROT__VALUE(NAT,VEC(1,1),VEC(2,1),VEC(3,1) &
...
!         ==  ORIENTATION  =============================================
        ...
        IF(TYPE.EQ.STRING(1:32)) THEN
          ...
          CALL LINKEDLIST__GET(LL_CNSTR,'GROUP',1,STRING)
          CALL GROUPLIST__MEMBERS(STRING,NAT,TMEMBER)
          CALL LINKEDLIST__GET(LL_CNSTR,'PHI',1,PHI)
          ALLOCATE(VEC(3,NAT))
...
!         == CONVERT INTO GENERALLINEAR ==============================
          TYPE='GENERALLINEAR'
          CALL LINKEDLIST__SET(LL_CNSTR,'TYPE',0,TYPE)
          CALL LINKEDLIST__sET(LL_CNSTR,'VEC',0,VEC)
          NC1=1
          CALL LINKEDLIST__SET(LL_CNSTR,'NC1',0,NC1)
          ALLOCATE(S0(NC1))
          ALLOCATE(SM(NC1))
...
!       ==  MIDPLANE==================================================
        ...
        IF(TYPE.EQ.STRING(1:32)) THEN
          ...
          CALL LINKEDLIST__GET(LL_CNSTR,'ATOM2',1,STRING)
          CALL ATOMLIST__INDEXx(STRING,IAT2,it2)
          CALL LINKEDLIST__GET(LL_CNSTR,'ATOM3',1,STRING)
          CALL ATOMLIST__INDEXx(STRING,IAT3,it3)
!
          ALLOCATE(S0(NC1))
          ALLOCATE(SM(NC1))
...
!       ==  COGSEP    ===============================================
        ...
        IF(TYPE.EQ.STRING(1:32)) THEN
          NC1=1
          CALL LINKEDLIST__SET(LL_CNSTR,'NC1',0,NC1)
          CALL LINKEDLIST__GET(LL_CNSTR,'GROUP1',1,STRING)
          CALL LINKEDLIST__GET(LL_CNSTR,'GROUP2',1,STRING1)
!
          ALLOCATE(S0(NC1))
          ALLOCATE(SM(NC1))
...
!       ==  BONDANGLE  ===============================================
        ...
        IF(TYPE.EQ.STRING(1:32)) THEN
          ...
          CALL LINKEDLIST__SET(LL_CNSTR,'NC1',0,NC1)
          CALL LINKEDLIST__GET(LL_CNSTR,'ATOM1',1,STRING)
          CALL ATOMLIST__INDEX(STRING,IAT1)
          CALL LINKEDLIST__GET(LL_CNSTR,'ATOM2',1,STRING)
          CALL ATOMLIST__INDEX(STRING,IAT2)
          CALL LINKEDLIST__GET(LL_CNSTR,'ATOM3',1,STRING)
          CALL ATOMLIST__INDEX(STRING,IAT3)
!
          ALLOCATE(S0(NC1))
          ALLOCATE(SM(NC1))
...
!       ==  TORSION =================================================
        ...
        IF(TYPE.EQ.STRING(1:32)) THEN
          ...
          CALL LINKEDLIST__GET(LL_CNSTR,'ATOM3',1,STRING)
          CALL ATOMLIST__INDEX(STRING,IAT3)
          CALL LINKEDLIST__GET(LL_CNSTR,'ATOM4',1,STRING)
          CALL ATOMLIST__INDEX(STRING,IAT4)
!
          ALLOCATE(S0(NC1))
          ALLOCATE(SM(NC1))
...
!
!       ==  GENERAL PROPERTIES  ======================================
        CALL LINKEDLIST__EXISTD(LL_CNSTR,'S0',1,TCHK)
        IF(TCHK) THEN
          CALL LINKEDLIST__EXISTD(LL_CNSTR,'SM',1,TCHK1)
          IF(.NOT.TCHK1) THEN
            CALL LINKEDLIST__SET(LL_CNSTR,'SM',0,S0)
          END IF
        ELSE
          CALL LINKEDLIST__SET(LL_CNSTR,'S0',0,S0)
          CALL LINKEDLIST__SET(LL_CNSTR,'SM',0,SM)
        END IF
!
        CALL LINKEDLIST__EXISTD(LL_CNSTR,'FLOAT',1,TCHK)
        IF(TCHK) THEN
          CALL LINKEDLIST__EXISTD(LL_CNSTR,'ANNES',1,TCHK1)
          IF(.NOT.TCHK1)THEN
            ANNES=0.D0
            CALL LINKEDLIST__SET(LL_CNSTR,'ANNES',0,ANNES)
          END IF
          CALL LINKEDLIST__EXISTD(LL_CNSTR,'SMASS',1,TCHK1)
          IF(.NOT.TCHK1)THEN
            CALL CONSTANTS('U',SMASS)
            CALL LINKEDLIST__SET(LL_CNSTR,'SMASS',0,SMASS)
          END IF
        ELSE
          CALL LINKEDLIST__SET(LL_CNSTR,'FLOAT',0,.FALSE.)
        END IF
!
!       ==============================================================
!       ==  CHECK PARAMETERS FOR MOVING CONSTRAINTS                 ==
!       ==============================================================
        CALL LINKEDLIST__EXISTD(LL_CNSTR,'MOVE',1,TCHK)
        IF(.NOT.TCHK)CALL LINKEDLIST__SET(LL_CNSTR,'MOVE',0,.FALSE.)
        CALL LINKEDLIST__GET(LL_CNSTR,'MOVE',1,TCHK)
        IF(TCHK) THEN
!         == CHECK FINAL VALUE OF THE CONSTRAINT =====================
          CALL LINKEDLIST__EXISTD(LL_CNSTR,'SFINAL',1,TCHK1)
          SETS=TCHK1
          CALL LINKEDLIST__SET(LL_CNSTR,'SETS',0,SETS)
          IF(SETS) THEN
            CALL LINKEDLIST__SIZE(LL_CNSTR,'SFINAL',1,NBYTE)
            IF(NBYTE.NE.NC1) THEN
              CALL ERROR__MSG('SIZE OF SFINAL INCORRECT')
              CALL ERROR__CHVAL('TYPE',TYPE)
              CALL ERROR__STOP('CONSTRAINTS__SETREFERENCE')
            END IF
          ELSE
            CALL LINKEDLIST__SET(LL_CNSTR,'SFINAL',0,S0)
          END IF
!           == CHECK FINAL VELOCITY OF THE CONSTRAINT ==================
          CALL LINKEDLIST__EXISTD(LL_CNSTR,'VFINAL',1,TCHK1)
          SETV=TCHK1
          CALL LINKEDLIST__SET(LL_CNSTR,'SETV',0,SETV)
          IF(SETV) THEN
            CALL LINKEDLIST__SIZE(LL_CNSTR,'VFINAL',1,NBYTE)
            IF(NBYTE.NE.NC1) THEN
              CALL ERROR__MSG('SIZE OF VFINAL INCORRECT')
              CALL ERROR__CHVAL('TYPE',TYPE)
              CALL ERROR__STOP('CONSTRAINTS__SETREFERENCE')
            END IF
          ELSE
            ...
            DO II=1,NC1
              VF(II)=0.D0
            ENDDO
            CALL LINKEDLIST__SET(LL_CNSTR,'VFINAL',0,VF)
            DEALLOCATE(VF)
          END IF
          CALL LINKEDLIST__EXISTD(LL_CNSTR,'NSTEP',1,TCHK1)
          IF(.NOT.TCHK1) THEN
            CALL ERROR__MSG('NSTEP MUST BE SET WHEN CONSTRAINTS MOVE')
            CALL ERROR__CHVAL('TYPE',TYPE)
            CALL ERROR__STOP('CONSTRAINTS__SETREFERENCE')
          END IF
        END IF
...
!
!     ..................................................................
      SUBROUTINE CONSTRAINTS__NFREE(NAT_,NFREE_)
!     ******************************************************************
...
!
!     ..................................................................
      SUBROUTINE CONSTRAINTS__SWITCH
!     ******************************************************************
!     **  STEP FORWARD                                                **
!     ******************************************************************
      USE CONSTRAINTS_MODULE
...
!     ******************************************************************
      IF(.NOT.TON) RETURN
      CALL LINKEDLIST__SELECT(LL_CNSTR,'~')
      CALL LINKEDLIST__GET(LL_CNSTR,'ICOUNT',1,ICOUNT)
      ICOUNT=ICOUNT+1
      CALL LINKEDLIST__SET(LL_CNSTR,'ICOUNT',0,ICOUNT)
!
      CALL LINKEDLIST__NLISTS(LL_CNSTR,'CONSTRAINT',NUM)
      DO I=1,NUM
        CALL LINKEDLIST__SELECT(LL_CNSTR,'~')
        CALL LINKEDLIST__SELECT(LL_CNSTR,'CONSTRAINT',I)
        CALL LINKEDLIST__GET(LL_CNSTR,'NC1',1,NC1)
        ALLOCATE(S0(NC1))
        CALL LINKEDLIST__GET(LL_CNSTR,'S0',1,S0)
        CALL LINKEDLIST__SET(LL_CNSTR,'SM',1,S0)
        CALL LINKEDLIST__GET(LL_CNSTR,'SP',1,S0)
        CALL LINKEDLIST__SET(LL_CNSTR,'S0',1,S0)
        DEALLOCATE(S0)
      ENDDO
      RETURN
      END
!
!     .................................................................
      SUBROUTINE CONSTRAINTS__APPLY(rbas,NAT,R0,RP,RMASS,FORCE,DELT)
!     ******************************************************************
!     **  APPLY CONSTRAINTS                                           **
!     ******************************************************************
      USE CONSTRAINTS_MODULE
...
!     ******************************************************************
      IF(.NOT.TON) RETURN
                            CALL TIMING__CLOCKON('CONSTRAINTS')
                            CALL TRACE__PUSH('CONSTRAINTS__APPLY')
      IF(.NOT.TSET) THEN
        CALL ERROR__MSG('CONSTRAINTS OBJECT NOT INITIALIZED')
        CALL ERROR__STOP('CONSTRAINTS__APPLY')
      END IF
      CALL LINKEDLIST__SELECT(LL_CNSTR,'~')
      IF(NC.EQ.0) RETURN
      ALLOCATE(A(NC))
...
!     ================================================================
      ...
      CALL ENERGYLIST__SET('CONSTRAINT KINETIC ENERGY',EKINS)
      DEALLOCATE(RLAM)
                            CALL TIMING__CLOCKOFF('CONSTRAINTS')
                            CALL TRACE__POP
      RETURN
      END
!     ..................................................................
...
!     ******************************************************************
      ...
      DO I=1,NUM
        CALL LINKEDLIST__SELECT(LL_CNSTR,'~')
        CALL LINKEDLIST__SELECT(LL_CNSTR,'CONSTRAINT',I)
        CALL LINKEDLIST__GET(LL_CNSTR,'IC',1,IC)
        CALL LINKEDLIST__GET(LL_CNSTR,'NC1',1,NC1)
        CALL LINKEDLIST__SET(LL_CNSTR,'FC',0,RLAM(IC:IC+NC1-1))
        ALLOCATE(S0(NC1))
        ALLOCATE(SM(NC1))
        ALLOCATE(SP(NC1))
        CALL LINKEDLIST__GET(LL_CNSTR,'S0',1,S0)
        CALL LINKEDLIST__GET(LL_CNSTR,'SM',1,SM)
        CALL LINKEDLIST__GET(LL_CNSTR,'FLOAT',1,TFLOAT)
        CALL LINKEDLIST__GET(LL_CNSTR,'MOVE',1,TMOVE)
        IF(TFLOAT) THEN
          CALL LINKEDLIST__GET(LL_CNSTR,'ANNES',1,ANNES)
          CALL LINKEDLIST__GET(LL_CNSTR,'SMASS',1,SMASS)
          DO II=1,NC1
            CALL CONSTRAINTS_FLOATS(S0(II),SM(II),SP(II),DELT &
     &                             ,SMASS,ANNES,-RLAM(IC+II-1),DEKIN)
          ENDDO
          EKINS=EKINS+DEKIN
          CALL LINKEDLIST__SET(LL_CNSTR,'SP',0,SP)
        ELSE IF(TMOVE) THEN
          CALL LINKEDLIST__GET(LL_CNSTR,'NSTEP',1,NSTEP)
          CALL LINKEDLIST__GET(LL_CNSTR,'SETS',1,SETS)
          CALL LINKEDLIST__GET(LL_CNSTR,'SETV',1,SETV)
          ALLOCATE(SF(NC1))
          ALLOCATE(VF(NC1))
          CALL LINKEDLIST__GET(LL_CNSTR,'SFINAL',1,SF)
          CALL LINKEDLIST__GET(LL_CNSTR,'VFINAL',1,VF)
          DO II=1,NC1
     ...
     &                      ,DELT,NSTEP,SETS,SF(II),SETV,VF(II))
          ...
          DEALLOCATE(VF)
        ELSE
          CALL LINKEDLIST__SET(LL_CNSTR,'SP',0,S0)
        END IF
        DEALLOCATE(S0)
        DEALLOCATE(SM)
        DEALLOCATE(SP)
...
!
      ...
      DO I=1,NUM
        ...
        CALL LINKEDLIST__SELECT(LL_CNSTR,'CONSTRAINT',I)
        CALL LINKEDLIST__GET(LL_CNSTR,'TYPE',1,TYPE)
        CALL LINKEDLIST__SET(LL_CNSTR,'IC',0,IC)
        CALL LINKEDLIST__GET(LL_CNSTR,'NC1',1,NC1)
!
!     ==  BONDLENGTH =================================================
        STRING='BONDLENGTH'
...
!       ==  TRANSLATIONALMOMENTUM  ===================================
        ...
        IF(TYPE.EQ.STRING(1:32)) THEN
          CALL LINKEDLIST__GET(LL_CNSTR,'GROUP',1,STRING)
          CALL GROUPLIST__MEMBERS(STRING,NAT,TMEMBER)
          CALL LINKEDLIST__GET(LL_CNSTR,'DIR',1,DIR)
...
!       ==  ANGULARMOMENTUM ==========================================
        ...
        IF(TYPE.EQ.STRING(1:32)) THEN
          CALL LINKEDLIST__GET(LL_CNSTR,'GROUP',1,STRING)
          CALL GROUPLIST__MEMBERS(STRING,NAT,TMEMBER)
          CALL LINKEDLIST__GET(LL_CNSTR,'PHI',1,DIR)
          CALL CONSTRAINTS_ROT__SET &
...
!       ==  RIGID  ===================================================
        ...
        IF(TYPE.EQ.STRING(1:32)) THEN
          CALL LINKEDLIST__GET(LL_CNSTR,'GROUP',1,STRING)
          CALL GROUPLIST__MEMBERS(STRING,NAT,TMEMBER)
          CALL LINKEDLIST__GET(LL_CNSTR,'IAT1',1,IAT1)
          CALL LINKEDLIST__GET(LL_CNSTR,'IAT2',1,IAT2)
          CALL LINKEDLIST__GET(LL_CNSTR,'IAT3',1,IAT3)
          CALL CONSTRAINTS_RIGID__SET(NAT,TMEMBER,R0,IAT1,IAT2,IAT3 &
...
!
      IF(IC.NE.NC+1) THEN
        CALL ERROR__MSG('NUMBER OF CONSTRAINTS INCONSISTENT')
        CALL ERROR__I4VAL('IC',IC)
        CALL ERROR__I4VAL('NC',NC)
        CALL ERROR__STOP('CONSTRAINTS__APPLY')
      END IF
      RETURN
      END
!
!     ..................................................................
      SUBROUTINE CONSTRAINTS__REPORT(NFIL,IDENT_)
!     ******************************************************************
!     **  RETURN NUMBER OF CONSTRAINTS                                **
!     ******************************************************************
      USE CONSTRAINTS_MODULE
...
!     ******************************************************************
      ...
      IF(TLONG) THEN
        CALL REPORT__TITLE(NFIL,'CONSTRAINTS')
      END IF
      CALL LINKEDLIST__SELECT(LL_CNSTR,'~')
      CALL LINKEDLIST__NLISTS(LL_CNSTR,'CONSTRAINT',NUM)
      IF(NUM.EQ.0) THEN
      ...
      DO I=1,NUM
        ...
        CALL LINKEDLIST__SELECT(LL_CNSTR,'CONSTRAINT',I)
        CALL LINKEDLIST__GET(LL_CNSTR,'TYPE',1,TYPE)
        CALL LINKEDLIST__GET(LL_CNSTR,'TITLE',1,STRING)
        IF(.NOT.TLONG) THEN
          CALL LINKEDLIST__GET(LL_CNSTR,'SHOW',1,TCHK)
          CALL LINKEDLIST__GET(LL_CNSTR,'NC1',1,NC1)
          IF(TSET.AND.TCHK) THEN
            ALLOCATE(S0(NC1))
            ALLOCATE(SM(NC1))
            CALL LINKEDLIST__GET(LL_CNSTR,'S0',1,S0)
            CALL LINKEDLIST__GET(LL_CNSTR,'FC',1,SM)
...
!
!     ..................................................................
      SUBROUTINE CONSTRAINTS_ROT__VALUE &
...
!
!     ..................................................................
      SUBROUTINE CONSTRAINTS_ROT__SET(NAT,X_,Y_,Z_,TMEMBER,R0,DELTA,RMASS,A,B,C)
!     ******************************************************************
...
!     ==================================================================
      CALL ATOMLIST__GETR8A('MASS',0,NAT,RMASS)
      CALL GROUPLIST__MEMBERS(GROUP1,NAT,TMEMBER1)
      CALL GROUPLIST__MEMBERS(GROUP2,NAT,TMEMBER2)
!
!     ==================================================================
...
!            CALL ERROR__MSG('ATOM CAN ONLY BE MEMBER OF ONE GROUP')
!            CALL ERROR__STOP('CONSTRAINTS_COGSEPVALUE')
!          ENDIF
...
!
!     ..................................................................
      SUBROUTINE CONSTRAINTS_RIGID__BASIS(NAT,TMEMBER,R,IAT1_,IAT2_,IAT3_)
!     ******************************************************************
!     **  CONSTRAINTS_RIGID__BASIS                                     **
!     ******************************************************************
      IMPLICIT NONE
      INTEGER(4),INTENT(IN) :: NAT
      LOGICAL(4),INTENT(IN) :: TMEMBER(NAT)
...
!
!     ..................................................................
      SUBROUTINE CONSTRAINTS_RIGID__VALUE(NAT,TMEMBER,R,IAT1_,IAT2_,IAT3_ &
     &                          ,NC,VALUE_)
!     ******************************************************************
!     **  CONSTRAINTS_RIGID__VALUE                                     **
!     ******************************************************************
      IMPLICIT NONE
      INTEGER(4),INTENT(IN) :: NAT
      LOGICAL(4),INTENT(IN) :: TMEMBER(NAT)
      ...
      DO IAT=1,NAT
        IF(TMEMBER(IAT)) THEN
          IF(IAT.NE.IAT1_.AND.IAT.NE.IAT2_.AND.IAT.NE.IAT3_) THEN
            IF(IC+3.GT.NC) THEN
              CALL ERROR__MSG('NC SMALLER THAN EXPECTED')
              CALL ERROR__I4VAL('NC',NC)
              CALL ERROR__I4VAL('IC',IC)
              CALL ERROR__STOP('CONSTRAINTS_RIGID__VALUE')
            END IF
...
!
!     ..................................................................
      SUBROUTINE CONSTRAINTS_RIGID__SET(NAT,TMEMBER,R,IAT1_,IAT2_,IAT3_ &
     &                       ,NC,A,B,C)
!     ******************************************************************
!     **  CONSTRAINTS_RIGID__SET                                       **
!     ******************************************************************
      IMPLICIT NONE
      INTEGER(4),INTENT(IN) :: NAT
      LOGICAL(4),INTENT(IN) :: TMEMBER(NAT)
...
!     ==   work3d(j,n1,n2)=sum_i c(i,j,n1)*g(i,n2)
      call lib__scalarproductr8(.false.,nx,nx*nc,c,nc,g,work3d)
!     ==   cc(n3,n1,n2)=sum_i g(i,n3)*work3d(i,n1,n2)
      call lib__scalarproductr8(.false.,nx,nc,g,nc*nc,work3d,cc)
!
!     ==   bb(n1,n2)=sum_i xp(i)*work3d(i,n1,n2)
      call lib__scalarproductr8(.false.,nx,1,xp,nc*nc,work3d,bb)
      deallocate(work3d)
!
      allocate(work2d(nc,nc))
!     ===  work2d(n1,n2)=sum_i b(i,n1)*g(i,n2)
      call lib__scalarproductr8(.false.,nx,nc,b,nc,g,work2d)
...
!     == work3d(j,n1)=b(j,n1)+sum_i xp(i)*c(i,j,n1)
      call lib__scalarproductr8(.false.,nx,1,xp,nx*nc,c,work2d)
      work2d(:,:)=0.5d0*work2d(:,:)+b(:,:)
!     == aa=a+sum_i xp(i)*work3d(i,n)
      call lib__scalarproductr8(.false.,nx,1,xp,nc,work2d,aa)
      aa(:)=a(:)+aa(:)
      deallocate(work2d)
else
...
!       PRINT*,'DEVIATION IN CONSTRAINT',abs(vec)
        ...
        IF(.NOT.(SVAR.LE.0.OR.SVAR.GT.0)) THEN
          CALL ERROR__MSG('DEVIATION VECTOR IS NOT A NUMERICAL QUANTITY')
          CALL ERROR__R8VAL('DEVIATION',SVAR)
          CALL ERROR__STOP('CONSTRAINTS_APPLY')
        END IF
        IF(TCONV) GOTO 100
!
...
!         __ CHECK LINEAR DEPENDENCE OF CONSTRAINTS_____________________
          IF(TLINDEP) THEN
            TAUSINGVAL=1.D-8
            call LIB__MATRIXSOLVE(Nc,nc,1,rmat,vec,vec)
          ELSE
            call LIB__MATRIXSOLVE(Nc,nc,1,rmat,vec,vec)
          END IF
        ELSE
...
!     ==================================================================
      IF(TTEST) THEN
        DO IC=1,NC
          ...
          END IF
          IF(DABS(SVAR).GT.TOL) THEN
            CALL ERROR__MSG('CONSTRAINT TEST FAILED')
            CALL ERROR__I4VAL('IC (CONSTRAINT NO.)',IC)
            CALL ERROR__R8VAL('ERROR',SVAR)
            CALL ERROR__STOP('CONSTRAINTS_APPLY')
          END IF
        ENDDO
      ENDIF
...
!
!     ..................................................................
      SUBROUTINE SYMMETRIZE__INITIALIZE(NSYM_,NAT_)
!     ******************************************************************
!     ******************************************************************
...
!
!     ..................................................................
      SUBROUTINE SYMMETRIZE__SETSYMMETRY(RMAT_,ORIGIN_,NAT_,MAP_)
!     ******************************************************************
!     ******************************************************************
      USE SYMMETRIZE_MODULE
      IMPLICIT NONE
...
!     ******************************************************************
      IF(.NOT.TOFF) THEN
        CALL ERROR__STOP('SYMMETRIZE__SETSYMMETRY')
      END IF
      IF(NAT_.NE.NAT) THEN
        CALL ERROR__STOP('SYMMETRIZE__SETSYMMETRY')
      END IF
...
!
!     ..................................................................
      SUBROUTINE SYMMETRIZE__FORCE(NAT_,F_)
!     ******************************************************************
!     ******************************************************************
      USE SYMMETRIZE_MODULE
      IMPLICIT NONE
...
!
!     ..................................................................
      SUBROUTINE SYMMETRIZE__POSITION(NAT_,R_)
!     ******************************************************************
!     ******************************************************************
      USE SYMMETRIZE_MODULE
      IMPLICIT NONE
...
!     ******************************************************************
      IF(TOFF) RETURN
      IF(NAT_.NE.NAT) THEN
        CALL ERROR__STOP('SYMMETRIZE__POSITION')
      END IF
      DO IAT=1,NAT
        DO I=1,3
          XNEW(I,IAT)=0.D0
