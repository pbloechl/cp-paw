...
!     ******************************************************************
      ...
      ELSE
        ...
        CALL ERROR__STOP('PDOS__GETI4')
      END IF
      RETURN
      END
!
!     ..................................................................
      SUBROUTINE PDOS__SETI4(ID,VAL)
      USE PDOS_MODULE
      IMPLICIT NONE
      CHARACTER(*),INTENT(IN) :: ID
...
!     ******************************************************************
      ...
      ELSE
        CALL ERROR__MSG('ID NOT RECOGNIZED')
        CALL ERROR__CHVAL('ID',ID)
        CALL ERROR__STOP('PDOS__SETI4')
      END IF
      RETURN
      END
!
!     ..................................................................
      SUBROUTINE PDOS__SETI4A(ID,LEN,VAL)
      USE PDOS_MODULE
      IMPLICIT NONE
      CHARACTER(*),INTENT(IN) :: ID
...
!     ******************************************************************
      ...
      ELSE
        CALL ERROR__MSG('ID NOT RECOGNIZED')
        CALL ERROR__CHVAL('ID',ID)
        CALL ERROR__STOP('PDOS__SETI4A')
      END IF
      RETURN
      END
!
!     ..................................................................
      SUBROUTINE PDOS__GETI4A(ID,LEN,VAL)
      USE PDOS_MODULE
      IMPLICIT NONE
      CHARACTER(*),INTENT(IN) :: ID
      INTEGER(4)  ,INTENT(IN) :: LEN
...
!     ******************************************************************
      IF(ID.EQ.'LNX') THEN
        ...
        IF(.NOT.ALLOCATED(LNX)) THEN
          CALL ERROR__MSG('REQUESTED QUANTITY HAS NOT BEEN SET')
          CALL ERROR__CHVAL('ID',ID)
          CALL ERROR__STOP('PDOS__GETI4')
        END IF
        VAL=LNX
      ...
      ELSE IF(ID.EQ.'NB') THEN
        IF(NKPT*NSPIN.EQ.0) THEN
          CALL ERROR__MSG('NKPT AND NSPIN MUST BE DEFINED')
          CALL ERROR__CHVAL('ID',ID)
      ...
      ELSE
        CALL ERROR__MSG('ID NOT RECOGNIZED')
        CALL ERROR__CHVAL('ID',ID)
        CALL ERROR__STOP('PDOS__GETI4A')
      END IF
      RETURN
      END
!
!     ..................................................................
      SUBROUTINE PDOS__GETR8A(ID,LEN,VAL)
      USE PDOS_MODULE
      IMPLICIT NONE
      CHARACTER(*),INTENT(IN) :: ID
      INTEGER(4)  ,INTENT(IN) :: LEN
...
!
!     ..................................................................
      SUBROUTINE PDOS__SETR8A(ID,LEN,VAL)
      USE PDOS_MODULE
      IMPLICIT NONE
      CHARACTER(*),INTENT(IN) :: ID
      INTEGER(4)  ,INTENT(IN) :: LEN
...
!     ==================================================================
 ...
 9999 CONTINUE
      ...
      CALL ERROR__MSG('ERROR reading pdos FILE')
      ...
      CALL ERROR__I4VAL('NPRO',NPRO)
      CALL ERROR__STOP('PDOS__READ')
      END SUBROUTINE PDOS__READ
!
!     ..................................................................
      SUBROUTINE PDOS__WRITE(NFIL)
!     ******************************************************************
!     **  WAVES__GET                                                   **
!     **  GET                                                         **
!     ******************************************************************
