...
!     .................................................................
      ...
      CALL MPE__QUERY(NTASK,ITASK)
      TFIRST=.TRUE.
      END SUBROUTINE TRACE_FIRST
END MODULE TRACE_MODULE
!
!     .................................................................
      SUBROUTINE TRACE__SETL4(ID,VAL)
!     ******************************************************************
!     ******************************************************************
      USE TRACE_MODULE
      IMPLICIT NONE
...
!     ******************************************************************
      ...
      ELSE
        ...
        CALL ERROR__STOP('TRAVCE__SETL4')
      END IF
      RETURN
      END
!
!     .................................................................
      SUBROUTINE TRACE__PUSH(CURRENT_)
!     ******************************************************************
!     ******************************************************************
      USE TRACE_MODULE
      IMPLICIT NONE
...
!
!     .................................................................
      SUBROUTINE TRACE__WRITEHISTORY(NFILERR)
!     ******************************************************************
!     ******************************************************************
      USE TRACE_MODULE
      IMPLICIT NONE
