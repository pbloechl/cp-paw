...
!     *****************************************************************
      call lib__getusage(id,val)
      return
      end
!     .................................................................
      SUBROUTINE USAGE__REPORT(NFIL)
!     *****************************************************************
!     **                                                             **
!     **  PROVIDES INFORMATION  ON THE USAGE OF SYSTEM RESOURCES     **
!     **                                                             **
...
!     =================================================================
      CALL LIB__GETUSAGE('CPUTIME',LOCARRAY(1))
      CALL LIB__GETUSAGE('USRTIME',LOCARRAY(2))
      CALL LIB__GETUSAGE('SYSTIME',LOCARRAY(3))
      CALL LIB__GETUSAGE('MAXMEM',LOCARRAY(4))
      CALL LIB__GETUSAGE('SWAPRATE',LOCARRAY(5))
      CALL LIB__GETUSAGE('SWITCHRATE',LOCARRAY(6))
!
!     =================================================================
!     == AVERAGE OVER ALL NODES                                      ==
!     =================================================================
      ALLOCATE(GLOBARRAY(NITEM,NTASKS))
      CALL MPE__GATHER(1,LOCARRAY,GLOBARRAY)
