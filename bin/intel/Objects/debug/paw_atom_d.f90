...
!       ................................................................
        ...
        IF(NB.EQ.0) THEN
          CALL ERROR__MSG('CANNOT MAKE AEATOM')
          CALL ERROR__MSG('NB NOT SET')
          CALL ERROR__STOP('MKAEATOM')
        END IF
        IF(NR.EQ.0) THEN
          CALL ERROR__MSG('CANNOT MAKE AEATOM')
          CALL ERROR__MSG('NR NOT SET')
          CALL ERROR__STOP('MKAEATOM')
        END IF
        ALLOCATE(AEPOT(NR))
        ALLOCATE(AECORE(NR))
...
!       .............................................................
        SUBROUTINE PROJECTION__LMAX(LMAX)
        IMPLICIT NONE
        INTEGER(4),INTENT(OUT):: LMAX
        LMAX=MAXVAL(LPHI)
        END SUBROUTINE PROJECTION__LMAX
!       .............................................................
        SUBROUTINE PROJECTION__NPRO(L,NPRO)
        IMPLICIT NONE
...
!       ****************************************************************
        ...
        ENDDO
        END SUBROUTINE PROJECTION__NPRO
!       ................................................................
        SUBROUTINE PROJECTION__POT(L,NPRO,PROL,AEPHIL,PSPHIL,DATHL,DTKINL,DOL)
        IMPLICIT NONE
        INTEGER(4),INTENT(IN) :: L
...
!       ****************************************************************
        ...
        DO I1=1,NPRO
          J1=INDEX(I1)
          if(j1.eq.0) then
            call error__msg('out of range')
            call error__stop('PROJECTION__POT')
          end if
        ...
        DO I1=1,NPRO
          ...
          END DO
        ENDDO
        END SUBROUTINE PROJECTION__POT
...
!     ==================================================================
      ...
      CALL FILEHANDLER__SETFILE('PROT',.FALSE.,TRIM(ROOTNAME)//-'.PROT')
      CALL FILEHANDLER__SETSPECIFICATION('PROT','STATUS','UNKNOWN')
      CALL FILEHANDLER__SETSPECIFICATION('PROT','POSITION','APPEND')
      CALL FILEHANDLER__SETSPECIFICATION('PROT','ACTION','WRITE')
      CALL FILEHANDLER__SETSPECIFICATION('PROT','FORM','FORMATTED')
!
!     ==================================================================
!     == DEFINE INPUT FILE                                            ==
!     ==================================================================
      CALL FILEHANDLER__SETFILE('INPUT',.FALSE.,TRIM(ROOTNAME)//-'.ACNTL')
      CALL FILEHANDLER__SETSPECIFICATION('INPUT','STATUS','OLD')
      CALL FILEHANDLER__SETSPECIFICATION('INPUT','POSITION','REWIND')
      CALL FILEHANDLER__SETSPECIFICATION('INPUT','ACTION','READ')
      CALL FILEHANDLER__SETSPECIFICATION('INPUT','FORM','FORMATTED')
!
!     ==================================================================
!     == DEFINE SETUP FILE (OLD STYLE)                                ==
!     ==================================================================
      CALL FILEHANDLER__SETFILE('SETUPO',.FALSE.,TRIM(ROOTNAME)//-'.OUT')
      CALL FILEHANDLER__SETSPECIFICATION('SETUPO','STATUS','UNKNOWN')
      CALL FILEHANDLER__SETSPECIFICATION('SETUPO','POSITION','REWIND')
      CALL FILEHANDLER__SETSPECIFICATION('SETUPO','ACTION','WRITE')
      CALL FILEHANDLER__SETSPECIFICATION('SETUPO','FORM','FORMATTED')
!
!     ==================================================================
!     == DEFINE SETUP FILE                                            ==
!     ==================================================================
      CALL FILEHANDLER__SETFILE('SETUP',.FALSE.,TRIM(ROOTNAME)//-'.STP')
      CALL FILEHANDLER__SETSPECIFICATION('SETUP','STATUS','UNKNOWN')
      CALL FILEHANDLER__SETSPECIFICATION('SETUP','POSITION','REWIND')
      CALL FILEHANDLER__SETSPECIFICATION('SETUP','ACTION','WRITE')
      CALL FILEHANDLER__SETSPECIFICATION('SETUP','FORM','FORMATTED')
!
!     ==================================================================
!     == DEFINE  GRAPHICS FILE FOR PROJECTOR FUNCTIONS                ==
!     ==================================================================
      ID=+'PRO_S'
      CALL FILEHANDLER__SETFILE(ID,.FALSE.,TRIM(ROOTNAME)//-'.PROJECTORS_S')
      ...
      ID=+'PRO_P'
      CALL FILEHANDLER__SETFILE(ID,.FALSE.,TRIM(ROOTNAME)//-'.PROJECTORS_P')
      CALL FILEHANDLER__SETSPECIFICATION(ID,'STATUS','UNKNOWN')
      CALL FILEHANDLER__SETSPECIFICATION(ID,'POSITION','REWIND')
      CALL FILEHANDLER__SETSPECIFICATION(ID,'ACTION','WRITE')
      CALL FILEHANDLER__SETSPECIFICATION(ID,'FORM','FORMATTED')
      ID=+'PRO_D'
      CALL FILEHANDLER__SETFILE(ID,.FALSE.,TRIM(ROOTNAME)//-'.PROJECTORS_D')
      CALL FILEHANDLER__SETSPECIFICATION(ID,'STATUS','UNKNOWN')
      CALL FILEHANDLER__SETSPECIFICATION(ID,'POSITION','REWIND')
      CALL FILEHANDLER__SETSPECIFICATION(ID,'ACTION','WRITE')
      CALL FILEHANDLER__SETSPECIFICATION(ID,'FORM','FORMATTED')
      ID=+'PRO_F'
      CALL FILEHANDLER__SETFILE(ID,.FALSE.,TRIM(ROOTNAME)//-'.PROJECTORS_F')
      CALL FILEHANDLER__SETSPECIFICATION(ID,'STATUS','UNKNOWN')
      CALL FILEHANDLER__SETSPECIFICATION(ID,'POSITION','REWIND')
      CALL FILEHANDLER__SETSPECIFICATION(ID,'ACTION','WRITE')
      CALL FILEHANDLER__SETSPECIFICATION(ID,'FORM','FORMATTED')
...
!     ==================================================================
      ID=+'POT'
      CALL FILEHANDLER__SETFILE(ID,.FALSE.,TRIM(ROOTNAME)//-'.POTENTIALS')
      CALL FILEHANDLER__SETSPECIFICATION(ID,'STATUS','UNKNOWN')
      CALL FILEHANDLER__SETSPECIFICATION(ID,'POSITION','REWIND')
      CALL FILEHANDLER__SETSPECIFICATION(ID,'ACTION','WRITE')
      CALL FILEHANDLER__SETSPECIFICATION(ID,'FORM','FORMATTED')
...
!     ==================================================================
      ID=+'PHI_S'
      CALL FILEHANDLER__SETFILE(ID,.FALSE.,TRIM(ROOTNAME)//-'.PARTIALWAVES_S')
      CALL FILEHANDLER__SETSPECIFICATION(ID,'STATUS','UNKNOWN')
      CALL FILEHANDLER__SETSPECIFICATION(ID,'POSITION','REWIND')
      CALL FILEHANDLER__SETSPECIFICATION(ID,'ACTION','WRITE')
      CALL FILEHANDLER__SETSPECIFICATION(ID,'FORM','FORMATTED')
      ID=+'PHI_P'
      CALL FILEHANDLER__SETFILE(ID,.FALSE.,TRIM(ROOTNAME)//-'.PARTIALWAVES_P')
      CALL FILEHANDLER__SETSPECIFICATION(ID,'STATUS','UNKNOWN')
      CALL FILEHANDLER__SETSPECIFICATION(ID,'POSITION','REWIND')
      CALL FILEHANDLER__SETSPECIFICATION(ID,'ACTION','WRITE')
      CALL FILEHANDLER__SETSPECIFICATION(ID,'FORM','FORMATTED')
      ID=+'PHI_D'
      CALL FILEHANDLER__SETFILE(ID,.FALSE.,TRIM(ROOTNAME)//-'.PARTIALWAVES_D')
      CALL FILEHANDLER__SETSPECIFICATION(ID,'STATUS','UNKNOWN')
      CALL FILEHANDLER__SETSPECIFICATION(ID,'POSITION','REWIND')
      CALL FILEHANDLER__SETSPECIFICATION(ID,'ACTION','WRITE')
      CALL FILEHANDLER__SETSPECIFICATION(ID,'FORM','FORMATTED')
      ID=+'PHI_F'
      CALL FILEHANDLER__SETFILE(ID,.FALSE.,TRIM(ROOTNAME)//-'.PARTIALWAVES_F')
      CALL FILEHANDLER__SETSPECIFICATION(ID,'STATUS','UNKNOWN')
      CALL FILEHANDLER__SETSPECIFICATION(ID,'POSITION','REWIND')
      CALL FILEHANDLER__SETSPECIFICATION(ID,'ACTION','WRITE')
      CALL FILEHANDLER__SETSPECIFICATION(ID,'FORM','FORMATTED')
...
!     ==================================================================
      ID=+'EPWCONV'
      CALL FILEHANDLER__SETFILE(ID,.FALSE.,TRIM(ROOTNAME)//-'.EPWCONV')
      CALL FILEHANDLER__SETSPECIFICATION(ID,'STATUS','UNKNOWN')
      CALL FILEHANDLER__SETSPECIFICATION(ID,'POSITION','REWIND')
      CALL FILEHANDLER__SETSPECIFICATION(ID,'ACTION','WRITE')
      CALL FILEHANDLER__SETSPECIFICATION(ID,'FORM','FORMATTED')
...
!     ==================================================================
      ID=+'PHASESHIFT_S'
      CALL FILEHANDLER__SETFILE(ID,.FALSE.,TRIM(ROOTNAME)//-'.PHASESHIFT_S')
      CALL FILEHANDLER__SETSPECIFICATION(ID,'STATUS','UNKNOWN')
      CALL FILEHANDLER__SETSPECIFICATION(ID,'POSITION','REWIND')
      CALL FILEHANDLER__SETSPECIFICATION(ID,'ACTION','WRITE')
      CALL FILEHANDLER__SETSPECIFICATION(ID,'FORM','FORMATTED')
      ID=+'PHASESHIFT_P'
      CALL FILEHANDLER__SETFILE(ID,.FALSE.,TRIM(ROOTNAME)//-'.PHASESHIFT_P')
      CALL FILEHANDLER__SETSPECIFICATION(ID,'STATUS','UNKNOWN')
      CALL FILEHANDLER__SETSPECIFICATION(ID,'POSITION','REWIND')
      CALL FILEHANDLER__SETSPECIFICATION(ID,'ACTION','WRITE')
      CALL FILEHANDLER__SETSPECIFICATION(ID,'FORM','FORMATTED')
      ID=+'PHASESHIFT_D'
      CALL FILEHANDLER__SETFILE(ID,.FALSE.,TRIM(ROOTNAME)//-'.PHASESHIFT_D')
      CALL FILEHANDLER__SETSPECIFICATION(ID,'STATUS','UNKNOWN')
      CALL FILEHANDLER__SETSPECIFICATION(ID,'POSITION','REWIND')
      CALL FILEHANDLER__SETSPECIFICATION(ID,'ACTION','WRITE')
      CALL FILEHANDLER__SETSPECIFICATION(ID,'FORM','FORMATTED')
      ID=+'PHASESHIFT_F'
      CALL FILEHANDLER__SETFILE(ID,.FALSE.,TRIM(ROOTNAME)//-'.PHASESHIFT_F')
      CALL FILEHANDLER__SETSPECIFICATION(ID,'STATUS','UNKNOWN')
      CALL FILEHANDLER__SETSPECIFICATION(ID,'POSITION','REWIND')
      CALL FILEHANDLER__SETSPECIFICATION(ID,'ACTION','WRITE')
      CALL FILEHANDLER__SETSPECIFICATION(ID,'FORM','FORMATTED')
...
!     == READ INPUT FILE                                              ==
!     ==================================================================
      CALL FILEHANDLER__UNIT('INPUT',NFIL)
...
!     ==================================================================
      ...
      CALL TRACE__PASS('AFTER RESOLVEPAWATOMSINBUFFER')
!
!     ==================================================================
!     == WRITE HEADER                                                 ==
!     ==================================================================
     ...
     &         ," PROGRAM FOR PAW ATOMIC SETUPS "/72("="))')
      WRITE(NFILO,*)
      CALL REPORT__CHVAL(NFILO,'ELEMENT',ELEMENT)
      WRITE(NFILO,*)
...
!     ==================================================================
      ...
      CALL TRACE__PASS('AFTER ALLELECTRONATOM')
!
!     ==================================================================
...
!     ==================================================================
      CALL VTILDE(LL_CNTL)
      CALL TRACE__PASS('AFTER VTILDE')
!
!     ==================================================================
!     ==  CALCULATE PSEUDO CORE                                       ==
!     ==================================================================
      CALL PSEUDIZECORE(LL_CNTL)
      CALL TRACE__PASS('AFTER PSEUDIZECORE')
!
!     ==================================================================
!     ==  CALCULATE AE-PARTIAL WAVES                                  ==
!     ==================================================================
      CALL PARTIALWAVES(LL_CNTL)
      CALL TRACE__PASS('AFTER PARTIALWAVES')
!
!     ==================================================================
!     ==  CALCULATE PROJECTOR FUNCTIONS                               ==
!     ==================================================================
      CALL PROJECTORS
      CALL TRACE__PASS('AFTER PROJECTORS')
!
!     ==================================================================
!     ==  CALCULATE MAKEVHAT                                          ==
!     ==================================================================
      CALL MAKEVHAT
      CALL TRACE__PASS('AFTER MAKEVHAT')
!
!     ==================================================================
!     ==  WRITE OUTPUT FILE                                           ==
!     ==================================================================
      CALL WRITEOUT
      CALL TRACE__PASS('SETUP FILE WRITTEN (OLD STYLE)')
      CALL WRITESTP(LL_CNTL)
      CALL TRACE__PASS('SETUP FILE WRITTEN (NEW STYLE)')
!
!     ==================================================================
...
!     ==================================================================
      ...
      CALL WRITEGRAPHICS
      CALL TRACE__PASS('GRAPHICS FILES WRITTEN')
!
!     ==================================================================
!     ==  CALCULATE PLANE WAVE CONVERGENCE                            ==
!     ==================================================================
      CALL PWCONVERGENCE
      CALL TRACE__PASS('AFTER PWCONVERGENCE')
!
!     ==================================================================
...
!     ==================================================================
!     CALL PAWATOM
!     CALL TRACE__PASS('AFTER PAWATOM')
!
!     ==================================================================
!     ==  CALCULATE PAW ATOM                                          ==
!     ==================================================================!
      CALL CHARGETRANSFERABILITY
      CALL TRACE__PASS('AFTER CHARGETRANSFERABILITY')
      WRITE(NFILO,FMT='(72("=")/72("="),T20 &
     &         ," PROGRAM FINISHED "/72("="))')
      STOP
      END
...
!     **                                                              **
!     ******************************************************************
      USE PERIODICTABLE_MODULE, ONLY : PERIODICTABLE__GET
      USE LINKEDLIST_MODULE
...
!     ===================================================================
      ...
      CALL LINKEDLIST__EXISTD(LL_CNTL,'RBOX',1,TCHK)
      IF(.NOT.TCHK)CALL LINKEDLIST__SET(LL_CNTL,'RBOX',1,25.D0)
      CALL LINKEDLIST__GET(LL_CNTL,'RBOX',1,OUTERBOXRADIUS)
      CALL LINKEDLIST__EXISTD(LL_CNTL,'RAUG',1,TCHK)
      IF(.NOT.TCHK)CALL LINKEDLIST__SET(LL_CNTL,'RAUG',1,25.D0)
      CALL LINKEDLIST__GET(LL_CNTL,'RAUG',1,AUGMENTATIONRADIUS)
!
!     ==================================================================
!     ==  DEFINE RADIAL GRID                                          ==
!     ==  POSSIBLE CHOICE :                                           ==
...
!     ==================================================================
      CALL LINKEDLIST__SELECT(LL_CNTL,'~')
      CALL LINKEDLIST__SELECT(LL_CNTL,'ACNTL')
      CALL LINKEDLIST__SELECT(LL_CNTL,'RGRID')
      CALL LINKEDLIST__EXISTD(LL_CNTL,'R1',1,TCHK)
      IF(.NOT.TCHK)CALL LINKEDLIST__SET(LL_CNTL,'R1',0,1.056D-4)
      CALL LINKEDLIST__GET(LL_CNTL,'R1',1,R1)
      CALL LINKEDLIST__EXISTD(LL_CNTL,'DEX',1,TCHK)
      IF(.NOT.TCHK)CALL LINKEDLIST__SET(LL_CNTL,'DEX',0,0.05D0)
      CALL LINKEDLIST__GET(LL_CNTL,'DEX',1,DEX)
      CALL LINKEDLIST__EXISTD(LL_CNTL,'NR',1,TCHK)
      IF(.NOT.TCHK)CALL LINKEDLIST__SET(LL_CNTL,'NR',0,250)
      CALL LINKEDLIST__GET(LL_CNTL,'NR',1,NR)
      CALL CREATEGRID
!
!     ===================================================================
...
!     ===================================================================
      CALL LINKEDLIST__SELECT(LL_CNTL,'~')
      CALL LINKEDLIST__SELECT(LL_CNTL,'ACNTL')
      CALL LINKEDLIST__SELECT(LL_CNTL,'COMPENSATE')
      CALL LINKEDLIST__EXISTD(LL_CNTL,'RC',1,TCHK)
      IF(.NOT.TCHK)CALL LINKEDLIST__SET(LL_CNTL,'RC',0,0.3D0)
      CALL LINKEDLIST__GET(LL_CNTL,'RC',1,RCSMALL)
!
!     ==================================================================
!     ==  CREATE AEATOM                                          ==
!     ==================================================================
      ...
      CALL LINKEDLIST__SELECT(LL_CNTL,'ACNTL')
      CALL LINKEDLIST__SELECT(LL_CNTL,'GENERIC')
      CALL LINKEDLIST__GET(LL_CNTL,'ELEMENT',1,ELEMENT)
      CALL PERIODICTABLE__GET(ELEMENT,'Z',ISVAR)
      AEZ=DBLE(ISVAR)
      CALL LINKEDLIST__SELECT(LL_CNTL,'~')
      CALL LINKEDLIST__SELECT(LL_CNTL,'ACNTL')
      CALL LINKEDLIST__SELECT(LL_CNTL,'VALENCE')
      CALL LINKEDLIST__NLISTS(LL_CNTL,'STATE',NV)
      CALL LINKEDLIST__SELECT(LL_CNTL,'~')
      CALL LINKEDLIST__SELECT(LL_CNTL,'ACNTL')
      CALL LINKEDLIST__SELECT(LL_CNTL,'AECORE')
      CALL LINKEDLIST__NLISTS(LL_CNTL,'STATE',NC)
      NB=NC+NV
      CALL CREATEAEATOM
!
!     ==================================================================
...
!     ===================================================================
      ...
      DO IB=1,NC
        ITH=IB
        CALL LINKEDLIST__SELECT(LL_CNTL,'STATE',ITH)
        CALL LINKEDLIST__GET(LL_CNTL,'L',1,LB(IB))
        CALL LINKEDLIST__GET(LL_CNTL,'N',1,NNB(IB)); NNB(IB)=NNB(IB)-LB(IB)-1
        CALL LINKEDLIST__CONVERT(LL_CNTL,'F',1,'R(8)')
        CALL LINKEDLIST__GET(LL_CNTL,'F',1,FB(IB))
        CALL LINKEDLIST__SELECT(LL_CNTL,'..')
      ENDDO
      CALL LINKEDLIST__SELECT(LL_CNTL,'~')
      CALL LINKEDLIST__SELECT(LL_CNTL,'ACNTL')
...
!     ==================================================================
      AUX1=-AECORE(:)/Y0*R(:)**2
      CALL RADIAL__INTEGRAL(R1,DEX,NR,AUX1,ZCORE)
!     THE FOLLOWING LINE CREATES AN INTERFACE ERROR
!     CALL RADIAL__INTEGRAL(R1,DEX,NR,-AECORE(:)/Y0*R(:)**2,ZCORE)
      ZEFF=AEZ+ZCORE
      DO IB=1,NB
...
!       ================================================================
        IF(CONVG) THEN
          CALL REPORT__I4VAL(NFILO,"SCF LOOP CONVERGED AFTER ",ITER," ITERATIONS")
          CALL REPORT__R8VAL(NFILO,'AV. DIFF BETWEEN IN- AND OUTPUT POTENTIAL',XAV,'?')
          CALL REPORT__R8VAL(NFILO,'MAXIMUM  OF (VIN-VOUT)*R^2',XMAX,'?')
...
!       ================================================================
        ...
        CONVG=(XMAX.LT.TOL)
      ENDDO
      CALL ERROR__MSG('SELFCONSISTENCY LOOP NOT CONVERGED')
      CALL ERROR__STOP('AESCF')
      STOP
      END
!
!     ..................................................................
...
!     ******************************************************************
      IF(SWITCH.EQ.'GO') THEN
        IF(NR.NE.NRSAVE) THEN
          CALL ERROR__MSG('INCONSISTENT NUMBER OF GRIDPOINTS')
          CALL ERROR__STOP('MIXPOT')
        END IF
        XEXP=DEXP(DEX)
!       ================================================================
...
! RETURN
      POT(:)=0.D0
      CALL RADIAL__POISSON(R1,DEX,NR,0,RHO,POT)
      POT(:)=POT(:)-AEZ/R(:)/Y0
!
      CALL RADIAL__DERIVE(R1,DEX,NR,RHO(:),GRHO)
      DO IR=1,NR
        RH=RHO(IR)*Y0
        GRHO2=(Y0*GRHO(IR))**2
      ...
      ENDDO
      CALL RADIAL__DERIVE(R1,DEX,NR,GRHO(:),AUX)
...
!CALL RADIAL__DERIVE(R1,DEX,NR,RHOC+RHOV,GRHO)
!PRINT*,'R,RHOTOT,GRHO'
!DO IR=1,NR
...
!     ==================================================================
      IF(TALL) THEN
        ...
        ENDDO
        CALL RADIAL__INTEGRAL(R1,DEX,NR,AUX1,SVAR)
        EKINCC=EBANDCC-SVAR
      END IF
!
!     ==================================================================
...
!     ==================================================================
      ...
      ENDDO
      CALL RADIAL__INTEGRAL(R1,DEX,NR,AUX1,EKINV)
      EKINV=ESUM-EKINV
!
!     ==================================================================
!     ==  CORE CORE ELECTROSTATIC
!     ==================================================================
      CALL RADIAL__POISSON(R1,DEX,NR,0,RHOC,AUX3)
      DO IR=1,NR
        AUX1(IR)=RHOC(IR)*(0.5D0*AUX3(IR)*R(IR)**2-AEZ/Y0*R(IR))
      ENDDO
      CALL RADIAL__INTEGRAL(R1,DEX,NR,AUX1,EELCC)
!
!     ==================================================================
...
!     ==================================================================
      ...
      ENDDO
      CALL RADIAL__INTEGRAL(R1,DEX,NR,AUX1,EELVC)
!
!     ==================================================================
!     ==  VALENCE VALENCE ELECTROSTATIC
!     ==================================================================
      CALL RADIAL__POISSON(R1,DEX,NR,0,RHOV,AUX3)
      DO IR=1,NR
        AUX1(IR)=RHOV(IR)*0.5D0*AUX3(IR)*R(IR)**2
      ENDDO
      CALL RADIAL__INTEGRAL(R1,DEX,NR,AUX1,EELVV)
!
!     ==================================================================
!     ==  CORE CORE EXCHANGE
!     ==================================================================
      CALL RADIAL__DERIVE(R1,DEX,NR,RHOC,GRHO)
      DO IR=1,NR
        GRHO2=(Y0*GRHO(IR))**2
        RH=RHOC(IR)*Y0
        CALL DFT(RH,0.D0,GRHO2,0.D0,0.D0,EXC,VXC,DUMMY1,VGXC,DUMMY2,DUMMY3)
      ...
      ENDDO
      CALL RADIAL__INTEGRAL(R1,DEX,NR,AUX1,EXCCC)
!
!     ==================================================================
...
!       CALL DFT(RH,RH,GRHO2,GRHO2,GRHO2,EXC,VXC,DUMMY1,VGXC,DUMMY2,DUMMY3)
        AUX1(IR)=EXC*FOURPI*R(IR)**2
      ENDDO
      CALL RADIAL__INTEGRAL(R1,DEX,NR,AUX1,EXCVV)
      EXCVV=EXCVV-EXCCC
!
!     ==================================================================
...
!     ==  PRINTOUT
      CALL REPORT__TITLE(NFILO,'ALL-ELECTRON ATOMIC OUTPUT')
      CALL REPORT__R8VAL(NFILO,'ATOMIC NUMBER',AEZ,' ')
      CALL REPORT__R8VAL(NFILO,'TOTAL ENERGY',EKINV+EELVV+EELVC+EXCVV,'H')
      CALL REPORT__R8VAL(NFILO,'SUM OF ONE-PARTICLE ENERGIES',ESUM,'H')
      CALL REPORT__R8VAL(NFILO,'VALENCE KINETIC ENERGY',EKINV,'H')
      CALL REPORT__R8VAL(NFILO,'VALENCE ELECTROSTATIC ENERGY',EELVV+EELVC,'H')
      CALL REPORT__R8VAL(NFILO,'VALENCE EXCHANGE AND CORRELATION ENERGY',EXCVV,'H')
      CALL REPORT__R8VAL(NFILO,'CORE KINETIC ENERGY',EKINCC,'H')
      CALL REPORT__R8VAL(NFILO,'CORE ELECTROSTATIC ENERGY',EELCC,'H')
      CALL REPORT__R8VAL(NFILO,'CORE EXCHANGE AND CORRELATION ENERGY',EXCCC,'H')
      CALL REPORT__R8VAL(NFILO,'CORE ENERGY',EKINCC+EELCC+EXCCC,'H')
      WRITE(NFILO,6001)
...
!     ==================================================================
      CALL LINKEDLIST__SELECT(LL_CNTL,'~')
      CALL LINKEDLIST__SELECT(LL_CNTL,'ACNTL')
      CALL LINKEDLIST__SELECT(LL_CNTL,'VTILDE')
...
PRINT*,'TYPE ',TYPE
      IF(TRIM(TYPE).EQ.'POLYNOMIAL') THEN
        CALL LINKEDLIST__GET(LL_CNTL,'RC',1,RC)
!
        CALL LINKEDLIST__EXISTD(LL_CNTL,'POWER',1,TCHK)
        IF(.NOT.TCHK)CALL LINKEDLIST__SET(LL_CNTL,'POWER',0,2)
        CALL LINKEDLIST__GET(LL_CNTL,'POWER',1,NIN)
!
        CALL LINKEDLIST__EXISTD(LL_CNTL,'POT(0)',1,T0VAL)
        IF(T0VAL) THEN
          CALL LINKEDLIST__GET(LL_CNTL,'POT(0)',1,V0)
        ELSE
          V0=0.D0
        END IF
!
!       == REPORT PARAMETERS ===========================================
        CALL REPORT__CHVAL(NFILO,'TYPE',TYPE)
        CALL REPORT__STRING(NFILO,'FUNCTIONAL FORM: V(R)=A*R^N+B*R^(N+1) ')
        CALL REPORT__R8VAL(NFILO,'R_C',RC,'A0')
        CALL REPORT__I4VAL(NFILO,'LOWEST POWER (N) OF THE POLYNOMIAL',NIN,' ')
        IF(T0VAL) THEN
          CALL REPORT__R8VAL(NFILO,'V0',V0,'H')
        ELSE
          CALL REPORT__STRING(NFILO,'POTENTIAL AT THE ORIGIN NOT FIXED')
        END IF
!
!       ================================================================
!       ==  CONSTRUCT PSEUDOPOTENTIAL POTENTIAL                       ==
!       ================================================================
      ...
      ELSE IF(TRIM(TYPE).EQ.'HBS') THEN
        CALL TRACE__PASS('MARKE 0')
        CALL LINKEDLIST__GET(LL_CNTL,'RC',1,RC)
!
        CALL LINKEDLIST__EXISTD(LL_CNTL,'POWER',1,TCHK)
        IF(.NOT.TCHK)CALL LINKEDLIST__SET(LL_CNTL,'POWER',0,6.D0)
        CALL LINKEDLIST__GET(LL_CNTL,'POWER',1,POWER)
!
        CALL LINKEDLIST__EXISTD(LL_CNTL,'POT(0)',1,T0VAL)
        IF(T0VAL) THEN
          CALL LINKEDLIST__GET(LL_CNTL,'POT(0)',1,V0)
...
!       == REPORT PARAMETERS ===========================================
        CALL REPORT__CHVAL(NFILO,'TYPE',TYPE)
        CALL REPORT__STRING(NFILO,'FUNCTIONAL FORM: V(R)=V0*F(R)+(1-F(R))*V(R)')
        CALL REPORT__R8VAL(NFILO,'R_C',RC,'A0')
        CALL REPORT__I4VAL(NFILO,'LOWEST POWER (N) OF THE POLYNOMIAL',NIN,' ')
        IF(T0VAL) THEN
          CALL REPORT__R8VAL(NFILO,'V0',V0,'H')
...
!     ******************************************************************
      ...
      DO IR=1,NR
        PSPOT(IR)=AEPOT(IR)
      ENDDO
      CALL RADIAL__DERIVE(R1,DEX,NR,AEPOT,WORK)
      CALL RADIAL__VALUE(R1,DEX,NR,WORK,RC,DFDR)
      CALL RADIAL__VALUE(R1,DEX,NR,AEPOT,RC,FOFR)
...
!     ==================================================================
      CALL FILEHANDLER__UNIT('PROT',NFILO)
      WRITE(NFILO,FMT='("INFO FROM PSEUDIZEPOTENTIAL__FIT"/26("-"))')
...
!     ==================================================================
      CALL LINKEDLIST__SELECT(LL_CNTL,'~')
      CALL LINKEDLIST__SELECT(LL_CNTL,'ACNTL')
      CALL LINKEDLIST__SELECT(LL_CNTL,'PSCORE')
      CALL LINKEDLIST__GET(LL_CNTL,'TYPE',1,TYPE)
      IF(TRIM(TYPE).EQ.'POLYNOMIAL') THEN
!       == COLLECT PARAMETERS ==========================================
        CALL LINKEDLIST__GET(LL_CNTL,'RC',1,RC)
        ...
        IF(.NOT.TCHK)CALL LINKEDLIST__SET(LL_CNTL,'POWER',0,2)
        CALL LINKEDLIST__GET(LL_CNTL,'POWER',1,NIN)
        CALL LINKEDLIST__EXISTD(LL_CNTL,'RHO(0)',1,T0VAL)
        IF(T0VAL) THEN
          CALL LINKEDLIST__GET(LL_CNTL,'RHO(0)',1,V0)
        ELSE
          V0=0.D0
        END IF
!
!       == REPORT PARAMETERS ===========================================
        CALL REPORT__CHVAL(NFILO,'TYPE',TYPE)
        CALL REPORT__STRING(NFILO,'FUNCTIONAL FORM: RHO(R)=A*R^N+B*R^(N+1) ')
        CALL REPORT__R8VAL(NFILO,'R_C',RC,'A0')
        CALL REPORT__I4VAL(NFILO,'LOWEST POWER (N) OF THE POLYNOMIAL',NIN,' ')
        IF(T0VAL) THEN
          CALL REPORT__R8VAL(NFILO,'PSEUDO DENSITY AT THE NUCLEUS',V0,'E/A0^3 ')
        ELSE
          CALL REPORT__STRING(NFILO,'VALUE AT THE ORIGIN NOT FIXED')
        END IF
!
...
!     __ SCAN THROUGH WAVES_____________________________________________
      ...
      DO IWAVE=1,NWAVE
        ...
        CALL LINKEDLIST__GET(LL_CNTL,'L',1,LPHI(IWAVE))
        CALL LINKEDLIST__EXISTD(LL_CNTL,'N',1,TCHK1)
        IF(TCHK1) CALL LINKEDLIST__GET(LL_CNTL,'N',1,N)
        CALL LINKEDLIST__EXISTD(LL_CNTL,'E',1,TCHK2)
        IF(TCHK2) CALL LINKEDLIST__GET(LL_CNTL,'E',1,E)
        IF((TCHK1.AND.TCHK2).OR..NOT.(TCHK1.OR.TCHK2)) THEN
          CALL ERROR__MSG('EITHER N OR E MUST BE SPECIFIED')
          CALL ERROR__STOP('PARTIALWAVES')
        END IF
...
!         == ESTIMATE ENERGY ===========================================
          ...
          IF(.NOT.TCHK) THEN
            ...
            ENDDO
            IF(N.EQ.0) THEN
              CALL ERROR__MSG('MAIN QUANTUM NUMBER MUST NOT BE ZERO')
              CALL ERROR__STOP('PARTIALWAVES')
            END IF
...
!         == REPORT ENERGY TO LINKEDLIST ===============================
          EWAVE(IWAVE)=E
          CALL LINKEDLIST__SET(LL_CNTL,'E',0,E)
        ELSE
!         ==============================================================
!         == CALCULATE AE-WAVE FUNCTIONS TO BE PSEUDIZED              ==
...
!       == CALCULATE NUMBER OF NODES FOR THE PS-PARTIAL WAVE ===========
        ...
        ENDDO
!
        CALL LINKEDLIST__GET(LL_CNTL,'PSTYPE',1,PSTYPE)
        IF(TRIM(PSTYPE).EQ.'HBS') THEN
          CALL LINKEDLIST__GET(LL_CNTL,'RC',1,RC)
          CALL LINKEDLIST__CONVERT(LL_CNTL,'LAMBDA',1,'R(8)')
          CALL LINKEDLIST__GET(LL_CNTL,'LAMBDA',1,RLAMBDA)
          CUT(:)=DEXP(-(RGRID(:)/RC)**RLAMBDA)
          TNORM=.FALSE. !   CALL LINKEDLIST__GET(LL_CNTL,'NORMALIZE',1,TNORM)
          CALL REPORT__STRING(NFILO,'HAMANN-BACHELET-SCHLUTER-LIKE CONSTRUCTION')
          CALL REPORT__STRING(NFILO,'V(R)=V_PS(R)+C EXP[-(R/R_C)^LAMBDA] WITH ADJUSTABLE C')
          CALL REPORT__I4VAL(NFILO,'MAIN ANGULAR MOMENTUM',LPHI(IWAVE),' ')
          CALL REPORT__R8VAL(NFILO,'ENERGY',E,'H')
          CALL REPORT__R8VAL(NFILO,'R_C',RC,'A0')
          CALL REPORT__R8VAL(NFILO,'LAMBDA',RLAMBDA,' ')
        ELSE IF(TRIM(PSTYPE).EQ.'BESSEL') THEN
          CALL ERROR__MSG('OPTION BESSEL DOES NOT EXIST')
          CALL ERROR__STOP('PARTIALWAVES')
        ELSE
          CALL ERROR__MSG('OPTION NOT RECOGNIZED')
          CALL ERROR__STOP('PARTIALWAVES')
        END IF
...
!
!       == FIND NEW PREFACTOR  =======================================
        CALL RADIAL__INTEGRATE(R1,DEX,NR,R(:)**2*PSPHI(:,1)**2*CUT(:)*Y0,AUX)
        CALL RADIAL__VALUE(R1,DEX,NR,AUX,RMT,SVAR)
        CALL RADIAL__VALUE(R1,DEX,NR,PSPHI(:,1),RMT,PHI1)
        CALL RADIAL__VALUE(R1,DEX,NR,PSPHI(:,2),RMT,PHI2)
...
!       == RESTRICT STEPS OF PREFAC TO BE SMALLER THAN DPREX      ====
        ...
        PREFAC=PREFAC+DPRE
      ENDDO
      CALL ERROR__MSG('LOOP TO FIND PSEUDO PARTIAL WAVES NOT CONVERGED')
      CALL ERROR__STOP('HBS')
 1000 CONTINUE
      CALL REPORT__I4VAL(NFILO,'LOOP FOR PS-POTENTIAL CONVERGED AFTER',ITER,'ITERATIONS')
      CALL REPORT__R8VAL(NFILO,'FACTOR FOR VARIABLE POTENTIAL PART',PREFAC*Y0,'H')
      CALL REPORT__R8VAL(NFILO,'ACCCURACY OF FACTOR FOR VARIABLE POTENTIAL PART',DPRE*SVAR,'H')
      CALL REPORT__R8VAL(NFILO,'AE PHASE SHIFT',PHASAE,' ')
      CALL REPORT__R8VAL(NFILO,'PS PHASE SHIFT',PHASPS,' ')
!
!     ==================================================================
...
!     ==================================================================
      IF(TNORM) THEN
        CALL ERROR__MSG('TNORM=.TRUE. NOT ALLOWED')
        CALL ERROR__STOP('HBS')
      END IF
      RETURN
      CONTAINS
...
!       ================================================================
     ...
     &    ," TEST PARTIAL WAVE FOR L=",I2," AND E=",F10.5/72("-"))')L,E
        CALL RADIAL__VALUE(R1,DEX,NR,PHI(:,1),RMT,PHI1)
        CALL RADIAL__VALUE(R1,DEX,NR,PHI(:,2),RMT,PHI2)
...
!       ================================================================
     ...
     &                ,POT(:),PHITEST,AUX)
        CALL RADIAL__VALUE(R1,DEX,NR,PHITEST(:,1),RMT,PHI1)
        CALL RADIAL__VALUE(R1,DEX,NR,PHITEST(:,2),RMT,PHI2)
        DLGTEST=RMT*PHI2/PHI1
...
!         PRINT*,'ETEST',ETEST,EOLD,EOLD-ETEST
        ...
        ENDDO
        CALL ERROR__MSG('LOOP NOT CONVERGED')
        CALL ERROR__STOP('HBS/TEST')
 1100   CONTINUE
        CALL RADIAL__VALUE(R1,DEX,IRMT,PHITEST(:,1),RMT,PHI1)
        CALL RADIAL__VALUE(R1,DEX,IRMT,PHITEST(:,2),RMT,PHI2)
...
!      . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . .
       SUBROUTINE PHASESHIFT(R1,DEX,NR,R,PHI,PHASE)
        ...
        REAL(8)               :: PHI1,PHI2
        PI=4.D0*DATAN(1.D0)
        CALL RADIAL__VALUE(R1,DEX,NR,PHI(:,1),R,PHI1)
        CALL RADIAL__VALUE(R1,DEX,NR,PHI(:,2),R,PHI2)
...
!     ==================================================================
      DO N1=1,NPRO
        ...
        ENDDO
        CALL RADIAL__INTEGRAL(R1,DEX,IRAUG,AUX1,SVAR)
...
!
        IF(DABS(DENL).LT.1.D-5) THEN
          ...
          ENDDO
          CALL RADIAL__INTEGRAL(R1,DEX,IRAUG,AUX1,SVAR2)
...
!       == TEST BIORTHOGONALITY OF PROJECTOR AND PS-PARTIALWAVES =======
        ...
        DO N1=1,NPRO
          DO N2=1,NPRO
            CALL RADIAL__INTEGRAL(R1,DEX,NR,R(:)**2*PSPHI(:,1,N1)*PRO(:,N2),SVAR)
            IF(N1.EQ.N2) THEN
...
!
          DO N2=1,NPRO
            CALL RADIAL__INTEGRAL(R1,DEX,NR,R(:)**2*PHITEST(:,1)*PRO(:,N2),SVAR)
...
!     ******************************************************************
      ...
      ENDDO
      RHO(:)=0.D0
      CALL RADIAL__INTEGRAL(R1,DEX,NR,(AECORE(:)-PSCORE(:))*R(:)**2,SVAR)
      QAUG=-AEZ+SVAR*4.D0*PI*Y0
      CALL PROJECTION__LMAX(LMAX)
AE1RHO(:)=0.D0
PS1RHO(:)=0.D0
      DO L=0,LMAX
        CALL PROJECTION__NPRO(L,NWAVE1)
        ALLOCATE(PRO1(NR,NWAVE1))
        ALLOCATE(DTKIN1(NWAVE1,NWAVE1))
        ALLOCATE(DO1(NWAVE1,NWAVE1))
        ALLOCATE(DATH1(NWAVE1,NWAVE1))
        ALLOCATE(PROJ(NWAVE1))
        CALL PROJECTION__POT(L,NWAVE1,PROL=PRO1,DOL=DO1,DATHL=DATH1)
!
ALLOCATE(AEPHI1(NR,3,NWAVE1))
ALLOCATE(PSPHI1(NR,3,NWAVE1))
CALL PROJECTION__POT(L,NWAVE1,AEPHIL=AEPHI1,PSPHIL=PSPHI1)
...
!           ============================================================
            AUX(:)=R(:)**2*PSPSI(:,1)**2
            CALL RADIAL__INTEGRAL(R1,DEX,NR,AUX(:),SUM)
            DO I1=1,NWAVE1
              AUX(:)=R(:)**2*PRO1(:,I1)*PSPSI(:,1)
              CALL RADIAL__INTEGRAL(R1,DEX,NR,AUX(:),PROJ(I1))
            ENDDO
            DO I1=1,NWAVE1
              DO I2=1,NWAVE1
              ...
              ENDDO
            ENDDO
            CALL REPORT__R8VAL(NFILO,"NORM (REMOVE THIS)",SUM,' ')
            SVAR=1.D0/DSQRT(SUM)
            PSPSI(:,:)=PSPSI(:,:)*SVAR
            PROJ(:)=PROJ(:)*SUM
!
...
!        POTOFRHO(IR)=POTOFRHO(IR)+QAUG*ERF(R(IR)/RCSMALL)/R(IR)/Y0
        CALL LIB__ERFR8(R(IR)/RCSMALL,SVAR)
...
!     ==================================================================
      ...
      CALL RADIAL__INTEGRAL(R1,DEX,NR,AUX,SVAR)
      CALL REPORT__R8VAL(NFILO,"TOTAL INTEGRATED DENSITY (SHOULD BE ZERO)",SVAR+QAUG,' ')
      CALL REPORT__R8VAL(NFILO,"ATOMIC NUMBER",AEZ,' ')
      CALL REPORT__R8VAL(NFILO,"CHARGE IN ONE-CENTER DENSITY",QAUG,' ')
      CALL REPORT__R8VAL(NFILO,"CHARGE IN PLANE WAVE PART",SVAR,' ')
!
!     ==================================================================
...
!       PRINT*,R(IR),VHAT(IR)*Y0
      ...
      AUX(1:IRAUG)=0.D0
      CALL RADIAL__INTEGRAL(R1,DEX,NR,AUX,SVAR)
      CALL REPORT__R8VAL(NFILO,"VHAT SET TO ZERO BEYOND RADIUS",R(IRAUG+1),'A0')
      CALL REPORT__R8VAL(NFILO,"ERROR BY VHAT TRUNCATION",SVAR,'H')
...
!         ==  G-MOMENTS FOR KINETIC ENERGY AND MASS RENORMALIZATION  ==
          ...
          ENDDO
          WORK(:)=GMOMENT(:,1)
          CALL RADIAL__INTEGRATE(G1,DEX,NG,WORK,GMOMENT(:,1))
          WORK(:)=GMOMENT(:,2)
          CALL RADIAL__INTEGRATE(G1,DEX,NG,WORK,GMOMENT(:,2))
          WORK(:)=GMOMENT(:,3)
          CALL RADIAL__INTEGRATE(G1,DEX,NG,WORK,GMOMENT(:,3))
...
!           ==========================================================
            DO I1=1,NWAVE1
              CALL RADIAL__INTEGRAL(R1,DEX,NR,R(:)**2*PRO1(:,I1)*PSIR(1:NR),PROJ(I1))
            ENDDO
!
!           ==========================================================
!           ==  RENORMALIZE WAVE FUNCTION                           ==
!           ==========================================================
            CALL RADIAL__INTEGRAL(R1,DEX,NR,(R(:)*PSIR(1:NR))**2,SVAR)
            DO I1=1,NWAVE1
              DO I2=1,NWAVE1
...
!           ============================================================
            DO I1=1,NWAVE1
              CALL RADIAL__INTEGRAL(R1,DEX,NR,R(:)**2*PRO1(:,I1)*PSPSI(:,1),PROJ(I1))
            ENDDO
            DO I1=1,NWAVE1
              DO I2=1,NWAVE1
                QAUG=QAUG+PROJ(I1)*DO1(I1,I2)*PROJ(I2)*FB(IB)
...
!     == CHECK CHARGE CONSERVATION ======================================
      AUX(:)=4.D0*PI*Y0*RHO(:)*R(:)**2
      CALL RADIAL__INTEGRAL(R1,DEX,NR,AUX,SVAR)
!     CALL RADIAL__INTEGRAL(R1,DEX,NR,4.D0*PI*Y0*RHO(:)*R(:)**2,SVAR)
...
!     ==================================================================
      ...
      DO IR=1,30
        ...
        CALL RADIAL__VALUE(R1,DEX,NR,AEPOT,RI,AEPOT1)
        CALL RADIAL__VALUE(R1,DEX,NR,PSPOT,RI,PSPOT1)
        CALL RADIAL__VALUE(R1,DEX,NR,VHAT,RI,VHAT1)
        CALL RADIAL__VALUE(R1,DEX,NR,AECORE,RI,AECORE1)
        CALL RADIAL__VALUE(R1,DEX,NR,PSCORE,RI,PSCORE1)
        AEPOT1=AEPOT1*Y0
        PSPOT1=PSPOT1*Y0
        AECORE1=AECORE1*Y0
        PSCORE1=PSCORE1*Y0
...
!     ==================================================================
      DO L=0,3
        CALL PROJECTION__NPRO(L,NPRO)
        IF(NPRO.EQ.0) CYCLE
        ALLOCATE(PRO1(NR,NPRO))
        CALL PROJECTION__POT(L,NPRO,PROL=PRO1)
        IF(L.EQ.0) THEN
          CALL FILEHANDLER__UNIT('PRO_S',NFIL)
        ELSE IF(L.EQ.1) THEN
          CALL FILEHANDLER__UNIT('PRO_P',NFIL)
        ELSE IF(L.EQ.2) THEN
          CALL FILEHANDLER__UNIT('PRO_D',NFIL)
        ELSE IF(L.EQ.3) THEN
          CALL FILEHANDLER__UNIT('PRO_F',NFIL)
        ELSE
          CALL ERROR__MSG('L>3 NOT IMPLEMENTED')
          CALL ERROR__STOP('WRITEGRAPHICS')
        END IF
        REWIND NFIL
        DO IR=1,NR
...
!     ==  WRITE POTENTIALS                                            ==
!     ==================================================================
      CALL FILEHANDLER__UNIT('POT',NFIL)
      REWIND NFIL
      DO IR=1,NR
        WRITE(NFIL,*)R(IR),AEPOT(IR),PSPOT(IR),VHAT(IR)
      ENDDO
      CALL FILEHANDLER__CLOSE('POT')
!
!     ==================================================================
!     ==  WRITE PARTIAL WAVES                                         ==
!     ==================================================================
      DO L=0,3
        ...
        CALL PROJECTION__POT(L,NPRO,AEPHIL=AEPHI1,PSPHIL=PSPHI1)
        IF(L.EQ.0) THEN
          CALL FILEHANDLER__UNIT('PHI_S',NFIL)
        ELSE IF(L.EQ.1) THEN
          CALL FILEHANDLER__UNIT('PHI_P',NFIL)
        ELSE IF(L.EQ.2) THEN
          CALL FILEHANDLER__UNIT('PHI_D',NFIL)
        ELSE IF(L.EQ.3) THEN
          CALL FILEHANDLER__UNIT('PHI_F',NFIL)
        ELSE
          CALL ERROR__MSG('L>3 NOT IMPLEMENTED')
          CALL ERROR__STOP('WRITEGRAPHICS')
        END IF
...
!     ******************************************************************
      ...
      ENDDO
      CALL FILEHANDLER__UNIT('PROT',NFILO)
      CALL FILEHANDLER__UNIT('EPWCONV',NFIL)
!
!     ==================================================================
...
!     ==================================================================
     ...
     &                       -PSPHI(:,1,IW1)*PSPHI(:,1,IW2))*DENMAT(IW1,IW2)
      ...
      CALL RADIAL__MOMENT(R1,DEX,NR,0,RHO(:),QLM)
      QLM=QLM-AEZ*Y0
!
!     ==================================================================
...
!     == XC ENERGY
      ...
      DO IR=1,NR
        ...
        AUX1(IR)=EXC*FOURPI*R(IR)**2
      ENDDO
      CALL RADIAL__INTEGRAL(R1,DEX,NR,AUX1,PSEXC)
!
!     == ELECTROSTATIC ENERGY
      ...
      CALL RADIAL__INTEGRAL(R1,DEX,NR,AUX1,PSEEL)
!
!     == ENERGY VHAT ===
      CALL RADIAL__INTEGRAL(R1,DEX,NR,VHAT(:)*RHO(:)*R(:)**2,SVAR)
      PSEEL=PSEEL+SVAR
!
!     ==================================================================
...
!     == XC ENERGY
      ...
      DO IR=1,NR
        ...
        AUX1(IR)=EXC*FOURPI*R(IR)**2
      ENDDO
      CALL RADIAL__INTEGRAL(R1,DEX,NR,AUX1,PS1EXC)
!     == ELECTROSTATIC ENERGY
      CALL GAUSSN(0,1.D0/RCSMALL**2,SVAR)
      DO IR=1,NR
        RHO(IR)=RHO(IR)+QLM*SVAR*DEXP(-(R(IR)/RCSMALL)**2)
      ...
      CALL RADIAL__POISSON(R1,DEX,NR,0,RHO,POT)
      AUX1(:)=0.5D0*RHO(:)*POT(:)*R(:)**2
      CALL RADIAL__INTEGRAL(R1,DEX,NR,AUX1,PS1EEL)
!     == ENERGY VHAT ===
      CALL RADIAL__INTEGRAL(R1,DEX,NR,VHAT(:)*RHO(:)*R(:)**2,SVAR)
      PS1EEL=PS1EEL+SVAR
!
...
!     == XC ENERGY
      ...
      DO IR=1,NR
        ...
        AUX1(IR)=EXC*FOURPI*R(IR)**2
      ENDDO
      CALL RADIAL__INTEGRAL(R1,DEX,NR,AUX1,AE1EXC)
!     == ELECTROSTATIC ENERGY
      CALL RADIAL__POISSON(R1,DEX,NR,0,RHO,POT)
      AUX1(:)=RHO(:)*(0.5D0*POT(:)*R(:)**2-AEZ/Y0*R(:))
      CALL RADIAL__INTEGRAL(R1,DEX,NR,AUX1,AE1EEL)
!     == SUBSTRACT CORE ENERGIES
      CALL RADIAL__DERIVE(R1,DEX,NR,AECORE,GRHO)
      DO IR=1,NR
        GRHO2=(Y0*GRHO(IR))**2
      ...
      AE1EXC=AE1EXC-SVAR
!
      CALL RADIAL__POISSON(R1,DEX,NR,0,AECORE,POT)
        ...
        DO IB=1,NB
          DO IPRO=1,NPRO
            IF(LB(IB).EQ.LPRO(IPRO)) THEN
              CALL RADIAL__INTEGRAL(R1,DEX,NR,R(:)**2*PSPSI(:,1,IB),PROJ(IPRO,IB))
            ELSE
              PROJ(IPRO,IB)=0.D0
            END IF
          ENDDO
...
!       ================================================================
        QAUG=AEZ
        CALL RADIAL__INTEGRAL(R1,DEX,NR,R(:)**2*(AECORE(:)-PSCORE(:))*Y0,SVAR)
...
!         PSPOT(IR)=PSPOT(IR)+QAUG*ERF(R(IR)/RCSM)/R(IR)/Y0+VHAT(IR)
          CALL LIB__ERFR8(R(IR)/RCSM,SVAR)
...
!     **                                                              **
      ...
      INTEGER(4)      :: IWAVE,ir
!     ******************************************************************
      CALL FILEHANDLER__UNIT('SETUPO',NFIL)
...
!     ==================================================================
      ...
      CALL FILEHANDLER__CLOSE('SETUPO')
      RETURN
      END
!
!     ..................................................................
...
!     ==================================================================
      CALL LINKEDLIST__SELECT(LL_CNTL,'AECORE')
      CALL LINKEDLIST__SET(LL_CNTL,'CORE',0,AECORE)
      CALL LINKEDLIST__SELECT(LL_CNTL,'..')
      CALL LINKEDLIST__SELECT(LL_CNTL,'PSCORE')
      CALL LINKEDLIST__SET(LL_CNTL,'CORE',0,PSCORE)
      CALL LINKEDLIST__SELECT(LL_CNTL,'..')
      CALL LINKEDLIST__SELECT(LL_CNTL,'VTILDE')
      CALL LINKEDLIST__SET(LL_CNTL,'VHAT',0,VHAT)
      CALL LINKEDLIST__SELECT(LL_CNTL,'..')
!
!     ==================================================================
...
!     ==================================================================
      DO IWAVE=1,NWAVE
        CALL LINKEDLIST__SELECT(LL_CNTL,'WAVE',IWAVE)
        CALL LINKEDLIST__SET(LL_CNTL,'PRO',0,PRO(:,IWAVE))
        CALL LINKEDLIST__SET(LL_CNTL,'AEPHI',0,AEPHI(:,1,IWAVE))
        CALL LINKEDLIST__SET(LL_CNTL,'PSPHI',0,PSPHI(:,1,IWAVE))
        CALL LINKEDLIST__SELECT(LL_CNTL,'..')
      ENDDO
!
!     ==================================================================
...
!     ==================================================================
      CALL LINKEDLIST__SELECT(LL_CNTL,'MATRIXELEMENTS')
      CALL LINKEDLIST__SET(LL_CNTL,'NWAVE',0,NWAVE)
      CALL LINKEDLIST__SET(LL_CNTL,'DTKIN',0,DTKIN(:,:))
      CALL LINKEDLIST__SET(LL_CNTL,'DO',0,DO(:,:))
      CALL LINKEDLIST__SELECT(LL_CNTL,'..')
!
!     ==================================================================
!     == WRITE LINKEDLIST TO FILE                                     ==
!     ==================================================================
      CALL FILEHANDLER__UNIT('SETUP',NFIL)
      CALL LINKEDLIST__SELECT(LL_CNTL,'~')
      CALL LINKEDLIST__WRITE(LL_CNTL,NFIL)
      CALL FILEHANDLER__CLOSE('SETUP')
!
      RETURN
      CALL FILEHANDLER__FILENAME('SETUP',FILE)
      CALL FILEHANDLER__SETFILE('SETUPR',.FALSE.,FILE)
      CALL FILEHANDLER__SETSPECIFICATION('SETUPR','STATUS','OLD')
      CALL FILEHANDLER__SETSPECIFICATION('SETUPR','POSITION','REWIND')
      CALL FILEHANDLER__SETSPECIFICATION('SETUPR','ACTION','READ')
      CALL FILEHANDLER__SETSPECIFICATION('SETUPR','FORM','FORMATTED')
      CALL FILEHANDLER__UNIT('SETUPR',NFIL)
      CALL LINKEDLIST__NEW(LL_STP)
      CALL LINKEDLIST__READ(LL_STP,NFIL)
      CALL FILEHANDLER__UNIT('PROT',NFILO)
      CALL LINKEDLIST__REPORT(LL_STP,NFILO)
      STOP
      RETURN
      END
!
...
!     ******************************************************************
     ...
     &                 ," TEST ENERGY TRANSFERABILITY "/72("-"))')
      ...
      CALL PERIODICTABLE__GET(NINT(AEZ),'R(COV)',RCOV)
      RPHASE=1.5D0*RCOV
      CALL REPORT__R8VAL(NFILO,'PHASESHIFTS TAKEN AT RADIUS',RPHASE,'A_0')
      CALL REPORT__STRING(NFILO,'(RADIUS=1.5 COVALENT RADIUS)')
!
!     ==================================================================
!     ==  PREPARE SOME COMMON CONSTANTS                               ==
!     ==================================================================
...
!       ================================================================
        ...
        DO NPRO=0,NPROX
          ...
          ALLOCATE(PSPHI1(NR,3,NPRO))
          ALLOCATE(PROJ1(NPRO))
          CALL PROJECTION__POT(L,NPRO,PROL=PRO1,AEPHIL=AEPHI1,PSPHIL=PSPHI1 &
     &                              ,DOL=DO1,DATHL=DATH1)
          DO IE=1,NE
            CALL PAWDER(.TRUE.,R1,DEX,NR,L,EOFI(IE),IRAUG+4 &
     &                     ,PSPOT,NPRO,PRO1,DATH1,DO1,PAWPSI,AUX)
            DO IPRO=1,NPRO
              CALL RADIAL__INTEGRAL(R1,DEX,NR &
...
!
      ...
      DO L=0,LMAX
        IF(L.EQ.0) THEN
          CALL FILEHANDLER__UNIT('PHASESHIFT_S',NFIL)
        ELSE IF(L.EQ.1) THEN
          CALL FILEHANDLER__UNIT('PHASESHIFT_P',NFIL)
        ELSE IF(L.EQ.2) THEN
          CALL FILEHANDLER__UNIT('PHASESHIFT_D',NFIL)
        ELSE IF(L.EQ.3) THEN
          CALL FILEHANDLER__UNIT('PHASESHIFT_F',NFIL)
        ELSE
          CALL ERROR__MSG('LMAX>3 NOT SUPPORTED')
          CALL ERROR__STOP('ENERGYTRANSFERABILITY')
        END IF
        REWIND NFIL
        DO IE=1,NE
          CALL PROJECTION__NPRO(L,NPROX)
...
!     == calculate wave functions                            ==
!     =========================================================
      CALL FILEHANDLER__SETFILE('TEST',.FALSE.,'TEST.DAT')
      CALL FILEHANDLER__SETSPECIFICATION('TEST','STATUS','UNKNOWN')
      CALL FILEHANDLER__SETSPECIFICATION('TEST','POSITION','REWIND')
      CALL FILEHANDLER__SETSPECIFICATION('TEST','ACTION','WRITE')
      CALL FILEHANDLER__SETSPECIFICATION('TEST','FORM','FORMATTED')
!
!     =========================================================
!     == define radial grid                                  ==
!     =========================================================
...
!       CALL XPHASESHIFT(R1,DEX,NR,RPHASE,REFPSI,PHASEAE(IE,L+1))
        do ir=1,np
          call radial__value(r1,dex,nr,refpsi(1,1),rp(ir),psiarr(ir,ie))
        enddo
...
!     =========================================================
     ...
     &              ,IRlast,0.d0,AEPOT,REFPSI,AUX)
      do ir=1,np
        call radial__value(r1,dex,nr,refpsi(1,1),rp(ir),psib(ir,1))
      enddo
      svar=1.d0/psib(1,1)
      psib(:,1)=psib(:,1)*svar
      do ie=1,ne
...
!     == printout                                            ==
!     =========================================================
      CALL FILEHANDLER__UNIT('TEST',NFIL)
      do ie=1,ne
        e=emin+(emax-emin)*real(ie-1)/real(ne-1)
        do ir=1,np
