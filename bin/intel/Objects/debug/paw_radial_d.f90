...
!**                                                                   **
!**  FUNCTIONS:                                                       **
!**    RADIAL__VALUE(R1,DEX,NR,FUNC,R0,F0)                             **
!**    RADIAL__DERIVE(R1,DEX,NR,F,DFDR)                                **
!**    RADIAL__DERIVATIVE(R1,DEX,NR,F,R0,DFDR0)                        **
!**    RADIAL__INTEGRATE(R1,DEX,NR,F,FINT)                             **
!**    RADIAL__INTEGRAL(R1,DEX,NR,F,R0,FINT0)                          **
!**    RADIAL__FFT(ID,R1,DEX,NR,F1,G1,F2)                              **
!**    RADIAL__POISSON(R1,DEX,NR,RHO,V)                                **
!**    RADIAL__MOMENT(R1,DEX,NR,L,RHO,QLM)                             **
!**    BESSELTRANSFORM__CLEAR                                          **
...
!
!     .......................................................SPHLSD.....
      SUBROUTINE RADIAL__DERIVE(R1,DEX,NR,F,G)
!     **                                                              **
...
!
!     .....................................................INTRAD.......
      SUBROUTINE RADIAL__INTEGRATE(R1,DEX,NR,F1,G)
!     **                                                              **
...
!     ******************************************************************
      IF(NR.LT.10) THEN
        CALL ERROR__MSG('NUMBER OF MESHPOINTS SMALLLER THAN 10')
        CALL ERROR__STOP('RADIAL__INTEGRATE')
      END IF
      F(:)=F1(:)
      XEXP=DEXP(DEX)
!     ==================================================================
...
!
!     .....................................................INTRAD.......
      SUBROUTINE RADIAL__INTEGRAL(R1,DEX,NR,F1,RES)
!     ******************************************************************
!     **                                                              **
...
!
!     .....................................................INTRAD.......
      SUBROUTINE RADIAL__INTEGRAL1(R1,DEX,NR,F1,RAD,VAL)
!     ******************************************************************
!     **                                                              **
...
!
!     .....................................................INTRAD.......
      SUBROUTINE RADIAL__INTEGRAL2(R1,DEX,NR,F1,r,RES)
!     ******************************************************************
!     **                                                              **
!     **  INTEGRATES THE RADIAL FUNCTION F(R) FROM 0 TO GRID POINT NR **
!     **  WHERE F IS GIVEN ON A LOGHARITHMIC MESH                     **
...
CALL ERROR__STOP('RADIAL__INTEGRAL2')
      IF(NR.LT.10) THEN
        CALL ERROR__MSG('NUMBER OF MESHPOINTS SMALLLER THAN 10')
        CALL ERROR__STOP('INTGRL')
      END IF
...
!
!     ....................................................................
      SUBROUTINE RADIAL__VALUE(R1,DEX,NR,FI_,R0,F0)
!     **                                                                **
!     **  POLYNOMIAL EXTRAPOLATION OF ORDER NP FROM NP POINTS (RI,FI_)  **
!     **  TO THE POINT (R0,F0)                                          **
!     **                                                                **
...
!       ****************************************************************
      ...
      END SUBROUTINE RADIAL__VALUE
!
!     ..................................................................
      SUBROUTINE RADIAL__DERIVATIVE(R1,DEX,NR,FI_,R0,F0)
!     ******************************************************************
...
!           == DO NOT CHANGE THE ORDER OF THE NEXT TWO STATEMENTS ======
      ...
      END SUBROUTINE RADIAL__DERIVATIVE
!
!     .....................................................POISON.......
      SUBROUTINE RADIAL__POISSON(R1,DEX,NR,L,RHO,V)
!     ******************************************************************
!     **                                                              **
...
!
      ...
      ENDDO
!
      CALL RADIAL__INTEGRATE(R1,DEX,NR,AUX1,AUX2)
!
...
!
!     ...........................................MLTPOL.................
      SUBROUTINE RADIAL__MOMENT(R1,DEX,NR,L,RHO,QLM)
!     ******************************************************************
!     **                                                              **
...
!     ******************************************************************
      ...
      ENDDO
      CALL RADIAL__INTEGRAL(R1,DEX,NR,AUX1,QLM)
      RETURN
      END
!
!.......................................................................
...
!
!     ..................................................................
      SUBROUTINE BESSELTRANSFORM__CLEAR
!     ******************************************************************
!     **                                                              **
...
!       ==================================================================
        ...
        DO WHILE (ISVAR.NE.NP)
          ...
          ISVAR=ISVAR*2
          IF(ISVAR.GT.NP) THEN
            CALL ERROR__MSG('NP MUST BE A POWER OF TWO')
            CALL ERROR__I4VAL('NP',NP)
            CALL ERROR__STOP('BESSELTRANSFORM')
          END IF
        ENDDO
        NSAVE=N
!
...
!     ==================================================================
      ...
      ENDDO
      CALL ERROR__MSG('Y NOT CONVERGED')
      CALL ERROR__I4VAL('L',L)
      CALL ERROR__R8VAL('X',X)
      CALL ERROR__STOP('FUNCTION BESSL')
9999  CONTINUE
      RETURN
      END
