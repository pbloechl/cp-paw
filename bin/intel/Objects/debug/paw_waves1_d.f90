...
!     ================================================================
      ...
      MAP%NBAREPRO=0
      DO ISP=1,MAP%NSP
        CALL SETUP__LNX(ISP,LNX)
        MAP%LNX(ISP)=lnx
        CALL SETUP__LOFLN(ISP,LNX,MAP%LOX(1:LNX,ISP))
        MAP%LMNX(ISP)=0
        DO LN=1,lnx
...
!       ================================================================
        ...
        DO ISP=1,MAP%NSP
          ...
          DO LN=1,MAP%LNX(ISP)
            IND=IND+1
            CALL SETUP__GETFOFG('PRO',.FALSE.,LN,NGL,G2,CELLVOL,GSET%PRO(:,IND))
            CALL SETUP__GETFOFG('PRO',.TRUE.,LN,NGL,G2,CELLVOL,GSET%DPRO(:,IND))
          ENDDO
        ENDDO
!
!       ================================================================
