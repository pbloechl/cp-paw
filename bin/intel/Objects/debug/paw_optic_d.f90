...
!
! ............................................................
        SUBROUTINE OPTICS__GETL4(ID,VAL)
        USE OPTIC_MODULE
...
! *************************************************************
        ...
        ELSE
          ...
          CALL ERROR__STOP('OPTICS__GETL4')
        END IF
        RETURN
        END

!written by MEA
SUBROUTINE OPTICS__CORRELATION_PARTIALS(iat,r1,dex,NR,NRX,lnx,LMRX,&
 ...
 CALL OPTICS__RHO_PARTIAL(IAT,NR,LMRX,NDIMD,PSRHO,AERHO)
 ...
 DEALLOCATE(AEPOT)
 DEALLOCATE(PSPOT)
END SUBROUTINE optics__correlation_partials

SUBROUTINE optics__writeout_partials(NSPIN,NAT,LMNXX,DH,DO)
   USE OPTIC_MODULE
   IMPLICIT NONE
   ...
   REAL(8), INTENT(IN) :: DO(1:LMNXX,1:LMNXX,NSPIN,NAT)
      IF(.NOT.OPTIC)RETURN
      if(.not.INIT_OPTIC)call OPTICS_INIT
        CALL OPTICS__ATOMS(NSPIN,NAT,LMNXX,DH,DO)
        CALL ATOMLIST__GETI4A('ISPECIES',0,NAT,ISPECIES)
        CALL OPTICS__WRITE_RHO_PARTIAL(NSPIN,NAT,ISPECIES)
        CALL OPTICS__VXC_PARTIAL(NSPIN,NAT,ISPECIES)
        CALL OPTICS__VXC_PARTIAL_VALENCE(NSPIN,NAT,ISPECIES)
        CALL OPTICS__VXC_PARTIAL_CORE(NSPIN,NAT,ISPECIES)
END SUBROUTINE optics__writeout_partials


SUBROUTINE OPTICS__VOFG(NR1,NR2,NR3,NVOFG,RHOG,NSPINV)
      USE OPTIC_MODULE
      IMPLICIT NONE
...
! ******************************************************************
      ...
      CALL FILEHANDLER__UNIT('OPTICS_INFO',NFIL1)
      WRITE(NFIL1,*)'SUBROUTINE OPTICS_VOFG EST APPELEE'

      CALL FILEHANDLER__UNIT('OPTICS_VOFG',NFIL)
      ...
      CALL FILEHANDLER__CLOSE('OPTICS_VOFG')
      WRITE(NFIL1,*)'FIN DE LA SUBROUTINE OPTICS_VOFG'
      CALL FILEHANDLER__CLOSE('OPTICS_INFO')

END SUBROUTINE OPTICS__VOFG
...
SUBROUTINE OPTICS__VXC_PARTIAL(NSPINXC,NATXC,ISPECIES)
      USE OPTIC_MODULE
      IMPLICIT NONE
      ...
      CALL FILEHANDLER__UNIT('OPTICS_VXC_PARTIAL',NFIL)
      WRITE(NFIL,*)NATXC
      WRITE(NFIL,*)NSPINXC
      DO IAT=1, NATXC
        ISP=ISPECIES(IAT)
        CALL SETUP__LMNX(ISP,LMNXXC)
        WRITE(NFIL,*)IAT
        WRITE(NFIL,*)LMNXXC
      ...
      CALL FILEHANDLER__CLOSE('OPTICS_VXC_PARTIAL')
      WRITE(NFIL1,*)'FIN DE LA SUBROUTINE OPTICS_VXC_PARTIAL'
      CALL FILEHANDLER__CLOSE('OPTICS_INFO')

END SUBROUTINE OPTICS__VXC_PARTIAL

SUBROUTINE OPTICS__REQUEST(TEST)
      USE OPTIC_MODULE
      IMPLICIT NONE
      LOGICAL :: TEST
      IF(.NOT.OPTIC) THEN
      ...
      ELSE
         ...
         IF(.NOT.INIT_OPTIC)CALL OPTICS_INIT
      END IF
END SUBROUTINE OPTICS__REQUEST
...
SUBROUTINE OPTICS__VXC_PARTIAL_VALENCE(NSPINXC,NATXC,ISPECIES)
      USE OPTIC_MODULE
      IMPLICIT NONE
      ...
      CALL FILEHANDLER__UNIT('OPTICS_VXC_PARTIAL_VALENCE',NFIL)
      WRITE(NFIL,*)NATXC
      WRITE(NFIL,*)NSPINXC
      DO IAT=1, NATXC
        ISP=ISPECIES(IAT)
      ...
      CALL FILEHANDLER__CLOSE('OPTICS_VXC_PARTIAL_VALENCE')
      WRITE(NFIL1,*)'FIN DE LA SUBROUTINE OPTICS_VXC_PARTIAL_VALENCE'
      CALL FILEHANDLER__CLOSE('OPTICS_INFO')

END SUBROUTINE OPTICS__VXC_PARTIAL_VALENCE
...
SUBROUTINE OPTICS__VXC_PARTIAL_CORE(NSPINXC,NATXC,ISPECIES)
      USE OPTIC_MODULE
      IMPLICIT NONE
      ...
      CALL FILEHANDLER__UNIT('OPTICS_VXC_PARTIAL_CORE',NFIL)
      WRITE(NFIL,*)NATXC
      WRITE(NFIL,*)NSPINXC
      DO IAT=1, NATXC
        ISP=ISPECIES(IAT)
      ...
      CALL FILEHANDLER__CLOSE('OPTICS_VXC_PARTIAL_CORE')
      WRITE(NFIL1,*)'FIN DE LA SUBROUTINE OPTICS_VXC_PARTIAL_CORE'
      CALL FILEHANDLER__CLOSE('OPTICS_INFO')

END SUBROUTINE OPTICS__VXC_PARTIAL_CORE
!===========================================================================
! PARTIAL_RHO(IR,LMN,ISPIN,IAT) contains AERHO(IR,LMN,ISPIN,IAT)-PSRHO(IR,LMN,ISPIN,IAT)
! B. Arnaud
!===========================================================================
SUBROUTINE OPTICS__RHO_PARTIAL(IAT,NRX,LMRX,NSPIN,PSRHO,AERHO)
...
END SUBROUTINE OPTICS__RHO_PARTIAL
!===========================================================================
! PARTIAL_RHO(IR,LMN,ISPIN,IAT) is written in file OPTICS_PARTIAL_RHO_VALENCE
! B. Arnaud
!===========================================================================
SUBROUTINE OPTICS__WRITE_RHO_PARTIAL(NSPIN,NAT,ISPECIES)
      ...
      CALL FILEHANDLER__UNIT('OPTICS_PARTIAL_RHO_VALENCE',NFIL)
      WRITE(NFIL,*)NAT
      WRITE(NFIL,*)NSPIN
      DO IAT=1, NAT
        ISP=ISPECIES(IAT)
        CALL SETUP__LMRX(ISP,LMRX)
        CALL SETUP__RADGRID(ISP,R1,DEX,NRX1)
        WRITE(NFIL,*)IAT
        WRITE(NFIL,*)NRX1
        WRITE(NFIL,*)LMRX
        ...
        DO ISPIN=1, NSPIN
         ...
         END DO
       END DO
       CALL FILEHANDLER__CLOSE('OPTICS_PARTIAL_RHO_VALENCE')
      WRITE(NFIL1,*)'FIN DE LA SUBROUTINE OPTICS_WRITE_RHO_PARTIAL'
      CALL FILEHANDLER__CLOSE('OPTICS_INFO')



END SUBROUTINE OPTICS__WRITE_RHO_PARTIAL
...
! B. Arnaud
!===========================================================================
SUBROUTINE OPTICS__VXCG(NR1,NR2,NR3,NVOFG,RHOG,NSPINV)
      USE OPTIC_MODULE
      IMPLICIT NONE
      ...
      CALL FILEHANDLER__UNIT('OPTICS_VXCG',NFIL)
      WRITE(NFIL,*)NR1, NR2, NR3
      WRITE(NFIL,*)NVOFG
      ...
      CALL FILEHANDLER__CLOSE('OPTICS_VXCG')
      WRITE(NFIL1,*)'FIN DE LA SUBROUTINE OPTICS_VXCG'
      CALL FILEHANDLER__CLOSE('OPTICS_INFO')


END SUBROUTINE OPTICS__VXCG
...
! B. Arnaud
!===========================================================================
SUBROUTINE OPTICS__VXCG_VALENCE(TGRA,NSPIN,NNRX,NNR,NNRSCAL,NR1,NR2,&
...
!===========================================================================
      ...
      ALLOCATE(gk(3,nvofg))
      CALL PLANEWAVE__GETI4A('IGVEC',3*nvofg,IGVEC)
      INDV1(:) = IGVEC(1,1:nvofg)
      INDV2(:) = IGVEC(2,1:nvofg)
      INDV3(:) = IGVEC(3,1:nvofg)

      CALL PLANEWAVE__GETR8A('GVEC',3*NVOFG,GK)
      CALL PLANEWAVE__SELECT('DENSITY') ! MEA
      CALL PLANEWAVE__SUPFFT('RTOG',NSPIN,NVOFG,RHOG_TEMP,NNRX,RHOE_TEMP)

      rhog_val(:,:) = rhog_temp(:,:)
      CALL FILEHANDLER__UNIT('OPTICS_RHOG_VALENCE',NFIL)
      WRITE(NFIL,*)NR1, NR2, NR3
      WRITE(NFIL,*)NVOFG
      DO I=1,NVOFG
      WRITE(NFIL,*)INDV1(I),INDV2(I),INDV3(I),RHOG_TEMP(I,1)
      ENDDO
      CALL FILEHANDLER__CLOSE('OPTICS_RHOG_VALENCE')
...
!===========================================================================
      ...
      CALL PLANEWAVE__SUPFFT('RTOG',NSPIN,NVOFG,WORK,NNRX,RHOE_TEMP)
     ...
     END IF
      ...
      CALL FILEHANDLER__UNIT('OPTICS_VXCG_VALENCE',NFIL)
      WRITE(NFIL,*)NR1, NR2, NR3
      WRITE(NFIL,*)NVOFG
      DO I=1,NVOFG
      WRITE(NFIL,*)INDV1(I),INDV2(I),INDV3(I),RHOG_TEMP(I,1)
      ...
      CALL FILEHANDLER__CLOSE('OPTICS_VXCG_VALENCE')

      WRITE(NFIL1,*)'FIN DE LA SUBROUTINE OPTICS_VXCG_VALENCE'
      CALL FILEHANDLER__CLOSE('OPTICS_INFO')


END SUBROUTINE OPTICS__VXCG_VALENCE
SUBROUTINE OPTICS__VXCG_core(TGRA,NSPIN,NNRX,NNR,NNRSCAL,NR1,NR2,&
...
!===========================================================================
      ...
      CALL PLANEWAVE__SELECT('DENSITY') ! MEA
      CALL PLANEWAVE__SUPFFT('GTOR',NSPIN,NVOFG,RHOG_CORE,NNRX,RHOE_TEMP)
...
!===========================================================================
     ...
     END IF
      ...
      CALL FILEHANDLER__UNIT('OPTICS_VXCG_CORE',NFIL)
      WRITE(NFIL,*)NR1, NR2, NR3
      WRITE(NFIL,*)NVOFG
      DO I=1,NVOFG
      ...
      CALL FILEHANDLER__CLOSE('OPTICS_VXCG_CORE')

      WRITE(NFIL1,*)'FIN DE LA SUBROUTINE OPTICS_VXCG_CORE'
      CALL FILEHANDLER__CLOSE('OPTICS_INFO')


END SUBROUTINE OPTICS__VXCG_core
!
! ..................................................................
SUBROUTINE OPTICS__SETL4(ID,VAL)
      USE OPTIC_MODULE
      IMPLICIT NONE
      CHARACTER(*),INTENT(IN) :: ID
...
! END BENGONE MODIFY
      ELSE
        ...
        CALL ERROR__CHVAL('ID',ID)
        CALL ERROR__STOP('OPTICS__SETL4')
      END IF
END SUBROUTINE OPTICS__SETL4
!
! ..................................................................
...
! CALL WAVES__GETI4('NSPIN',NSPIN)
      ...
      CALL ATOMLIST__GETI4A('ISPECIES',0,NAT,SPECIES)
      MAXNRX=0
      DO IAT=1, NAT
         ISP=SPECIES(IAT)
...
! == DEFINE FILES ==
! ==================================================================
      CALL FILEHANDLER__SETFILE(+'OPTICS_VOFG',.TRUE.,-'.OPTICS_VOFG')
      CALL FILEHANDLER__SETSPECIFICATION(+'OPTICS_VOFG','STATUS','UNKNOWN')
      CALL FILEHANDLER__SETSPECIFICATION(+'OPTICS_VOFG','POSITION','REWIND')
      CALL FILEHANDLER__SETSPECIFICATION(+'OPTICS_VOFG','ACTION','WRITE')
      CALL FILEHANDLER__SETSPECIFICATION(+'OPTICS_VOFG','FORM','FORMATTED')

      CALL FILEHANDLER__SETFILE(+'OPTICS_ATOMS',.TRUE.,-'.OPTICS_ATOMS')
      CALL FILEHANDLER__SETSPECIFICATION(+'OPTICS_ATOMS','STATUS','UNKNOWN')
      CALL FILEHANDLER__SETSPECIFICATION(+'OPTICS_ATOMS','POSITION','REWIND')
      CALL FILEHANDLER__SETSPECIFICATION(+'OPTICS_ATOMS','ACTION','WRITE')
      CALL FILEHANDLER__SETSPECIFICATION(+'OPTICS_ATOMS','FORM','FORMATTED')

      CALL FILEHANDLER__SETFILE(+'OPTICS_LATTICE',.TRUE.,-'.OPTICS_LATTICE')
      CALL FILEHANDLER__SETSPECIFICATION(+'OPTICS_LATTICE','STATUS','UNKNOWN')
      CALL FILEHANDLER__SETSPECIFICATION(+'OPTICS_LATTICE','POSITION','REWIND')
      CALL FILEHANDLER__SETSPECIFICATION(+'OPTICS_LATTICE','ACTION','WRITE')
      CALL FILEHANDLER__SETSPECIFICATION(+'OPTICS_LATTICE','FORM','FORMATTED')


      CALL FILEHANDLER__SETFILE(+'OPTICS_VXC_PARTIAL',.TRUE.,-'.OPTICS_VXC_PARTIAL')
      CALL FILEHANDLER__SETSPECIFICATION(+'OPTICS_VXC_PARTIAL','STATUS','UNKNOWN')
      CALL FILEHANDLER__SETSPECIFICATION(+'OPTICS_VXC_PARTIAL','POSITION','REWIND')
      CALL FILEHANDLER__SETSPECIFICATION(+'OPTICS_VXC_PARTIAL','ACTION','WRITE')
      CALL FILEHANDLER__SETSPECIFICATION(+'OPTICS_VXC_PARTIAL','FORM','FORMATTED')

      CALL FILEHANDLER__SETFILE(+'OPTICS_VXC_PARTIAL_VALENCE',.TRUE.,-'.OPTICS_VXC_PARTIAL_VALENCE')
      CALL FILEHANDLER__SETSPECIFICATION(+'OPTICS_VXC_PARTIAL_VALENCE','STATUS','UNKNOWN')
      CALL FILEHANDLER__SETSPECIFICATION(+'OPTICS_VXC_PARTIAL_VALENCE','POSITION','REWIND')
      CALL FILEHANDLER__SETSPECIFICATION(+'OPTICS_VXC_PARTIAL_VALENCE','ACTION','WRITE')
      CALL FILEHANDLER__SETSPECIFICATION(+'OPTICS_VXC_PARTIAL_VALENCE','FORM','FORMATTED')

      CALL FILEHANDLER__SETFILE(+'OPTICS_VXC_PARTIAL_CORE',.TRUE.,-'.OPTICS_VXC_PARTIAL_CORE')
      CALL FILEHANDLER__SETSPECIFICATION(+'OPTICS_VXC_PARTIAL_CORE','STATUS','UNKNOWN')
      CALL FILEHANDLER__SETSPECIFICATION(+'OPTICS_VXC_PARTIAL_CORE','POSITION','REWIND')
      CALL FILEHANDLER__SETSPECIFICATION(+'OPTICS_VXC_PARTIAL_CORE','ACTION','WRITE')
      CALL FILEHANDLER__SETSPECIFICATION(+'OPTICS_VXC_PARTIAL_CORE','FORM','FORMATTED')

      CALL FILEHANDLER__SETFILE(+'OPTICS_VXCG',.TRUE.,-'.OPTICS_VXCG')
      CALL FILEHANDLER__SETSPECIFICATION(+'OPTICS_VXCG','STATUS','UNKNOWN')
      CALL FILEHANDLER__SETSPECIFICATION(+'OPTICS_VXCG','POSITION','REWIND')
      CALL FILEHANDLER__SETSPECIFICATION(+'OPTICS_VXCG','ACTION','WRITE')
      CALL FILEHANDLER__SETSPECIFICATION(+'OPTICS_VXCG','FORM','FORMATTED')

      CALL FILEHANDLER__SETFILE(+'OPTICS_VXCG_VALENCE',.TRUE.,-'.OPTICS_VXCG_VALENCE')
      CALL FILEHANDLER__SETSPECIFICATION(+'OPTICS_VXCG_VALENCE','STATUS','UNKNOWN')
      CALL FILEHANDLER__SETSPECIFICATION(+'OPTICS_VXCG_VALENCE','POSITION','REWIND')
      CALL FILEHANDLER__SETSPECIFICATION(+'OPTICS_VXCG_VALENCE','ACTION','WRITE')
      CALL FILEHANDLER__SETSPECIFICATION(+'OPTICS_VXCG_VALENCE','FORM','FORMATTED')

      CALL FILEHANDLER__SETFILE(+'OPTICS_VXCG_CORE',.TRUE.,-'.OPTICS_VXCG_CORE')
      CALL FILEHANDLER__SETSPECIFICATION(+'OPTICS_VXCG_CORE','STATUS','UNKNOWN')
      CALL FILEHANDLER__SETSPECIFICATION(+'OPTICS_VXCG_CORE','POSITION','REWIND')
      CALL FILEHANDLER__SETSPECIFICATION(+'OPTICS_VXCG_CORE','ACTION','WRITE')
      CALL FILEHANDLER__SETSPECIFICATION(+'OPTICS_VXCG_CORE','FORM','FORMATTED')


      CALL FILEHANDLER__SETFILE(+'OPTICS_PARTIAL_RHO_VALENCE',.TRUE.,-'.OPTICS_PARTIAL_RHO_VALENCE')
      CALL FILEHANDLER__SETSPECIFICATION(+'OPTICS_PARTIAL_RHO_VALENCE','STATUS','UNKNOWN')
      CALL FILEHANDLER__SETSPECIFICATION(+'OPTICS_PARTIAL_RHO_VALENCE','POSITION','REWIND')
      CALL FILEHANDLER__SETSPECIFICATION(+'OPTICS_PARTIAL_RHO_VALENCE','ACTION','WRITE')
      CALL FILEHANDLER__SETSPECIFICATION(+'OPTICS_PARTIAL_RHO_VALENCE','FORM','FORMATTED')

      CALL FILEHANDLER__SETFILE(+'OPTICS_RHOG_VALENCE',.TRUE.,-'.OPTICS_RHOG_VALENCE')
      CALL FILEHANDLER__SETSPECIFICATION(+'OPTICS_RHOG_VALENCE','STATUS','UNKNOWN')
      CALL FILEHANDLER__SETSPECIFICATION(+'OPTICS_RHOG_VALENCE','POSITION','REWIND')
      CALL FILEHANDLER__SETSPECIFICATION(+'OPTICS_RHOG_VALENCE','ACTION','WRITE')
      CALL FILEHANDLER__SETSPECIFICATION(+'OPTICS_RHOG_VALENCE','FORM','FORMATTED')

      CALL FILEHANDLER__SETFILE(+'OPTICS_INFO',.TRUE.,-'.OPTICS_INFO')
      CALL FILEHANDLER__SETSPECIFICATION(+'OPTICS_INFO','STATUS','UNKNOWN')
      CALL FILEHANDLER__SETSPECIFICATION(+'OPTICS_INFO','POSITION','REWIND')
      CALL FILEHANDLER__SETSPECIFICATION(+'OPTICS_INFO','ACTION','WRITE')
      CALL FILEHANDLER__SETSPECIFICATION(+'OPTICS_INFO','FORM','FORMATTED')

      CALL FILEHANDLER__UNIT('OPTICS_INFO',NFIL)
...
! ..................................................................
SUBROUTINE OPTICS__ATOMS(NSPIN2,NAT2,LMNXX2,DH,DO)
      USE OPTIC_MODULE
      USE ATOMS_MODULE
      USE SETUP_MODULE
      IMPLICIT NONE
...
! ******************************************************************
      ...
      CALL FILEHANDLER__UNIT('OPTICS_ATOMS',NFIL)

      WRITE(NFIL,*)'ATOMS'

      CALL ATOMLIST__NATOM(NAT) !nbre total d atomes
      WRITE(NFIL,*) NAT

      DO IAT=1,NAT !loop sur tout les atomes
        WRITE(NFIL,*) IAT

        CALL ATOMLIST__GETI4('ISPECIES',IAT,VAL)
        WRITE(NFIL,*) VAL

        CALL ATOMLIST__GETCH('NAME',IAT,ATOM)
        WRITE(NFIL,*) ATOM

        CALL ATOMLIST__GETR8('ZVALENCE',IAT,ZVAL)
        WRITE(NFIL,*) ZVAL

        CALL ATOMLIST__GETR8A('R(0)',IAT,3,POS)
        WRITE(NFIL,*) POS(1), POS(2), POS(3)

        CALL SETUP__LNX(VAL,LNX)
        WRITE(NFIL,*) LNX

        ALLOCATE(LOX(LNX))

        CALL SETUP__LMNX(VAL,LMNX)
        WRITE(NFIL,*) LMNX

        CALL SETUP__LOFLN(VAL,LNX,LOX)
        WRITE(NFIL,*)(LOX(i),i=1,LNX)

        CALL SETUP__RADGRID(VAL,R1,DEX,NR)
        ...
        CALL SETUP__PROJECTOR(VAL,NR,LNX,PROJ)
        CALL SETUP__AEPARTIALWAVES(VAL,NR,LNX,AEPHII)
        CALL SETUP__PSPARTIALWAVES(VAL,NR,LNX,PSPHII)
      ...
      CALL FILEHANDLER__CLOSE('OPTICS_INFO')
      CALL FILEHANDLER__CLOSE('OPTICS_ATOMS')
END SUBROUTINE OPTICS__ATOMS

SUBROUTINE OPTICS__LATTICE
       USE OPTIC_MODULE
! USE WAVES_MODULE
! USE PLANEWAVE_MODULE
      IMPLICIT NONE
...
! ******************************************************************
      ...
      CALL FILEHANDLER__UNIT('OPTICS_LATTICE',NFIL)
      ...
      WRITE(NFIL,*) NGLL
      CALL PLANEWAVEOPTIC__GETI4A('IGVEC',3*NGLL,IGVECC)
! CALL PLANEWAVE__GETI4A('IGVEC',3*NGLL,IGVECC)
      DO IG=1,NGLL
      ...
      WRITE(NFIL1,*)'FIN DE LA SUBROUTINE OPTICS_ATOMS'
      CALL FILEHANDLER__CLOSE('OPTICS_INFO')
      CALL FILEHANDLER__CLOSE('OPTICS_LATTICE')
      DEALLOCATE(IGVECC)
END SUBROUTINE OPTICS__LATTICE
! cette routine a ete ecrite par seb
! ..................................................................
SUBROUTINE SETUP__PROJECTOR(ISP_,NRX_,LNX_,PROJ_)
! ==================================================================
...
! ==================================================================
      ...
      DO LN=1,LNX_
        ...
        ENDDO
      ENDDO
END SUBROUTINE SETUP__PROJECTOR
SUBROUTINE PLANEWAVEOPTIC__GETI4A(ID,LEN,VAL)
! ******************************************************************
...
! ==================================================================
      ELSE
        CALL ERROR__MSG('ID NOT RECOGNIZED')
        CALL ERROR__CHVAL('ID',ID)
        CALL ERROR__STOP('PLANEWAVEOPTIC__GETI4A')
      END IF
CONTAINS
...
! ==================================================================
      ...
      DO IG1=1,NG
        ...
        CALL ERROR__STOP('OPTIC_MINUSG')
 100 CONTINUE
      ENDDO
      RETURN
 END SUBROUTINE OPTIC_MINUSG

END SUBROUTINE PLANEWAVEOPTIC__GETI4A
!
