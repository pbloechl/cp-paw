!PROGRAM MAIN;USE PERIODICTABLE_MODULE;CALL PERIODICTABLE__REPORT(6);STOP;END
!
!.......................................................................
...
!**                                                                  **
!**  METHOD:                                                         **
!**    PERIODICTABLE__GET(SY,ID,VALUE)                                **
...
!**********************************************************************
PRIVATE
PUBLIC PERIODICTABLE__GET
INTERFACE PERIODICTABLE__GET
  MODULE PROCEDURE PERIODICTABLE__GETCH
  MODULE PROCEDURE PERIODICTABLE__GETR8
  MODULE PROCEDURE PERIODICTABLE__GETI4
  MODULE PROCEDURE PERIODICTABLE__SYMBOLGETR8
  MODULE PROCEDURE PERIODICTABLE__SYMBOLGETI4
END INTERFACE
TYPE ISOTOPE_TYPE
...
!=======================================================================
CALL CONSTANTS__GET('NUCLEARMAGNETON',NUCLEARMAGNETON)
CALL CONSTANTS__GET('METER',METER)
CALL CONSTANTS__GET('FEMTO',FEMTO)
FM2=(FEMTO*METER)**2
DO IZ=1,NEL
...
!     ******************************************************************
      ...
      DO I=0,NEL
        ...
        END IF
      ENDDO
      CALL ERROR__MSG('ELEMENT-SYMBOL NOT RECOGNIZED')
      CALL ERROR__CHVAL('SYMBOL',SYMBOL_)
      CALL ERROR__STOP('PERIODICTABLE_ATOMICNUMBER')
      RETURN
      END SUBROUTINE PERIODICTABLE_ATOMICNUMBER
!
!     ...........................................PERIODICTABLE..........
      SUBROUTINE PERIODICTABLE__GETCH(IZ,ID,VAL)
!     ******************************************************************
!     **                                                              **
!     ******************************************************************
      IMPLICIT NONE
...
!     ******************************************************************
      ...
      IF(IZ.GT.NEL) THEN
        CALL ERROR__MSG('ATOMIC NUMBER OUT OF RANGE')
        CALL ERROR__STOP('PERIODICTABLE__GETCH')
      END IF
      ...
      END IF
      RETURN
      END SUBROUTINE PERIODICTABLE__GETCH
!
!     ...........................................PERIODICTABLE..........
      SUBROUTINE PERIODICTABLE__GETR8(IZ,ID,VAL)
!     ******************************************************************
!     **                                                              **
!     ******************************************************************
      IMPLICIT NONE
...
!     ******************************************************************
      ...
      IF(IZ.GT.NEL) THEN
        CALL ERROR__MSG('ATOMIC NUMBER OUT OF RANGE')
        CALL ERROR__STOP('PERIODICTABLE__GETR8')
      END IF
      IF(ID.EQ.'R(COV)') THEN
        VAL=ELEMENT(IZ)%RCOV
     ...
     &         /ELEMENT(IZ)%ISOTOPE(I)%S
      ...
      END IF
      RETURN
      END SUBROUTINE PERIODICTABLE__GETR8
!
!     ...........................................PERIODICTABLE..........
      SUBROUTINE PERIODICTABLE__GETI4(IZ,ID,VAL)
!     **                                                              **
      IMPLICIT NONE
      INTEGER(4)  ,INTENT(IN) :: IZ
      CHARACTER(*),INTENT(IN) :: ID
...
!     ******************************************************************
      IF(IZ.GT.NEL) THEN
        CALL ERROR__MSG('ATOMIC NUMBER OUT OF RANGE')
        CALL ERROR__STOP('PERIODICTABLE__GETI4')
      END IF
      IF(ID.EQ.'Z') THEN
        VAL=IZ
      ...
      END IF
      RETURN
      END SUBROUTINE PERIODICTABLE__GETI4
!
!     ..................................................................
      SUBROUTINE PERIODICTABLE__SYMBOLGETI4(SYMBOL,ID,VAL)
!     **                                                              **
      IMPLICIT NONE
...
!     ******************************************************************
      ...
      CALL PERIODICTABLE__GETI4(IZ,ID,VAL)
      RETURN
      END SUBROUTINE PERIODICTABLE__SYMBOLGETI4
!
!     ..................................................................
      SUBROUTINE PERIODICTABLE__SYMBOLGETR8(SYMBOL,ID,VAL)
!     **                                                              **
      IMPLICIT NONE
      CHARACTER(*),INTENT(IN) :: SYMBOL
      CHARACTER(*),INTENT(IN) :: ID
...
!     ******************************************************************
      CALL PERIODICTABLE_INITIALIZE
      CALL PERIODICTABLE_ATOMICNUMBER(SYMBOL,IZ)
      CALL PERIODICTABLE__GETR8(IZ,ID,VAL)
      RETURN
      END SUBROUTINE PERIODICTABLE__SYMBOLGETR8
!
!     ..................................................................
      SUBROUTINE PERIODICTABLE__REPORT(NFIL)
!     **                                                              **
      IMPLICIT NONE
...
!     ******************************************************************
     ...
     &              ,ELEMENT(IZ)%RASA,ELEMENT(IZ)%RVDW,CONFIG,NNODES
      ENDDO
      RETURN
      END SUBROUTINE PERIODICTABLE__REPORT
