...
!
!     ..................................................................
      SUBROUTINE REPORT__TITLE(NFIL,TITLE)
!     ******************************************************************
!     **  WRITES A TITLE                                              **
!     ******************************************************************
...
!
!     ..................................................................
      SUBROUTINE REPORT__R8VAL(NFIL,NAME,VALUE,UNIT)
!     ******************************************************************
...
!
!     ..................................................................
      SUBROUTINE REPORT__I4VAL(NFIL,NAME,VALUE,UNIT)
!     ******************************************************************
...
!
!     ..................................................................
      SUBROUTINE REPORT__L4VAL(NFIL,NAME,VALUE)
!     ******************************************************************
...
!
!     ..................................................................
      SUBROUTINE REPORT__CHVAL(NFIL,NAME,VALUE)
!     ******************************************************************
...
!
!     ..................................................................
      SUBROUTINE REPORT__STRING(NFIL,STRING)
!     ******************************************************************
!     **  WRITES A STRING                                             **
!     ******************************************************************
      INTEGER(4)  ,INTENT(IN) :: NFIL
...
!     ..................................................................
      SUBROUTINE RESTART__SKIP(NFIL,NFILO)
!     ******************************************************************
!     **  READS SEPARATOR FROM FILE NFIL                              **
!     **  TCHK ON INPUT : DATASET SHOULD BE READ OR SKIPPED           **
!     **  TCHK ON OUTPUT: DATASET SHOULD BE READ OR SKIPPED           **
...
!     ******************************************************************
      ...
      IF(NREC.LT.0.OR.NREC.GT.10000000) THEN
        CALL ERROR__MSG('FILE STRUCTURE CORRUPTED')
        CALL ERROR__CHVAL('NAME',SEPARATOR%NAME)
        CALL ERROR__I4VAL('NREC',NREC)
        CALL ERROR__STOP('RESTART__SKIP')
      END IF
      DO I=1,NREC
        READ(NFIL)
      ENDDO
      RETURN
      END SUBROUTINE RESTART__SKIP
