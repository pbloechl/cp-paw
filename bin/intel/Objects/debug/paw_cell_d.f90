...
!     ==================================================================
     ...
     &    +TREF(3,1) * (TREF(1,2)*TREF(2,3)-TREF(2,2)*TREF(1,3))
      CALL LIB__INVERTR8(3,TREF,TREFINV)
!
!     ==================================================================
...
!
!     .........................................................
      SUBROUTINE CELL__REPORT(NFIL)
      USE CELL_MODULE
      IMPLICIT NONE
      INTEGER(4),INTENT(IN) :: NFIL
!     *****************************************************************
      IF(.NOT.TON) RETURN
      CALL REPORT__TITLE(NFIL,'UNIT CELL')
      CALL REPORT__L4VAL(NFIL,'DYNAMICAL UNIT CELL',TMOVE)
      CALL REPORT__R8VAL(NFIL,'MASS',TMASS,'A.U.')
      CALL REPORT__R8VAL(NFIL,'FRICTION',FRIC,'DT/2')
      CALL REPORT__R8VAL(NFIL,'EXTERNAL PRESSURE',PRESSURE,'A.U.')
      CALL REPORT__R8VAL(NFIL,'REFERENCE VOLUME',VREF,'A.U.')
      ...
      END SUBROUTINE CELL__REPORT
!
!     .........................................................
      SUBROUTINE CELL__CONVERT(DT,B,TREF,PERIOD,MASS,FRICTION)
      IMPLICIT NONE
      ...
      REAL(8)            :: AMAT(3,3)
!     *****************************************************************
      CALL ERROR__MSG('NOT FULLY IMPLEMENTED: DO NOT USE')
      CALL ERROR__STOP('CELL__CONVERT')
      PI=4.D0*DATAN(1.D0)
...
!     =================================================================
      ELSE
        ...
        CALL ERROR__STOP('CELL__SETL4')
      END IF
      RETURN
      END SUBROUTINE CELL__SETL4
!
!     ..................................................................
      SUBROUTINE CELL__GETL4(ID,VAL)
      USE CELL_MODULE
      IMPLICIT NONE
      CHARACTER(*),INTENT(IN) :: ID
...
!     =================================================================
      ELSE
        CALL ERROR__MSG('ID NOT RECOGNIZED')
        CALL ERROR__CHVAL('ID',ID)
        CALL ERROR__STOP('CELL__GETL4')
      END IF
      RETURN
      END SUBROUTINE CELL__GETL4
!
!     ..................................................................
      SUBROUTINE CELL__SETR8(ID,VAL)
      USE CELL_MODULE
      IMPLICIT NONE
      CHARACTER(*),INTENT(IN) :: ID
...
!     ==================================================================
      ELSE
        CALL ERROR__MSG('ID NOT RECOGNIZED')
        CALL ERROR__CHVAL('ID',ID)
        CALL ERROR__STOP('CELL__SETR8')
      END IF
      RETURN
      END SUBROUTINE CELL__SETR8
!
!     ..................................................................
      SUBROUTINE CELL__GETR8(ID,VAL)
      USE CELL_MODULE
      IMPLICIT NONE
      CHARACTER(*),INTENT(IN) :: ID
...
!     =================================================================
      IF(ID.EQ.'EPOT') THEN
        IF(TMOVE.AND.(.NOT.TPROPAGATED)) THEN
          CALL ERROR__MSG('DATA AVALAIBLE ONLY AFTER PROPAGATION')
          CALL ERROR__CHVAL('ID',ID)
          CALL ERROR__STOP('CELL__GETR8')
        END IF
        VAL=EPOT
!
!     =================================================================
...
!     =================================================================
      ...
      END IF
      RETURN
      END SUBROUTINE CELL__GETR8
!
!     .........................................................
      SUBROUTINE CELL__SETR8A(ID,LEN,VAL)
      USE CELL_MODULE
      IMPLICIT NONE
      CHARACTER(*),INTENT(IN) :: ID
...
!     ==================================================================
      IF(ID.EQ.'TREF') THEN
        IF(LEN.NE.9) THEN
          CALL ERROR__MSG('SIZE MISMATCH')
          CALL ERROR__CHVAL('ID',ID)
          CALL ERROR__I4VAL('LEN',LEN)
          CALL ERROR__STOP('CELL__SETR8A')
        END IF
...
!     ==================================================================
      ...
      END IF
      RETURN
      END SUBROUTINE CELL__SETR8A
!
!     ..................................................................
      SUBROUTINE CELL__GETR8A(ID,LEN,VAL)
      USE CELL_MODULE
      IMPLICIT NONE
      CHARACTER(*),INTENT(IN) :: ID
      INTEGER(4)  ,INTENT(IN) :: LEN
...
!     ==================================================================
      ...
      END IF
      RETURN
      END SUBROUTINE CELL__GETR8A
!
!     ..................................................................
      SUBROUTINE CELL__STOP()
      USE CELL_MODULE
      IMPLICIT NONE
!     ******************************************************************
      TSTOP=.TRUE.
...
WRITE(*,FMT='("STRESS_I ",3F10.5)')STRESS_I(3,:)
     ...
     &  +T0(3,1)*(T0(1,2)*T0(2,3)-T0(1,3)*T0(2,2))
      IF(V0.GT.1.D+10*VREF) THEN
        CALL ERROR__MSG('CELL DYNAMICS UNSTABLE')
!       CALL ERROR__R8AVAL('CELL',T0)
        CALL ERROR__R8VAL('VOLUME ',V0)
        CALL ERROR__R8VAL('REFERENCE VOLUME ',VREF)
        CALL ERROR__STOP('CELL_PROPAGATE')
      END IF
!     == EXTERNAL STRESS ===============================================
...
!     ==PROPAGATE ======================================================
      ...
      DO ITER=1,100
        ...
        CALL LIB__INVERTR8(3,XPMAT,XPMAT)
...
WRITE(*,FMT='("TP ",3F10.5)')TP(3,:)
      TPROPAGATED=.TRUE.
      RETURN
      END SUBROUTINE CELL__PROPAGATE
!
!     ..................................................................
      SUBROUTINE CELL__SWITCH()
      USE CELL_MODULE
      IMPLICIT NONE
      REAL(8)  :: AMAT(3,3)
!     ******************************************************************
...
!     == UPDATE VOUME OF THE UNIT CELL =================================
     ...
     &  +T0(3,1) * (T0(1,2)*T0(2,3)-T0(2,2)*T0(1,3))
      TPROPAGATED=.FALSE.
      RETURN
      END SUBROUTINE CELL__SWITCH
!
!     ..................................................................
      SUBROUTINE CELL__READ(NFIL,NFILO,TCHK)
...
!     ==================================================================
      IF(THISTASK.EQ.1) THEN
        IF(SEPARATOR%VERSION.NE.MYSEPARATOR%VERSION) THEN
          CALL ERROR__MSG('VERSION INCONSISTENCY')
          CALL ERROR__STOP('CELL__READ')
        END IF
        READ(NFIL)T0,TM
      END IF
      CALL MPE__BROADCAST(1,T0)
      CALL MPE__BROADCAST(1,TM)
      RETURN
      END
!
!     ..................................................................
      SUBROUTINE CELL__WRITE(NFIL,NFILO,TCHK)
!     ******************************************************************
!     **                                                              **
!     ******************************************************************
      USE CELL_MODULE
