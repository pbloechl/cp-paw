...
!**                                                                   **
!**  REMARKS:                                                         **
!**    1) FUNCTIONS NEED TO BE PUT INTO THE FORM SPHERICAL__FUNCTION   **
...
!      =================================================================
      ...
      &      +ROT(1,3)*(ROT(2,1)*ROT(3,2)-ROT(2,2)*ROT(3,1))
         IF(DABS(SVAR-1.D0).GT.1.D-12) THEN
           CALL ERROR__MSG('ROTATION MATRIX NOT UNITARY')
           CALL ERROR__STOP('YLMROT')
         END IF
       END IF
!
!      =================================================================
...
!     ******************************************************************
      ...
      IMAX=4*LMAX+1
      IF(IMAX.GT.50) THEN
        CALL ERROR__MSG('DIMENSIONS IN CLBSCH TO SMALL')
        CALL ERROR__STOP('CLBSCH')
      END IF
      FACT(0)=1.D0
      SQFACT(0)=1.D0
      DO I=1,IMAX
...
!**                                                                   **
!**  USE THE INTERFACES                                               **
!**    SPHERICAL__CCMAT0(LM1,I,LM2,CC)                                 **
!**    SPHERICAL__CCMATM(LM1,I,LM2,CC)                                 **
!**                                                                   **
!***********************************************************************
TYPE A_TYPE
LOGICAL(4):: EXIST0(10)
...
!
!     ..................................................................
      SUBROUTINE SPHERICAL__clearCCMAT
...
!         ==============================================================
          IF(T0) THEN
            ...
            DO WHILE(THIS(LM1)%EXIST0(I))
              I=I+1
              IF(I.GT.10) THEN
                CALL ERROR__MSG('SUMRULE VIOLATED - OVERFLOW A0')
                CALL ERROR__STOP('SPHERICAL_CCMAT')
              END IF
            END DO
            THIS(LM1)%A0(:,:,I)=A1(:,:)
            THIS(LM1)%LM20(I)=LM2
...
!         ==============================================================
          IF(TM) THEN
            ...
            DO WHILE(THIS(LM1)%EXISTM(I))
              I=I+1
              IF(I.GT.10) THEN
                CALL ERROR__MSG('SUMRULE VIOLATED - OVERFLOW AM')
                CALL ERROR__STOP('SPHERICAL_CCMAT')
              END IF
            END DO
            THIS(LM1)%AM(:,:,I)=A1(:,:)
...
!
!     ..................................................................
      SUBROUTINE SPHERICAL__CCMAT0(LM1,I,LM2,CC)
!     ******************************************************************
...
!
!     ..................................................................
      SUBROUTINE SPHERICAL__CCMATM(LM1,I,LM2,CC)
!     ******************************************************************
!     **  MATRIX P0 USED TO EVALUATE THE STRESS IN A REPRESENTATION   **
!     **  OF SPHERICAL HARMONICS                                      **
!     **  SEE SPHERICALCCMAT_MODULE FOR DETAILS                       **
