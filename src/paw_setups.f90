...
!     **************************************************************************
!     **  Obtain radial function of a function in G-space                     **
!     **                                                                      **
!     **  REMARK: REQUIRES PROPER SETUP TO BE SELECTED                        **
!     **************************************************************************
      USE SETUP_MODULE
      ...
      REAL(8)     ,INTENT(OUT) :: F(NG_)  ! radial function
...
!!$print*,'warning!!!  relativistic effects are switched off!!!!'
!!$print*,'warning!!!  relativistic effects are switched off!!!!'
!!$print*,'warning!!!  relativistic effects are switched off!!!!'
...
!     ==========================================================================
      IF(TYPE.ne.'NDLSS') THEN
        CALL ERROR$MSG('ONLY TYPE=NDLSS ALLOWED!')
        CALL ERROR$STOP('SETUP_MAKEPARTIALWAVES')
      end if
...
!     ******************************PETER BLOECHL, GOSLAR 2013 *****************
      ...
      LOGICAL(4),PARAMETER  :: T3PAR=.false.
      LOGICAL(4),PARAMETER  :: T4PAR=.false.
      LOGICAL(4),PARAMETER  :: TWRITE=.TRUE.
!     == A LARGER POTPOW MAKES THE POTENTIAL FLATTER WITH A MORE ABRUPT UPTURN
      REAL(8)   ,PARAMETER  :: POTPOW=4.D0
      REAL(8)   ,PARAMETER  :: PI=4.D0*ATAN(1.D0)
      REAL(8)   ,PARAMETER  :: Y0=1.D0/SQRT(4.D0*PI)
      INTEGER(4)            :: IRC
      REAL(8)               :: R(NR)
...
!     ==========================================================================
      ...
      ENU=0.D0
!
!     == REPLACE POTENTIAL INSIDE RC BY C1+C2*R^POTPOW =========================
!     == POTPOW=3 IS INSPIRED BY TROULIER MARTINS
      ...
      IF(TWRITE) THEN
        WRITE(LSTRING,*)L
        LSTRING=ADJUSTL(LSTRING)
        CALL SETUP_WRITEPHI('POT'//TRIM(LSTRING),GID,NR,1,POT)
        WRITE(*,*)'POTPOW=',POTPOW,c1,c2
      END IF
!
!     ==========================================================================
