...
& Kresse \\
\hline
H  & 0.8~$a_0$=1.323~$r_{cov}$  \\
Li & 1.3~$a_0$=0.559~$r_{cov}$  \\
Be & 1.9~$a_0$=1.117~$r_{cov}$  \\
C  & 1.1~$a_0$=0.756~$r_{cov}$  \\
N  & 1.1~$a_0$=0.776~$r_{cov}$  \\
O  & 1.1~$a_0$=0.797~$r_{cov}$  \\
F  & 1.0~$a_0$=0.735~$r_{cov}$  \\
Si & 1.9~$a_0$=0.906~$r_{cov}$  \\
P  & 1.5~$a_0$=0.749~$r_{cov}$  \\
S  & 1.5~$a_0$=0.778~$r_{cov}$  \\
Cl & 1.5~$a_0$=0.802~$r_{cov}$  \\
Na & 1.7~$a_0$=0.584~$r_{cov}$  \\
\hline
\end{tabular}
\end{center}
