...
\end{eqnarray}
These equations have great similarity with those of the nodeless
equations \eq{eq:nodelesseq}.
...
\caption{\label{fig:epwconvsindlss} Plane wave convergence of the
  ...
  augmentation radius of 0.7-0.8~$r_cov$ appears to be the best choice.}
\end{figure}
