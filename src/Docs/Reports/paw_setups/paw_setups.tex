...
The total energy is not completely converged with a plane wave cutoff
...
\subsubsection{Mn}
%=====================================================================
For manganese without semi-core states we need a cutoff for the
d-electrons of 0.8~$r_{cov}$ to get the correct lattice constant for
MnO. Chosing the s and p-electrons with a larger radius does not
improve the plane wave convergence. (It is not clear yet whether the
convergence is dominated by the oxygen setup, though)
Crucial is to set the potential at the origin to zero.
