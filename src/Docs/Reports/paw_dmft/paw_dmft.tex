...
\end{eqnarray}
This explains the origin of \eq{eq:paw_constraints_violation}.
...
\begin{figure}[h!]
\begin{center}
\includegraphics[width=0.3\linewidth]{Figs/hubimg.eps} % PreliminarY
\end{center}
...
\caption{\label{tab:matsubarasumlaurent} Derivatives required in
  \eq{eq:matgsubarasumlaurent} for the Matsubara sum of the first
...
!     **************************************peter bloechl goslar 2015***********
      ...
      real(8)   ,intent(out)   :: xp(n)       ! next position
      real(8)                  :: alpha(nmemx)
      real(8)                  :: beta(nmemx)
      real(8)                  :: rho(nmemx)
      real(8)                  :: q(n)
...
!
!     ...1.........2.........3.........4.........5.........6.........7.........8
      subroutine doetot(n,x,val,f)
!     **************************************************************************
!     ** calculate value val of function to be minimized and the force f      **
!     **************************************************************************
      implicit none
      integer(4),intent(in)    :: n     !dimension of the search space
      real(8)   ,intent(in)    :: x(n)  ! position vector
      real(8)   ,intent(out)   :: val   ! function value
      real(8)   ,intent(out)   :: f(n)  ! force
      real(8)                  :: c(n,n),b(n)
!     **************************************************************************
      c(:,:)=0.d0
      c(1,1)=1.d0
      c(2,2)=2.d0
      b=(/5.d0,3.d0/)
      val=0.5d0*dot_product(x,matmul(c,x))-dot_product(b,x)
      val=val+1.d-2*x(1)**4
      f=-matmul(c,x)+b
      f=f-4.d0*1.d-2*x(1)**3
      return
      end
\end{verbatim}
}
