...
\begin{enumerate}
\item At first a so-called envelope function is defined.
%
\item In a second step this envelope function is expanded about each
  atomic site into spherical harmonics.
%
\item In the third step the spherical-harmonics contributions are
  replaced differentially at some sphere radius by partial waves of
...
%====================================================================
The envelope functions used here are solid Hankel functions, defined
...
%====================================================================
\section{Calculate screened structure constants on clusters}
%====================================================================
...
of the Helmholtz equation\footnote{The factors and signs of the
  inhomogeneity need to be confirmed. The equation has been taken from
  the methods book, chapter \textit{``Working with spherical Hankel and Bessel
  functions.}}
\begin{eqnarray}
\Bigl[\vec{\nabla^2}+k^2\Bigr]H_{L}(\vec{r})
=-4\pi(-1)^\ell\mathcal{Y}(\vec{\nabla})\delta(\vec{r})
...
-J_s(\vec{r}-\vec{R}) S^\dagger_{\vec{R},s;\vec{0},s}
\nonumber\\
&&-J_{p_x}(\vec{r}-\vec{R}) S^\dagger_{\vec{R},p_x;\vec{0},s}
-J_{p_y}(\vec{r}-\vec{R}) S^\dagger_{\vec{R},p_y;\vec{0},s}
-J_{p_z}(\vec{r}-\vec{R}) S^\dagger_{\vec{R},p_z;\vec{0},s}
\\
K_{\vec{0},s}^\infty(\vec{R})&=&\frac{1}{\sqrt{4\pi}}\frac{1}{|\vec{R}|}
=-
\underbrace{\frac{1}{\sqrt{4\pi}}}_{J_{\vec{R},s}(\vec{R})} 
\underbrace{\Bigl(-\frac{1}{|\vec{R}|}\Bigr)
}_{S^\dagger_{\vec{R},s;\vec{0},s}}
\\
...
\underbrace{\sqrt{3}\frac{X}{|\vec{R}|^3}}_{S^\dagger_{\vec{R},p_x,\vec{0},s}}
\\
K_{\vec{0},p_x}(\vec{R})&=&\sqrt{\frac{3}{4\pi}}\frac{X}{|\vec{R}|^3}
=-\underbrace{\frac{1}{\sqrt{4\pi}}}_{J_{\vec{R},s}(\vec{R})}
\underbrace{\Bigl(-\sqrt{3}\frac{X}{|\vec{R}|^3}\Bigr)
}_{S^\dagger_{\vec{R},s,\vec{0},p_x}}
\end{eqnarray}

For $\kappa=0$ the structure constants have the form
\begin{eqnarray}
S_{RL,R'L'}=(-1)^{\ell'+1} 4\pi \sum_{L''} C_{L,L',L''} 
H_{L''}(\vec{R}'-\vec{R})
\underbrace{\kappa^{\ell+\ell'-\ell''}}_{=1\text{ for $\kappa=0$}}
\nonumber\\
S^\dagger_{RL,R'L'}=(-1)^{\ell+1} 4\pi \sum_{L''} C_{L,L',L''} 
H_{L''}(\vec{R}-\vec{R}')
\underbrace{\kappa^{\ell+\ell'-\ell''}}_{=1\text{ for $\kappa=0$}}
\end{eqnarray}
The structure constants obtained from this equation are
\begin{eqnarray}
S^\dagger_{\vec{R},s,\vec{0},s}&=&(-1) 4\pi \frac{1}{\sqrt{4\pi}}
\cdot\frac{1}{\sqrt{4\pi}}\frac{1}{|\vec{R}|}=-\frac{1}{|\vec{R}|}
\nonumber\\
S^\dagger_{\vec{R},p_x,\vec{0},s}&=& 4\pi
\underbrace{\frac{1}{\sqrt{4\pi}}}_{C_{p_x,s,p_x}}
\sqrt{\frac{3}{4\pi}}\frac{X}{|\vec{R}|^3}=\sqrt{3}\frac{X}{|\vec{R}|^3}
\nonumber\\
S^\dagger_{\vec{R},s,\vec{0},p_x}&=& (-1)4\pi
