...
%===============================================================
We calculate ahead of time 
\begin{eqnarray}
\langle{p}_\alpha|\phi^H_\beta\rangle = PROPHIH
\nonumber\\
\langle{p}_\alpha|\phi^T_\beta\rangle = PROPHIT
\end{eqnarray}
...
\langle\Phi^H|p\rangle\langle\phi|\phi\rangle=PROPHIHINV
\end{eqnarray}
...
}_{=:X^\dagger_{\zeta,\eta}}
\biggr\rbrace  \langle{p}_\eta|\phi^H_\gamma\rangle 
\nonumber\\
%
\langle{p}|\chi\rangle
&=&\Bigl(\mat{1}-\mat{X}^\dagger\Bigr)\langle{p}|\phi^H\rangle
\end{eqnarray}

We define the quantities
\begin{eqnarray}
\mat{X}_{\zeta,\eta}&\defas&
\Bigl(\langle{p}|\phi^H\rangle\Bigr)^{-1}_{\zeta,\mu}
...
\begin{eqnarray}
\langle\pi_{\mu}|=
\Bigl(\langle{p}|\phi^H\rangle\Bigr)^{-1}_{\eta}
\biggl\lbrace
\delta_{\zeta,\eta}-X^\dagger_{\zeta,\eta}
...
Y_L(\vec{r'}-\vec{R}_2)
\end{eqnarray}
This expression is used to comnstruct the short-ranged potentials.
